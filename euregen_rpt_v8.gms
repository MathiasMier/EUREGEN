...
$if      set co2iter    $if      set indformula     $if      set bauprice          execute_unload   'euetsmsr\co2elec_%l%_bauprice.gdx',            co2elec_out ;
$if      set co2iter    $if      set indformula     $if      set bauprice          execute          'gdxxrw.exe euetsmsr\co2elec_%l%_bauprice.gdx   o=euetsmsr\EUETS_MSR_CO2ITER_bauprice_indformula_shortrun.xlsx   par=co2elec_out rng=co2elec_out!a1'
$if      set co2iter    $if      set indformula     $if      set recovery          execute_unload   'euetsmsr\co2elec_%l%_recovery.gdx',            co2elec_out ;
$if      set co2iter    $if      set indformula     $if      set recovery          execute          'gdxxrw.exe euetsmsr\co2elec_%l%_recovery.gdx   o=euetsmsr\EUETS_MSR_CO2ITER_recovery_indformula_shortrun.xlsx   par=co2elec_out rng=co2elec_out!a1'
$if      set co2iter    $if      set indformula     $if      set high              execute_unload   'euetsmsr\co2elec_%l%_high.gdx',                co2elec_out ;
$if      set co2iter    $if      set indformula     $if      set high              execute          'gdxxrw.exe euetsmsr\co2elec_%l%_high.gdx       o=euetsmsr\EUETS_MSR_CO2ITER_high_indformula_shortrun.xlsx       par=co2elec_out rng=co2elec_out!a1'
$if      set co2iter    $if not  set indformula     $if      set bauprice          execute_unload   'euetsmsr\co2elec_%l%_bauprice.gdx',            co2elec_out ;
$if      set co2iter    $if not  set indformula     $if      set bauprice          execute          'gdxxrw.exe euetsmsr\co2elec_%l%_bauprice.gdx   o=euetsmsr\EUETS_MSR_CO2ITER_bauprice_shortrun.xlsx   par=co2elec_out rng=co2elec_out!a1'
$if      set co2iter    $if not  set indformula     $if      set recovery          execute_unload   'euetsmsr\co2elec_%l%_recovery.gdx',            co2elec_out ;
$if      set co2iter    $if not  set indformula     $if      set recovery          execute          'gdxxrw.exe euetsmsr\co2elec_%l%_recovery.gdx   o=euetsmsr\EUETS_MSR_CO2ITER_recovery_shortrun.xlsx   par=co2elec_out rng=co2elec_out!a1'
$if      set co2iter    $if not  set indformula     $if      set high              execute_unload   'euetsmsr\co2elec_%l%_high.gdx',                co2elec_out ;
$if      set co2iter    $if not  set indformula     $if      set high              execute          'gdxxrw.exe euetsmsr\co2elec_%l%_high.gdx       o=euetsmsr\EUETS_MSR_CO2ITER_high_shortrun.xlsx       par=co2elec_out rng=co2elec_out!a1'
