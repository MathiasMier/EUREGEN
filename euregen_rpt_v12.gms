...
$if set bauprice $if     set banking execute_unload 'limits\%l%_%s%.gdx', ixfx, itfx, igfx ;
$if set bauprice $if not set banking execute_unload 'limits\%l%_%s%_nobanking.gdx', ixfx, itfx, igfx ;
