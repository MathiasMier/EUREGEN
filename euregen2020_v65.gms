...
eqs_msrin2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..       MSRIN(t)                    =e= UPP(t-1) * 0.12 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) * 0.5 ;
...
eqs_msrout2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 100 + LOWMID(t-1) * 2.5 * (400 - TNAC(t-1)) ;
eqs_msrout_old(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 100 + LOWMID(t-1) * 2.5 * (400 - TNAC(t-1)) ;
eqs_msrout_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 200 + LOWMID(t-1) * 5 * (400 - TNAC(t-1)) ;
eqs_msrout2030_old(t)$((t.val ge 2024 and t.val le 2030) and tmyopic(t))..  MSROUT_INT(t)               =e= LOW(t-1) * 100 + LOWMID(t-1) * 2.5 * (400 - TNAC(t-1)) ;

eqs_msrout2030_new(t)$((t.val ge 2024 and t.val le 2030) and tmyopic(t))..  MSROUT_INT(t)               =e= LOW(t-1) * 200 + LOWMID(t-1) * 5 * (400 - TNAC(t-1)) ;
eqs_msrout2045(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      MSROUT_MAX(t)               =e= (LOW(t-1) + LOWMID(t-1)) * MSR(t-1) / nyrs(t) ;

eqs_msroutfinal(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..     MSROUT(t)                   =e= MSRFULL(t-1) * MSROUT_INT(t) + MSREMPTY(t-1) * MSROUT_MAX(t) ;
eqs_binarymsrout(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSRFULL(t) + MSREMPTY(t)    =e= 1 ;

eqs_msroutup(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..        MSR(t-1)                    =g=                                           MSRFULL(t-1) * MSROUT_INT(t) * nyrs(t)  ;             
eqs_msroutlo(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..        MSR(t-1)                    =l= MSREMPTY(t-1) * MSROUT_INT(t) * nyrs(t) + MSRFULL(t-1) * 5000 ;
...
eqs_cancel2045(t)$(sameas(t,"2045") and tmyopic(t))..                       CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - 0 ;

eqs_cancelfinal(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..     CANCEL(t)                   =e= CANCEL_INT(t) * CANCELYES(t) ;
eqs_binarycancel(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    CANCELNO(t) + CANCELYES(t)  =e= 1 ;
eqs_cancelup_old(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =g=                                                                   CANCELYES(t) * (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) ;             
eqs_cancello_old(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =l= CANCELNO(t) * (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) + CANCELYES(t) * 5000 ;
eqs_cancelup_new(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =g=                     CANCELYES(t) * 400 ;             
eqs_cancello_new(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =l= CANCELNO(t) * 400 + CANCELYES(t) * 5000 ;
...
msrout_in(t)$(msr_in(t) < 0 and tnac_in(t) < 400) = msrin_in(t) ;
...
$if      set co2mips                                                            eqs_msroutfinal
$if      set co2mips                                                            eqs_binarymsrout
...
$if      set co2mips    $if      set euetsold                                   eqs_cancelfinal
$if      set co2mips    $if      set euetsold                                   eqs_binarycancel
$if      set co2mips    $if      set euetsold                                   eqs_cancelup_old             
$if      set co2mips    $if      set euetsold                                   eqs_cancello_old

$if      set co2mips    $if      set euetsmsrin                                 eqs_cancelfinal
$if      set co2mips    $if      set euetsmsrin                                 eqs_binarycancel
$if      set co2mips    $if      set euetsmsrin                                 eqs_cancelup_old             
$if      set co2mips    $if      set euetsmsrin                                 eqs_cancello_old

$if      set co2mips    $if      set euetscancel                                eqs_cancelfinal
$if      set co2mips    $if      set euetscancel                                eqs_binarycancel
$if      set co2mips    $if      set euetscancel                                eqs_cancelup_new             
$if      set co2mips    $if      set euetscancel                                eqs_cancello_new

$if      set co2mips    $if      set euetsnew                                   eqs_cancelfinal
$if      set co2mips    $if      set euetsnew                                   eqs_binarycancel
