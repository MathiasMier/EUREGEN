...
genUP_coal(r,t)$(tmyopic(t) and sameas(t,"2022"))..
...
msrstart_in = round(msr_int("2022"), 4) ;

tnacstart_in =
$if not set hedgeeua    round(tnac_int("2022"), 4) ;
$if     set hedgeeua    round(tnacres_int("2022"), 4) ;
...
$if     set banking     $if not set bauprice    TNAC.FX("2022") = tnac_in("2022") ;
...
*$if     set banking     $if     set bauprice    TNAC.LO("2022") = tnac_in("2022") ;
*$if     set banking     $if     set bauprice    TNACUSE.UP("2022") = tnacuse_in("2022") ;
*$if     set banking     $if not set bauprice    TNAC.UP("2022") = tnac_in("2022") ;
*$if     set banking     $if not set bauprice    TNACUSE.UP("2022") = tnacuse_in("2022") ;

$if      set realworld2022                      TNAC.FX("2022") = tnac_in("2022") ;
$if      set realworld2022                      TNACUSE.FX("2022") = tnacuse_in("2022") ;            
...
$if set co2iter $if     set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_in(t) + 10 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_in(t) - 10 ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val ge 2023 and t.val le 2040) = co2ele_in(t) + 10 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(t.val ge 2023 and t.val le 2040) = co2ele_in(t) - 10 ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val ge 2041 and t.val le 2045) = co2ele_in(t) + 10 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(t.val ge 2041 and t.val le 2045) = co2ele_in(t) - 10 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_in(t) + 10 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_in(t) - 10 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2040 and t.val ge 2023) = co2ele_in(t) + 10 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2040 and t.val ge 2023) = co2ele_in(t) - 10 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val ge 2041 and t.val le 2045) = co2ele_in(t) + 10 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val ge 2041 and t.val le 2045) = co2ele_in(t) - 10 ;

$ontext
$if set co2iter $if     set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 50 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) - 50 ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) + 150 ;
...
$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) + 150 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) - 50 ;

$if set co2iter ECEU.UP(t)$(sameas(t,"2050")) = co2ele_org(t) + 5 ;
$if set co2iter ECEU.LO(t)$(sameas(t,"2050")) = co2ele_org(t) - 5 ;
$offtext
...
eqs_euets(t)
eqs_msrin2022(t)
$if set shortrun    eqs_msrin2023(t)
eqs_msrin_old(t)
eqs_msrin_new(t)
eqs_msrout2022(t)
$if set shortrun    eqs_msrout2023(t)
eqs_msrout_old(t)
eqs_msrout_new(t)
eqs_tnac(t)
eqs_msr(t)
$if set shortrun    eqs_cancel2023(t)
eqs_cancel_old(t)
eqs_cancel_new(t)
eqs_tnacup(t)
eqs_tnaclo(t)
...
eqs_msrin2022(t)$(sameas(t,"2022"))..                                       MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) + UPPMID(t-1) * 0.24 * TNAC(t-1) ;
$if set shortrun    eqs_msrin2023(t)$(sameas(t,"2023"))..                   MSRIN(t)                    =e= UPP(t-1) * 0.12 * TNAC(t-1) + UPPMID(t-1) * 0.12 * TNAC(t-1) ;
eqs_msrin_old(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..       MSRIN(t)                    =e= UPP(t-1) * 0.12 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) * 0.5 ;
eqs_msrin_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..       MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) ;

eqs_msrout2022(t)$(sameas(t,"2022"))..                                      MSROUT(t)                   =l= LOW(t-1) * 200 + LOWMID(t-1) * 200;
$if set shortrun    eqs_msrout2023(t)$(sameas(t,"2023"))..                  MSROUT(t)                   =l= LOW(t-1) * 100 + LOWMID(t-1) * 100 ;
eqs_msrout_old(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      MSROUT(t)                   =l= LOW(t-1) * 100 + LOWMID(t-1) * 5 * (400 - TNAC(t-1)) ;
eqs_msrout_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      MSROUT(t)                   =l= LOW(t-1) * 200 + LOWMID(t-1) * 5 * (400 - TNAC(t-1)) ;

eqs_tnac(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..            TNAC(t)                     =e= tnacstart_in - sum(tt$(tt.val le t.val and tt.val ge 2023), TNACUSE(tt) * nyrs(tt)) ;
eqs_msr(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..             MSR(t)                      =e= msrstart_in  + sum(tt$(tt.val le t.val and tt.val ge 2023), (MSRIN(tt) - MSROUT(tt) - CANCEL(tt)) * nyrs(tt)) ;

eqs_tnacup(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          TNAC(t)                     =g=                LOWMID(t) * 360 + MID(t) * 400 + UPPMID(t) *  833 + UPP(t) * 1096 ;
eqs_tnaclo(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          TNAC(t)                     =l= LOW(t) * 360 + LOWMID(T) * 400 + MID(t) * 833 + UPPMID(t) * 1096 + UPP(t) * 2000 ;
eqs_binary(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          LOW(t) + LOWMID(t) + UPP(t) + UPPMID(t) + MID(t) =e= 1 ;

$if set shortrun    eqs_cancel2023(t)$(sameas(t,"2023"))..                  CANCEL(t)                   =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - co2auctioned_in(t-1) ;
eqs_cancel_old(t)$((t.val ge 2024 and t.val le 2025) and tmyopic(t))..      CANCEL(t)                   =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - co2auctioned_in(t-1) ;
eqs_cancel_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      CANCEL(t)                   =g= MSR(t-1) + MSRIN(t) - MSROUT(t) - 400 ;

Parameter
cancel_in(t)
;

$if not  set euetscancel    cancel_in(t)$(t.val ge 2023 and t.val le 2045) = msr_in(t-1) + msrin_in(t) - co2auctioned_in(t-1) ;
$if      set euetscancel    cancel_in(t)$(t.val ge 2023 and t.val le 2045) = msr_in(t-1) + msrin_in(t) - 400 ;
...
$if      set co2mips  MSR.FX("2022") = msr_in("2022") ;
...
$if      set co2mips  LOWMID.FX("2022") = 0 ;
$if      set co2mips  LOWMID.FX("2050") = 0 ;
...
$if      set co2mips  UPPMID.FX("2022") = 0 ;
$if      set co2mips  UPPMID.FX("2050") = 0 ;
...
$if not set bauprice $if     set nofreedom2022  =l= co2ele_in(t) + 0  
...
$if not set uselimits       $if not set bauprice    IX.FX(i,r,"2022")$(not gas(i)) = 0 ;
...
$if      set co2mips        $if      set shortrun       eqs_cancel2023
...
$if      set calibration2022                     $if not set bauprice   genUP_ngas
$if      set calibration2022                     $if not set bauprice   genUP_nucl
$if      set calibration2022                     $if not set bauprice   genUP_coal
$if      set calibration2022                     $if not set bauprice   genUP_hydr
