...
af(s,ivrt(bio(i),oldv(v),r,t)) = af_iint(s,i,v,r,t) * gen_co_biom(r,"2022") ;
...
af(s,ivrt(nuc(i),oldv(v),r,t)) = af_iint(s,i,v,r,t) * gen_co_nucl(r,"2022") ;
...
af(s,ivrt(i,oldv(v),r,t))$(sameas(i,"Hydro")) = af_iint(s,i,v,r,t) * gen_co_hydr(r,"2022") ;
...
lign_out(r,t)$(t.val ge 2022) = smax(tt$(tt.val le 2021), lign_out(r,tt)) ;

genUP_lign(r,t)$(tmyopic(t) and rlignite(r))..
    sum(ivrt("Lig_CHP",oldv(v),r,t), XTWH("Lig_CHP",v,r,t)/effrate("Lig_CHP",v,r)) + sum(ivrt("Lignite",oldv(v),r,t), XTWH("Lignite",v,r,t)/effrate("Lignite",v,r)) =l= lign_out(r,t) ;
