...
KCAPEX_MIP(i,r,t)           Capacity cost of learning technologies (billion EUR)
...
capcost_mixedip_k(i,r,t)$(kir_lea(i,r) and t.val ge 2023 and tmyopic(t))..
                 KCAPCOST_MIP(i,r,t)             =e= sum(kls, KRHO(i,r,t-1,kls) * kslope_mip(i,r,kls) ) * 1e-3 ;
* This equation enforeces that always just one line segment is active
...
$if      set lbs                            $if      set mixed
+ sum(ivrt(i,v,r,t)$(new(i) and not kir_lea(i,r) and tmyopic(t)), sum(inv, share(inv,i,r) * IX(i,r,t)                * sum(tv(t,v), capcost(i,v,r) * zeta(inv,i,v,r)))) +
$if      set lbs                            $if      set mixed
+ sum(ivrt(i,v,r,t)$(new(i) and     kir_lea(i,r) and tmyopic(t)), sum(inv, share(inv,i,r) * KCAPEX_MIP(i,r,t) * 1e+3 * sum(tv(t,v),                  zeta(inv,i,v,r)))) +
...
$if not  set doing      $if not  set lbs    $if      set mixed   + sum(new(i),              sum(inv,  share(inv,i,r) * IX(i,r,t)    * sum(tv(t,v)$ivrt(i,v,r,t),  capcost(i,v,r)  *  zeta(inv,i,v,r))))
...
$if      set lbs         $if    set normal                        + sum(new(i)$(kir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t), KCAPEX_MIP(i,r,t) * 1e+3 * kendeffect(i,r,t) ))
               )
