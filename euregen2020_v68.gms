...
$if     set frnuc2023       af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2023")                and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0) = sum(sm(s,m), afnn(m,i,r,"2023")) ;
* Set French nuclear availability in 2023 as in 2022 as what-if-still-case
...
$if     set hydro2023       af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2023")                and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), afnn(m,i,r,"2020") + afnn(m,i,r,"2021")) > 0) = round(sum(sm(s,m), afnn(m,i,r,"2023") / (afnn(m,i,r,"2020")/2 + afnn(m,i,r,"2021")/2)), 4) ;
* Assume that lower hydro availability prevails in 2023
...
af_mon2023_str("1","Nuclear","Germany") = afnn("1","Nuclear","Germany","2023") * 2 ;
af_mon2023_str("2","Nuclear","Germany") = afnn("2","Nuclear","Germany","2023") * 2 ;
af_mon2023_str("3","Nuclear","Germany") = afnn("3","Nuclear","Germany","2023") * 2 ;
af_mon2023_str("4","Nuclear","Germany") = afnn("3","Nuclear","Germany","2023") * 2 / 2 ;
...
$if     set streckbetrieb   gen_nucl(r,t)$(sameas(t,"2023") and                sameas(r,"Germany")) = 6.74 ;
$if     set extension       gen_nucl(r,t)$(t.val ge 2023 and t.val le 2029 and sameas(r,"Germany")) = gen_nucl(r,"2022") ;
$if     set strext          gen_nucl(r,t)$(sameas(t,"2023") and                sameas(r,"Germany")) = 6.74 + round(gen_nucl(r,"2022") / 3, 4) ;  
...
$if set streckbetrieb   af(s,nuc(i),oldv(v),r,t)$(sameas(r,"Germany") and sameas(t,"2023"))                 = af_iint(s,i,v,r,t) * gen_co_nucl(r,t) ;
...
$if set frnuc2023 af(s,nuc(i),oldv(v),r,t)$(sameas(r,"France") and sameas(t,"2023"))                = af_iint(s,i,v,r,t) ;
...
$if set hydro2023 af(s,i,oldv(v),r,t)$(sameas(i,"Hydro") and sameas(t,"2023"))                = af_iint(s,i,v,r,t) ;
...
$if set loadnew     daref(r,"2023")$(daref(r,"2025") > daref_new(r,"2022")) = daref(r,"2022") + 1/3 * (daref(r,"2025") - daref(r,"2022")) ;
$if set loadnew     daref(r,"2024")$(daref(r,"2025") > daref_new(r,"2022")) = daref(r,"2022") + 2/3 * (daref(r,"2025") - daref(r,"2022")) ;
...
eqs_euets(t)$(tmyopic(t))..                                                 ECEU(t) * (1 + co2elecind(t)) + co2indorgfix_in(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t)
                                                                                                        =e= co2add_in(t) + co2allocated_in(t) + (co2auctioned_in(t) - MSRIN(t)) + TNACUSE(t)
$if     set hedgeeua                                                                                        - co2out_in(t)
                                                                            ;
eqs_msr(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..             MSR(t)                      =e= msrstart_in  + sum(tt$(tt.val le t.val and tt.val ge 2022), (MSRIN(tt) - CANCEL(tt)) * nyrs(tt)) ;
                                                                            
eqs_msrin2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..       MSRIN_IINT(t)                =e= UPP(t-1) * 0.12 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) * 100.08 - LOW(t-1) * 100 - LOWMID(t-1) * 100 * (400 - TNAC(t-1)) ;
eqs_msrin_old(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..       MSRIN_IINT(t)                =e= UPP(t-1) * 0.12 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) * 100.08 - LOW(t-1) * 100 - LOWMID(t-1) * 100 * (400 - TNAC(t-1)) ;
eqs_msrin_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..       MSRIN_IINT(t)                =e= UPP(t-1) * 0.24 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833)          - LOW(t-1) * 200 - LOWMID(t-1) * 200 * (400 - TNAC(t-1)) ;
...
eqs_msrout_fin(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      MSRIN(t)                    =e= MSRFULL(t-1) * MSRIN_IINT(t) - MSREMPTY(t-1) * MSROUT_MAX(t) ;
eqs_msroutup(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1)                    =g=                                                 MSRFULL(t-1) * (-1) * MSRIN_IINT(t) * nyrs(t)  ;             
eqs_msroutlo(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1)                    =l= MSREMPTY(t-1) * (-1) * MSRIN_IINT(t) * nyrs(t) + MSRFULL(t-1) * 5000 ;
...
eqs_cancel2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..      CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - (co2auctioned_in(t-1) - MSRIN(t-1)) ;
eqs_cancel_old(t)$((t.val ge 2024 and t.val le 2040) and tmyopic(t))..      CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - (co2auctioned_in(t-1) - MSRIN(t-1)) ;
eqs_cancel_new(t)$((t.val ge 2024 and t.val le 2040) and tmyopic(t))..      CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - 400 ;
eqs_cancel2045(t)$(sameas(t,"2045") and tmyopic(t))..                       CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - 0 ;

eqs_cancel_fin(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      CANCEL(t)                   =e= CANCEL_INT(t) * CANCELYES(t) ;
eqs_cancel_bin(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      CANCELNO(t) + CANCELYES(t)  =e= 1 ;
eqs_cancelup_old(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) =g=                                                                   CANCELYES(t) * (co2auctioned_in(t-1) - MSRIN(t-1)) ;             
eqs_cancello_old(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) =l= CANCELNO(t) * (co2auctioned_in(t-1) - MSRIN(t-1)) + CANCELYES(t) * 5000 ;
eqs_cancelup_new(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) =g=                     CANCELYES(t) * 400 ;             
eqs_cancello_new(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..    MSR(t-1) + MSRIN(t) =l= CANCELNO(t) * 400 + CANCELYES(t) * 5000 ;
...
$if      set co2mips  MSRIN.L(t)                   = msrin_in(t) ;
