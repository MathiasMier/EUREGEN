...
$if      set co2mark                        + abs(co2marketeu.M(t)) / dfact(t)
...
Emissions_rpt(t,r,"CO2-price-uk")                       = co2pruk(t) ;
...
Emissions_total_rpt(t,"Total CO2-emissions-elec-eu")    = sum(r$(not sameas(r,"Britain")), co2emit(r,t)) ;
Emissions_total_rpt(t,"Total CO2-captured-eu")          = sum(r$(not sameas(r,"Britain")), co2capt(r,t)) ;
Emissions_total_rpt(t,"CO2 price-eu")                   = co2pr(t) ;

Emissions_total_rpt(t,"Total CO2-emissions-elec-uk")    = sum(r$(sameas(r,"Britain")), co2emit(r,t)) ;
Emissions_total_rpt(t,"Total CO2-captured-uk")          = sum(r$(sameas(r,"Britain")), co2capt(r,t)) ;
Emissions_total_rpt(t,"CO2 price-uk")                   = co2pruk(t) ;
...
Emissions_total_ByFuel_rpt(t,"CO2-emissions-bioenergy-eu") = sum(r$(not sameas(r,"Britain")), co2emit_fuel(r,t,"Bioenergy")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-coal-eu")      = sum(r$(not sameas(r,"Britain")), co2emit_fuel(r,t,"Coal")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-gas-eu")       = sum(r$(not sameas(r,"Britain")), co2emit_fuel(r,t,"Gas")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-lignite-eu")   = sum(r$(not sameas(r,"Britain")), co2emit_fuel(r,t,"Lignite")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-oil/other-eu") = sum(r$(not sameas(r,"Britain")), co2emit_fuel(r,t,"Oil")) ;

Emissions_total_ByFuel_rpt(t,"CO2-emissions-bioenergy-uk") = sum(r$(sameas(r,"Britain")), co2emit_fuel(r,t,"Bioenergy")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-coal-uk")      = sum(r$(sameas(r,"Britain")), co2emit_fuel(r,t,"Coal")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-gas-uk")       = sum(r$(sameas(r,"Britain")), co2emit_fuel(r,t,"Gas")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-lignite-uk")   = sum(r$(sameas(r,"Britain")), co2emit_fuel(r,t,"Lignite")) ;
Emissions_total_ByFuel_rpt(t,"CO2-emissions-oil/other-uk") = sum(r$(sameas(r,"Britain")), co2emit_fuel(r,t,"Oil")) ;
...
discostco2(i,v,r,t)$(not sameas(r,"Britain")) = discost(i,v,r,t) + emit(i,v,r) * co2pr(t) ;
...
Electricity1_rpt(t,r,"price-avg")                = sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s)) / sum(s,             dref(r,t) * load(s,r) * hours(s)) + eps ;
Electricity1_rpt(t,r,"price-avg-winter")         = sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s)) / sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s)) + eps ;
Electricity1_rpt(t,r,"price-avg-summer")         = sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s)) / sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s)) + eps ;
Electricity1_rpt(t,r,"price-avg-midseason")      = sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s)) / sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s)) + eps ;
Electricity1_rpt(t,r,"price-avg-janmar")         = sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s)) / sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s)) + eps ;
Electricity1_rpt(t,r,"price-avg-janapr")         = sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s)) / sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s)) + eps ;
Electricity1_rpt(t,r,"price-max")                = smax(s, price(s,r,t)) + eps ;
Electricity1_rpt(t,r,"price-min")                = smin(s, price(s,r,t)) + eps ;
Electricity1_rpt(t,r,"elec-demand")              = sum(s, dref(r,t) * load(s,r) * hours(s)) * 1e-3 + eps ;

Electricity2_rpt(t,r,"price-nuc")$(sum(nuc(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(nuc(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(nuc(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-sol")$(sum(sol(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(sol(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(sol(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-wind")$(sum(wind(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(wind(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(wind(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-windon")$(sum(windon(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windon(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(windon(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-windoff")$(sum(windoff(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windoff(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(windoff(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-bio")$(sum(bio(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(bio(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(bio(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-gas")$(sum(gas(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(gas(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(gas(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-coa")$(sum(i$sameas(i,"Coal"), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Coal"), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(i$sameas(i,"Coal"), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-lig")$(sum(i$sameas(i,"Lignite"), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Lignite"), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(i$sameas(i,"Lignite"), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_rpt(t,r,"price-ccs")$(sum(ccs(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(ccs(i), sum(s, price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(ccs(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;

Electricity3_rpt(t,r,"cost-nuc")$(sum(nuc(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(nuc(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(nuc(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-sol")$(sum(sol(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(sol(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(sol(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-wind")$(sum(wind(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(wind(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(wind(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-windon")$(sum(windon(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windon(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(windon(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-windoff")$(sum(windoff(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windoff(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(windoff(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-bio")$(sum(bio(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(bio(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(bio(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-gas")$(sum(gas(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(gas(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(gas(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-coa")$(sum(i$sameas(i,"Coal"), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Coal"), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(i$sameas(i,"Coal"), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-lig")$(sum(i$sameas(i,"Lignite"), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Lignite"), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(i$sameas(i,"Lignite"), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_rpt(t,r,"cost-ccs")$(sum(ccs(i), sum(s, sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(ccs(i), sum(s, sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum(v, XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(ccs(i), sum(s,                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;

Electricity1_total_rpt(t,"price-avg")           = sum(r, sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r, sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_total_rpt(t,"price-avg-winter")    = sum(r, sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r, sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_total_rpt(t,"price-avg-summer")     = sum(r, sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r, sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_total_rpt(t,"price-avg-midseason")  = sum(r, sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r, sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_total_rpt(t,"price-avg-janmar")     = sum(r, sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r, sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_total_rpt(t,"price-avg-janapr")     = sum(r, sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r, sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_total_rpt(t,"price-max")            = smax((s,r), price(s,r,t)) + eps ;
Electricity1_total_rpt(t,"price-min")            = smin((s,r), price(s,r,t)) + eps ;
Electricity1_total_rpt(t,"elec-demand")          = sum((s,r), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity2_total_rpt(t,"price-nuc")$(sum(nuc(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(nuc(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(nuc(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-sol")$(sum(sol(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(sol(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(sol(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-wind")$(sum(wind(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(wind(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(wind(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-windon")$(sum(windon(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windon(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(windon(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-windoff")$(sum(windoff(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windoff(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(windoff(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-bio")$(sum(bio(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(bio(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(bio(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;                                                
Electricity2_total_rpt(t,"price-gas")$(sum(gas(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(gas(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(gas(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-coa")$(sum(i$sameas(i,"Coal"), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Coal"), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(i$sameas(i,"Coal"), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-lig")$(sum(i$sameas(i,"Lignite"), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Lignite"), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(i$sameas(i,"Lignite"), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity2_total_rpt(t,"price-ccs")$(sum(ccs(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(ccs(i), sum((s,r), price(s,r,t) * sum(v, X.L(s,i,v,r,t)) * hours(s)))
                                                / sum(ccs(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
                                                
                                                
Electricity3_total_rpt(t,"cost-nuc")$(sum(nuc(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(nuc(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(nuc(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-sol")$(sum(sol(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(sol(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(sol(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-wind")$(sum(wind(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(wind(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(wind(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-windon")$(sum(windon(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windon(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(windon(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-windoff")$(sum(windoff(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(windoff(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(windoff(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-bio")$(sum(bio(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(bio(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(bio(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;                                                
Electricity3_total_rpt(t,"cost-gas")$(sum(gas(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(gas(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(gas(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-coa")$(sum(i$sameas(i,"Coal"), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Coal"), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(i$sameas(i,"Coal"), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-lig")$(sum(i$sameas(i,"Lignite"), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Lignite"), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(i$sameas(i,"Lignite"), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-lig")$(sum(i$sameas(i,"Lignite"), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(i$sameas(i,"Lignite"), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(i$sameas(i,"Lignite"), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;
Electricity3_total_rpt(t,"cost-ccs")$(sum(ccs(i), sum((s,r), sum(v, X.L(s,i,v,r,t)) * hours(s))) > 0)
                                                = sum(ccs(i), sum((s,r), sum(v, discostco2(i,v,r,t) * X.L(s,i,v,r,t)) * hours(s)) + sum((v,r), XC.L(i,v,r,t) * 1e+3 *  fomcost(i,v,r)))
                                                / sum(ccs(i), sum((s,r),                sum(v, X.L(s,i,v,r,t)) * hours(s))) + eps ;


Electricity1_GER_rpt(t,"price-avg")              = sum(r$sameas(r,"Germany"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Germany"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_GER_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"Germany"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Germany"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_GER_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"Germany"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Germany"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_GER_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"Germany"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Germany"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_GER_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"Germany"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Germany"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_GER_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"Germany"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Germany"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_GER_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"Germany"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity1_FR_rpt(t,"price-avg")              = sum(r$sameas(r,"France"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"France"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_FR_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"France"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"France"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_FR_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"France"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"France"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_FR_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"France"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"France"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_FR_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"France"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"France"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_FR_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"France"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"France"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_FR_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"France"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity1_UK_rpt(t,"price-avg")              = sum(r$sameas(r,"Britain"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Britain"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_UK_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"Britain"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Britain"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_UK_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"Britain"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Britain"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_UK_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"Britain"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Britain"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_UK_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"Britain"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Britain"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_UK_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"Britain"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Britain"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_UK_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"Britain"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity1_DK_rpt(t,"price-avg")              = sum(r$sameas(r,"Denmark"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Denmark"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_DK_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_DK_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_DK_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_DK_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_DK_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Denmark"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_DK_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"Denmark"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity1_NO_rpt(t,"price-avg")              = sum(r$sameas(r,"Norway"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Norway"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_NO_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"Norway"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Norway"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_NO_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"Norway"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Norway"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_NO_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"Norway"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Norway"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_NO_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"Norway"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Norway"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_NO_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"Norway"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Norway"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_NO_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"Norway"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity1_PL_rpt(t,"price-avg")              = sum(r$sameas(r,"Poland"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Poland"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_PL_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"Poland"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Poland"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_PL_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"Poland"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Poland"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_PL_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"Poland"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Poland"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_PL_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"Poland"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Poland"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_PL_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"Poland"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Poland"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_PL_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"Poland"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Electricity1_ES_rpt(t,"price-avg")              = sum(r$sameas(r,"Spain"), sum(s,             price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Spain"), sum(s,             dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_ES_rpt(t,"price-avg-winter")       = sum(r$sameas(r,"Spain"), sum(s$ssea(s,"w"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Spain"), sum(s$ssea(s,"w"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_ES_rpt(t,"price-avg-summer")       = sum(r$sameas(r,"Spain"), sum(s$ssea(s,"s"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Spain"), sum(s$ssea(s,"s"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_ES_rpt(t,"price-avg-midseason")    = sum(r$sameas(r,"Spain"), sum(s$ssea(s,"m"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Spain"), sum(s$ssea(s,"m"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_ES_rpt(t,"price-avg-janmar")       = sum(r$sameas(r,"Spain"), sum(s$ssea(s,"strm"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Spain"), sum(s$ssea(s,"strm"), dref(r,t) * load(s,r) * hours(s))) + eps ;
Electricity1_ES_rpt(t,"price-avg-janapr")       = sum(r$sameas(r,"Spain"), sum(s$ssea(s,"stra"), price(s,r,t) * dref(r,t) * load(s,r) * hours(s))) / sum(r$sameas(r,"Spain"), sum(s$ssea(s,"stra"), dref(r,t) * load(s,r) * hours(s))) + eps ;
...
Electricity1_ES_rpt(t,"elec-demand")            = sum((s,r)$sameas(r,"Spain"), dref(r,t) * load(s,r) * hours(s)) * 1e-3  + eps ;
...
Storage_FromMarket_rpt(t,j)              
Storage_ToMarket_rpt(t,j) 
;
...
Storage_total_rpt(t,j,"taken from market")       = sum(r, gcharge(r,j,t)) ;
Storage_total_rpt(t,j,"into reservoir")          = sum(r, greserv(r,j,t)) ;
Storage_total_rpt(t,j,"taken from reservoir")    = sum(r, gdcharge(r,j,t)) ;
Storage_total_rpt(t,j,"provided to market")      = sum(r, gmarket(r,j,t)) ;
Storage_total_rpt(t,j,"total storage losses")    = sum(r, gcharge(r,j,t)) - sum(r, gmarket(r,j,t)) ;
...
Storage_FromMarket_rpt(t,j)                      = Storage_total_rpt(t,j,"taken from market") + eps ;
Storage_ToMarket_rpt(t,j)                        = Storage_total_rpt(t,j,"provided to market") + eps ;

parameter
Storage_All_rpt(t,*)
;

Storage_All_rpt(t,"Pump-GenCap") = Storage_GenerationCapacity_rpt(t,"Pumpstorage") ;
Storage_All_rpt(t,"Hyd-GenCap") = Storage_GenerationCapacity_rpt(t,"Storage_LT") ;
Storage_All_rpt(t,"Bat-GenCap") = Storage_GenerationCapacity_rpt(t,"Storage_ST") ;

Storage_All_rpt(t,"Pump-ResCap") = Storage_ReservoirCapacity_rpt(t,"Pumpstorage") ;
Storage_All_rpt(t,"Hyd-ResCap") = Storage_ReservoirCapacity_rpt(t,"Storage_LT") ;
Storage_All_rpt(t,"Bat-ResCap") = Storage_ReservoirCapacity_rpt(t,"Storage_ST") ;

Storage_All_rpt(t,"Pump-FromMarket") = Storage_FromMarket_rpt(t,"Pumpstorage") ;
Storage_All_rpt(t,"Hyd-FromMarket") = Storage_FromMarket_rpt(t,"Storage_LT") ;
Storage_All_rpt(t,"Bat-FromMarket") = Storage_FromMarket_rpt(t,"Storage_ST") ;

Storage_All_rpt(t,"Pump-ToMarket") = Storage_ToMarket_rpt(t,"Pumpstorage") ;
Storage_All_rpt(t,"Hyd-ToMarket") = Storage_ToMarket_rpt(t,"Storage_LT") ;
Storage_All_rpt(t,"Bat-ToMarket") = Storage_ToMarket_rpt(t,"Storage_ST") ;

Storage_All_rpt(t,"GenCap") = sum(j, Storage_GenerationCapacity_rpt(t,j)) ;
Storage_All_rpt(t,"ResCap") = sum(j, Storage_ReservoirCapacity_rpt(t,j)) ;
Storage_All_rpt(t,"FromMarket") = sum(j, Storage_FromMarket_rpt(t,j)) ;
Storage_All_rpt(t,"ToMarket") = sum(j, Storage_ToMarket_rpt(t,j)) ;
...
noweffect_rpt("2022","GER","Gas") = ElectricityGeneration_xtype_rpt("2022","Germany","Gas-CCGT") + ElectricityGeneration_total_xtype_rpt("2022","Gas-OCGT") + ElectricityGeneration_total_xtype_rpt("2022","Gas-ST")+ eps ;
...
noweffect_rpt("2022","GER","Wind") = ElectricityGeneration_xtype_rpt("2022","Germany","WindOn") + ElectricityGeneration_total_xtype_rpt("2022","WindOff") + eps ;
...
noweffect_rpt("2022","FR","Gas") = ElectricityGeneration_xtype_rpt("2022","France","Gas-CCGT") + ElectricityGeneration_total_xtype_rpt("2022","Gas-OCGT") + ElectricityGeneration_total_xtype_rpt("2022","Gas-ST")+ eps ;
...
noweffect_rpt("2022","FR","Wind") = ElectricityGeneration_xtype_rpt("2022","France","WindOn") + ElectricityGeneration_total_xtype_rpt("2022","WindOff") + eps ;
...
discost_rpt(t,r,tyrpt)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) > 0)                 = sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), discost(i,v,r,t) * XTWH.L(i,v,r,t))))
                                                                                                                                    / sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) + eps ;
discost_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) > 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), discost(i,v,r,t) * XTWH.L(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) + eps ;
                                                                                                                      
discostco2_rpt(t,r,tyrpt)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) > 0)              = sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), discostco2(i,v,r,t) * XTWH.L(i,v,r,t))))
                                                                                                                                    / sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) + eps ;
discostco2_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) > 0)  = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), discostco2(i,v,r,t) * XTWH.L(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) + eps ;
                                                                                                                     
fomcost_rpt(t,r,tyrpt)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) > 0)                 = sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), fomcost(i,v,r) * XTWH.L(i,v,r,t))))
                                                                                                                                    / sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) + eps ;
fomcost_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) > 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), fomcost(i,v,r) * XTWH.L(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) + eps ;                                                                                                                        

capcost_rpt(t,r,tyrpt)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) > 0)                 = sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), capcost(i,v,r) * XTWH.L(i,v,r,t))))
                                                                                                                                    / sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) + eps ;
capcost_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) > 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), capcost(i,v,r) * XTWH.L(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) + eps ;                                                                                                                        

effrate_rpt(t,r,tyrpt)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) > 0)                 = sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), effrate(i,v,r) * XTWH.L(i,v,r,t))))
                                                                                                                                    / sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) + eps ;
effrate_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) > 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), effrate(i,v,r) * XTWH.L(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) + eps ;  

emit_rpt(t,r,tyrpt)$(sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) > 0)                    = sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), emit(i,v,r) * XTWH.L(i,v,r,t))))
                                                                                                                                    / sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t)))) + eps ;
emit_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) > 0)        = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), emit(i,v,r) * XTWH.L(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) + eps ;  


discost_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) = 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), discost(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), 1$(discost(i,v,r,t) > 0))))) + eps ;
                                                                                                                                    
discostco2_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) = 0)  = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), discostco2(i,v,r,t)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), 1$(discostco2(i,v,r,t) > 0))))) + eps ;
                                                                                                                                    
fomcost_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) = 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), fomcost(i,v,r)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), 1$(fomcost(i,v,r) > 0))))) + eps ;
                                                                                                                                    
capcost_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) = 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), capcost(i,v,r)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), 1$(capcost(i,v,r) > 0))))) + eps ;
                                                                                                                                    
effrate_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) = 0)     = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), effrate(i,v,r)))))
                                                                                                                                    / sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), 1$(effrate(i,v,r) > 0))))) + eps ;
                                                                                                                                    
emit_total_rpt(t,tyrpt)$(sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), XTWH.L(i,v,r,t))))) = 0)        = sum(r, sum(xtyperpt(tyrpt,type), sum(idef(i,type), sum(v$(v.val le t.val), emit(i,v,r)))))
...
gcapcost_total_rpt(t,j) = sum(r, sum(tv(t,v), gcapcost(j,v,r))) / sum(r, 1) + eps ;

gfomcost_rpt(t,r,j) = sum(tv(t,v), gfomcost(j,v,r)) + eps ;
gfomcost_total_rpt(t,j) = sum(r, sum(tv(t,v), gfomcost(j,v,r))) / sum(r, 1) + eps ;
...
lostload(r,t) = sum(s, hours(s) * BS.L(s,r,t)) * 1e-3 + eps ;
...
flhlearni(ivrt(i_flh(i),v,r,t))$(XC.L(i,v,r,t) > 0) = sum(s, hours(s) * X.L(s,i,v,r,t)) / XC.L(i,v,r,t) ;

flhpoteni(i_flh(i),v,r)$(cap(i,v,r) > 0 or sum(tv(t,v), IX.L(i,r,t)) > 0 and v.val le 2022) = sum(s, hours(s) * vrsc(s,i,v,r)) ;     
$if     set flh     flhpoteni(i_flh(i),v,r)$(cap(i,v,r) > 0 or sum(tv(t,v), IX.L(i,r,t)) > 0 and v.val ge 2023) = sum(s, hours(s) * vrsc_nor(s,i,v,r)) * sum(flhls, flhindexSLOPE(i,r,flhls) * sum(tv(tt,v), RHOFLH.L(i,r,tt-1,flhls))) ;     
$if     set flheur  flhpoteni(i_flh(i),v,r)$(cap(i,v,r) > 0 or sum(tv(t,v), IX.L(i,r,t)) > 0 and v.val ge 2023) = sum(s, hours(s) * vrsceur_nor(s,i,v,r)) * sum(flhls, flheurindexSLOPE(i,flhls) * sum(tv(tt,v), RHOFLHEUR.L(i,tt-1,flhls))) * flheurindex_reg(i,r,v) ;

flhreport("Max",ivrt(i_flh(i),v,r,t))$(cap(i,v,r) > 0 or sum(tv(t,v), IX.L(i,r,t)) > 0) = irnwflh_check(i,v,r) ;
flhreport("Real",ivrt(i_flh(i),v,r,t))$(cap(i,v,r) > 0 or sum(tv(t,v), IX.L(i,r,t)) > 0) = flhlearni(i,v,r,t) ;
flhreport("Pote",ivrt(i_flh(i),v,r,t))$(cap(i,v,r) > 0 or sum(tv(t,v), IX.L(i,r,t)) > 0) = flhpoteni(i,v,r) ;
...
$if     set flh     investflh_irt(ir_flh(i,r),tmyopic(t))    = IFLH.L(i,r,t) ;
$if not set flh     investflh_irt(ir_flh(i,r),tmyopic(t))    = 0 ;
investflh_ir(i,r)       = sum(tmyopic(t), nyrs(t) * investflh_irt(i,r,t)) ;
investflh_it(i,t)       = sum(r, investflh_irt(i,r,t)) ;
investflh_rt(r,t)       = sum(i, investflh_irt(i,r,t)) ;
investflh_i(i)          = sum((r,tmyopic(t)), nyrs(t) * investflh_irt(i,r,t)) ;
investflh_r(r)          = sum((i,tmyopic(t)), investflh_irt(i,r,t)) ;
investflh_t(t)          = sum((i,r), investflh_irt(i,r,t)) ;
investflh               = sum((i,r,tmyopic(t)), nyrs(t) * investflh_irt(i,r,t)) ;

$if     set flheur  investflheur_it(i_flh(i),tmyopic(t))    = IFLHEUR.L(i,t) ;
$if not set flheur  investflheur_it(i_flh(i),tmyopic(t))    = 0 ;
investflheur_i(i)       = sum((tmyopic(t)), nyrs(t) * investflheur_it(i,t)) ;
investflheur_t(t)       = sum((i), investflheur_it(i,t)) ;
investflheur            = sum((i,tmyopic(t)), nyrs(t) * investflheur_it(i,t)) ;
...
$if set flhbenchmark execute_unload 'database\data\researchflhdata_out.gdx', irnwflheur_check ;
$if set flhbenchmark execute 'gdxxrw.exe database\data\researchflhdata_out.gdx    o=database\data\researchflh_data.xlsx   par=irnwflheur_check rng=flhcheck!a1'
...
co2elec_out(t)$(ECEU.L(t) < 0) = ECEU.L(t) + eps ;
co2ind_out(t) = ECEU.L(t) * co2elecind(t) + co2indorgfix(t)  + eps ;
...
Emissions_total_rpt(t,"CO2elec-UKETS") = ECUK.L(t) + eps ;
...
$if     set excelsimple                                                                                                           Emissions_rpt,
...
$if     set excelsimple                                                                                                           AddedCapacities_xtype_rpt,
$if     set excelsimple                                                                                                           gasuse,
$if     set excelsimple                                                                                                           discost_rpt, discost_total_rpt,discostco2_rpt,discostco2_total_rpt,fomcost_rpt,fomcost_total_rpt,capcost_rpt,capcost_total_rpt,effrate_rpt,effrate_total_rpt,emit_rpt,emit_total_rpt
$if     set excelsimple                                                                                                           gcapcost_rpt,gcapcost_total_rpt,gfomcost_rpt,gfomcost_total_rpt,geffrate_rpt,geffrate_total_rpt,
$if     set excelsimple                                                                                                           tcapcost_rpt,tcapcost_total_rpt,tfomcost_rpt,tfomcost_total_rpt,teffrate_rpt,teffrate_total_rpt,                                                                
...
$if     set flhcal                                               stock, accspendings, flheur_ls_rpt, flheur_cost_rpt, flheur_stock_rpt, flheur_check_rpt
                                                                 ...
                                                                 gasuseeu, lostload, lostload, lostload_total, noweffect_rpt, effect_rpt
                                                                 ;
                                                                 
$if      set flhcal            execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=stock rng=stock!a1 par=accspendings rng=accspendings!a1 par=flheur_ls_rpt rng=flheur_ls_rpt!a1 par=flheur_cost_rpt rng=flheur_cost_rpt!a1 par=flheur_check_rpt rng=flheur_check_rpt!a1 par=flheur_stock_rpt rng=flheur_stock_rpt!a1'                                    
...
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_total_rpt rng=Electricity1!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_total_rpt rng=Electricity2!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_total_rpt rng=Electricity3!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_GER_rpt rng=Electricity1_GER!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_GER_rpt rng=Electricity2_GER!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_GER_rpt rng=Electricity3_GER!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_FR_rpt rng=Electricity1_FR!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_FR_rpt rng=Electricity2_FR!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_FR_rpt rng=Electricity3_FR!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_UK_rpt rng=Electricity1_UK!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_UK_rpt rng=Electricity2_UK!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_UK_rpt rng=Electricity3_UK!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_DK_rpt rng=Electricity1_DK!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_DK_rpt rng=Electricity2_DK!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_DK_rpt rng=Electricity3_DK!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_NO_rpt rng=Electricity1_NO!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_NO_rpt rng=Electricity2_NO!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_NO_rpt rng=Electricity3_NO!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_PL_rpt rng=Electricity1_PL!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_PL_rpt rng=Electricity2_PL!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_PL_rpt rng=Electricity3_PL!a1'

$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity1_ES_rpt rng=Electricity1_ES!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity2_ES_rpt rng=Electricity2_ES!a1'
$if      set flhcal       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Electricity3_ES_rpt rng=Electricity3_ES!a1'

$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=ElectricityGeneration_total_xtype_rpt rng=Generation!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=ElectricityGeneration_GER_xtype_rpt rng=Generation_GER!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=ElectricityGeneration_FR_xtype_rpt rng=Generation_FR!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=AddedCapacities_total_xtype_rpt rng=Added!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=InstalledCapacities_total_xtype_rpt rng=Installed!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=Storage_All_rpt rng=Storage_All!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=NTCTransfers_total_rpt rng=NTCTransfers!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=noweffect_rpt rng=noweffect!a1 par=effect_rpt rng=effect!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=discost_total_rpt rng=discost_total!a1 par=discostco2_total_rpt rng=discostco2_total!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=fomcost_total_rpt rng=fomcost_total!a1 par=capcost_total_rpt rng=capcost_total!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=effrate_total_rpt rng=effrate_total!a1 par=emit_total_rpt rng=emit_total!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=gfomcost_total_rpt rng=gfomcost_total!a1 par=gcapcost_total_rpt rng=gcapcost_total!a1 par=geffrate_total_rpt rng=geffrate_total!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=tfomcost_total_rpt rng=tfomcost_total!a1 par=tcapcost_total_rpt rng=tcapcost_total!a1 par=teffrate_total_rpt rng=teffrate_total!a1'
$if      set excelsimple       execute 'gdxxrw.exe report_verysimple_%m%\%e%_rpt.gdx o=excel_%m%\%e%.xlsx par=lostload rng=lostload!a1 par=lostload_total rng=lostload_total!a1'
