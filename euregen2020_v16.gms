...
$if      set streext        $if     set shortrun    lifetime("Nuclear","1990","Germany",t)$(t.val ge 2023 and t.val le 2030) = lifetime("Nuclear","1990","Germany","2022") ;
...
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2020") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = sum(sm(s,m), afnew(m,i,r,t)) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2020") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = sum(sm(s,m), afnew(m,i,r,t)) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2021") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = sum(sm(s,m), afnew(m,i,r,t)) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2021") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = sum(sm(s,m), afnew(m,i,r,t)) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2022") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = sum(sm(s,m), afnew(m,i,r,t)) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2022") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = sum(sm(s,m), afnew(m,i,r,t)) ;

* Set 2023+ availability to average of 2020 and 2021
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023    and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023    and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;
...
$if      set extension      af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = sum(sm(s,m), af_mon2023_ext(m,"Nuclear","Germany")) + eps ; 
$if      set streckbetrieb  af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = sum(sm(s,m), af_mon2023_str(m,"Nuclear","Germany")) + eps ; 
$if      set strext         af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = sum(sm(s,m), af_mon2023_strext(m,"Nuclear","Germany")) + eps ; 
...
$if      set searching   lifetime(ki_del(i),v,r,t) = NO ;
$if      set searching   deprtime(ki_del(i),v,r,t) = NO ;
$if      set searching   capcost(ki_del(i),v,r)    = 0 ;
$if      set searching   vrsc(s,ki_del(i),v,r)     = 0 ;
$if      set searching   invlimLO(ki_del(i),r,t)   = 0 ;
$if      set searching   cap(ki_del(i),v,r)        = 0 ;
...
$if set fixbrdinvest IFLH.FX(i,r,t) = sum(v$(v.val eq t.val), flhrdbudget(i,r,v)) ;
...
FLHTRY(i,r,t) =e= FLHTRY(i,r,t - 1) * delta_k_pa**nyrs(t) + IFLH(i,r,t) * nyrs(t) ;
...
* Helper equations
flh_helper1(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and ir_flh(i,r) and v.val le t.val)..
                XCFLH(i,v,r,t,flhls) =l= irnwlimUP_quantiles(i,r,"q90") * RHOFLH(i,r,t-1,flhls) * flhindexSLOPE(i,r,flhls) ;
flh_helper2(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and ir_flh(i,r) and v.val le t.val)..
                XCFLH(i,v,r,t,flhls) =l= XC(i,v,r,t) * flhindexSLOPE(i,r,flhls) ;
flh_helper3(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and ir_flh(i,r) and v.val le t.val)..
                XCFLH(i,v,r,t,flhls) =g= XC(i,v,r,t) * flhindexSLOPE(i,r,flhls) - irnwlimUP_quantiles(i,r,"q90") * flhindexSLOPE(i,r,flhls)* (1 - RHOFLH(i,r,t-1,flhls)) ;
flh_helper4(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and ir_flh(i,r) and v.val le t.val)..
                XCFLH(i,v,r,t,flhls) =g= 0 ;

* Capacity equations
capacity_noflh(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and not ir_flh(i,r))..
...
capacity_flh(s,ivrt(i,v,r,t))$(tmyopic(t) and ir_flh(i,r))..
                X(s,i,v,r,t) =l=  sum(flhls, XCFLH(i,v,r,t,flhls) * vrsc(s,i,"2022",r)) ;
...
$if set fixrdinvest IFLHEUR.FX(i,t) = sum(v$(v.val eq t.val), flheurrdbudget(i,v)) ;
...
* Helper equations
flheur_helper1(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i) and v.val le t.val)..
                XCFLHEUR(i,v,r,t,flhls) =l= irnwlimUP_quantiles(i,r,"q90") * flheurindexSLOPE(i,flhls) * RHOFLHEUR(i,t-1,flhls) ;
flheur_helper2(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i) and v.val le t.val)..
                XCFLHEUR(i,v,r,t,flhls) =l= XC(i,v,r,t) * flheurindexSLOPE(i,flhls) ;
flheur_helper3(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i) and v.val le t.val)..
...
flheur_helper4(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i) and v.val le t.val)..
                XCFLHEUR(i,v,r,t,flhls) =g= 0 ;

* Capacity equations
capacity_noflheur(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and not i_flh(i))..
                X(s,i,v,r,t) =l=  XCS(s,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) ;              
capacity_flheur(s,ivrt(i,v,r,t))$(tmyopic(t) and i_flh(i))..
                X(s,i,v,r,t) =l=  sum(flhls, XCFLHEUR(i,v,r,t,flhls)) * vrsc(s,i,"2022",r) * flheurindex_reg(i,r,v) ;  
...
$if     set fixbudget    IFLH(i,r,t) =l= sum(v$(t.val eq v.val), flhrdbudget(i,r,v)) ;
eq_flh_rdbudget_rt(r,t)..
$if not set fixbudget        sum(i, IFLH(i,r,t)) =l= sum(i, sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
$if     set fixbudget        sum(i, IFLH(i,r,t)) =e= sum(i, sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
eq_flh_rdbudget_it(i,t)..
...
eq_flh_rdbudget_ir(i,r)..
$if not set fixbudget        sum(t, IFLH(i,r,t)) =l= sum(t, sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
$if     set fixbudget        sum(t, IFLH(i,r,t)) =e= sum(t, sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
eq_flh_rdbudget_t(t)..
$if not set fixbudget        sum((i,r), IFLH(i,r,t)) =l= sum((i,r), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
$if     set fixbudget        sum((i,r), IFLH(i,r,t)) =e= sum((i,r), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
eq_flh_rdbudget_r(r)..
$if not set fixbudget        sum((i,t), IFLH(i,r,t)) =l= sum((i,t), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
$if     set fixbudget        sum((i,t), IFLH(i,r,t)) =e= sum((i,t), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
eq_flh_rdbudget_i(i)..
$if not set fixbudget        sum((r,t), IFLH(i,r,t)) =l= sum((r,t), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
$if     set fixbudget        sum((r,t), IFLH(i,r,t)) =e= sum((r,t), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
eq_flh_rdbudget..
$if not set fixbudget        sum((i,r,t), IFLH(i,r,t)) =l= sum((i,r,t), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
$if     set fixbudget        sum((i,r,t), IFLH(i,r,t)) =e= sum((i,r,t), sum(v$(t.val eq v.val), flhrdbudget(i,r,v))) ;
eq_flheur_rdbuddet_it(i,t)..
...
eq_flheur_rdbudget_i(i)..
$if not set fixbudget        sum(t, IFLHEUR(i,t)) =l= sum(t, sum(v$(t.val eq v.val), flheurrdbudget(i,v))) ;
$if     set fixbudget        sum(t, IFLHEUR(i,t)) =e= sum(t, sum(v$(t.val eq v.val), flheurrdbudget(i,v))) ;
eq_flheur_rdbudget_t(t)..
$if not set fixbudget        sum(i, IFLHEUR(i,t)) =l= sum(i, sum(v$(t.val eq v.val), flheurrdbudget(i,v))) ;
$if     set fixbudget        sum(i, IFLHEUR(i,t)) =e= sum(i, sum(v$(t.val eq v.val), flheurrdbudget(i,v))) ;
eq_flheur_rdbudget..
$if not set fixbudget        sum((i,t), IFLHEUR(i,t)) =l= sum((i,t), sum(v$(t.val eq v.val), flheurrdbudget(i,v))) ;
$if     set fixbudget        sum((i,t), IFLHEUR(i,t)) =e= sum((i,t), sum(v$(t.val eq v.val), flheurrdbudget(i,v))) ;
...
par=co2indorg_in        rng=co2indorg_in!a2          rdim=1 cdim=0
...
co2indorgfix(t) = co2indorg_in(t) * co2indfix_in(t) ;
co2elecind(t) = (1 - co2indfix_in(t)) * co2indshare_in(t) ;
...
co2marketeu(t)$(tmyopic(t))..           ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t) =e= co2sup(t) + TNACUSE(t) ;
...
$if set co2mark $if     set bauprice ECEU.UP(t)$(t.val le 2045) = co2ele_org(t) + 25 ;
$if set co2mark $if     set bauprice ECEU.LO(t)$(t.val le 2045) = co2ele_org(t) - 25 ;

$if set co2mark $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) + 25 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) - 75 ;
...
it_euets(t)$(tmyopic(t))..                                ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t) =l= co2sup(t) + TNACUSE(t) ;
it_tnac(t)$(t.val le 2045 and tmyopic(t))..               TNAC(t)                                                        =e= tnacstart_in - sum(tt$(tt.val le t.val and tt.val ge 2022), TNACUSE(tt) * nyrs(tt)) ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val le 2045) = co2ele_org(t) + 25 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(t.val le 2045) = co2ele_org(t) - 25 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 500 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) + 250 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2023")) = co2ele_org(t) + 360 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2023")) = co2ele_org(t) + 100 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2024")) = co2ele_org(t) + 250 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2024")) = co2ele_org(t) + 50 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2025")) = co2ele_org(t) + 150 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2025")) = co2ele_org(t) + 0 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) + 25 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) - 75 ;
...
eqs_euets(t)$(tmyopic(t))..                                                 ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t)
...
eqs_cancel(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..          CANCEL(t)                   =e= MSR(t-1) + MSRIN(t-1) - MSROUT(t-1) + MSRIN(t) - MSROUT(t) - co2auctioned_in(t-1) ;
...
*$if      set co2mips  $if      set shortrun   CANCEL.FX(t)$(t.val ge 2035) = 0 ;

*$if set co2mips $if     set bauprice ECEU.UP(t)$(t.val le 2045) = co2ele_org(t) + 25 ;
*$if set co2mips $if     set bauprice ECEU.LO(t)$(t.val le 2045) = co2ele_org(t) - 25 ;

*$if set co2mips $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) + 25 ;
*$if set co2mips $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) - 50 ;
...
$if not  set bauprice   $if     set banking $gdxin limits\%l%_bauprice.gdx
$if not  set bauprice   $if not set banking $gdxin limits\%l%_bauprice_nobanking.gdx
...
$if not  set bauprice                           IX.FX(nuc(i),r,t)$(t.val le 2030)       = ixfx(i,r,t) ;
...
$if not  set bauprice   $if not set shortrun    IX.FX("Nuclear",r,t)$(t.val le 2025)   = ixfx(i,r,t) ;
...
IX.FX(nuc(i),r,t)$(t.val le 2030 and not invlimLO(i,r,t) > 0) = 0 ;
IX.UP(nuc(i),r,t)$(t.val le 2030 and     invlimLO(i,r,t) > 0) = invlimLO(i,r,t) ;
...
$if set flheur $if set flh  IX.FX("WindOn_q70",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOn_q50",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOn_q30",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOn_q10",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOff_q70",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOff_q50",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOff_q30",r,t) = 0 ;
$if set flheur $if set flh  IX.FX("WindOff_q10",r,t) = 0 ;

$ontext
IX.FX("OpenPV_q70",r,t)$(not sameas(r,"Spain") or not sameas(r,"Italy") or not sameas(r,"Greece")) = 0 ;
IX.FX("OpenPV_q50",r,t)$(not sameas(r,"Spain") or not sameas(r,"Italy") or not sameas(r,"Greece")) = 0 ;
IX.FX("OpenPV_q30",r,t) = 0 ;
IX.FX("OpenPV_q10",r,t) = 0 ;

IX.FX("WindOn_q50",r,t)$(not sameas(r,"Denmark")) = 0 ;
IX.FX("WindOn_q30",r,t) = 0 ;
IX.FX("WindOn_q10",r,t) = 0 ;

IX.FX("WindOff_q70",r,t) = 0 ;
IX.FX("WindOff_q50",r,t) = 0 ;
IX.FX("WindOff_q30",r,t) = 0 ;
IX.FX("WindOff_q10",r,t) = 0 ;

IX.FX("Hydro",r,t) = 0 ;
IX.FX("Lignite",r,t) = 0 ;
IX.FX("Lignite_CCS",r,t) = 0 ;
IX.FX("Coal",r,t)$(t.val le 2030) = 0 ;
IX.FX("Coal_CCS",r,t) = 0 ;
IX.FX("OilOther",r,t) = 0 ;
$offtext
...
* Generation
$if not  set flheur   $if not  set flh           capacity
...
$if      set trans                               copytc
* * * Regional Learning-by-Doing
$if      set doing       $if      set recall       $if not set                        acc_q_recall2020
$if      set doing       $if      set recall       $if not set      $if       set leg acc_q_leg_recall2020
$if      set doing       $if      set recall       $if not set                        acc_q_recall
$if      set doing       $if      set recall       $if not set      $if       set leg acc_q_leg_recall
$if      set doing       $if      set continuous   $if not set                        acc_q_continuous2020
$if      set doing       $if      set continuous   $if not set      $if       set leg acc_q_leg_continuous2020
$if      set doing       $if      set continuous   $if not set                        acc_q_continuous
$if      set doing       $if      set continuous   $if not set      $if       set leg acc_q_leg_continuous
$if      set doing       $if      set discrete     $if not set                        acc_q_discrete2020
$if      set doing       $if      set discrete     $if not set      $if       set leg acc_q_leg_discrete2020
$if      set doing       $if      set discrete     $if not set                        acc_q_discrete
$if      set doing       $if      set discrete     $if not set      $if       set leg acc_q_leg_discrete
$if      set doing       $if      set constant     $if not set                        capex_constant
$if      set doing       $if      set nonlinear    $if not set                        capex_nonlinear
$if      set doing       $if      set nonlinear    $if not set                        acc_capex_nonlinear
$if      set doing       $if      set nonlinear    $if not set      $if       set leg acc_capex_leg_nonlinear
$if      set doing       $if      set mip          $if not set                        capex_mixedip
$if      set doing       $if      set mip          $if not set                        acc_capex_mixedip
$if      set doing       $if      set mip          $if not set      $if       set leg acc_capex_leg_mixedip
$if      set doing       $if      set mip          $if not set                        rho_mixedip
$if      set doing       $if      set mip          $if not set      $if       set leg rho_leg_mixedip
$if      set doing       $if      set mip          $if not set                        qlsLO_mixedip
$if      set doing       $if      set mip          $if not set      $if       set leg qlsLO_leg_mixedip
$if      set doing       $if      set mip          $if not set                        qlsUP_mixedip
$if      set doing       $if      set mip          $if not set      $if       set leg qlsUP_leg_mixedip
$if      set doing       $if      set mip          $if not set                        acc_qls_mixedip
$if      set doing       $if      set mip          $if not set      $if       set leg acc_qls_leg_mixedip
* Max constraints
$if      set doing       $if      set mip          $if not set                        acc_q_max
$if      set doing       $if      set mip          $if not set      $if       set leg acc_q_leg_max
* Monotonicity constraints
$if      set doing       $if      set recall       $if not set                        acc_q_mono
$if      set doing       $if      set recall       $if not set      $if       set leg acc_q_leg_mono
$if      set doing       $if      set recall       $if not set                        rho_mixedip_mono
$if      set doing       $if      set recall       $if not set      $if       set leg rho_leg_mixedip_mono
$if      set doing       $if      set recall       $if not set                        qls_mixedip_mono
$if      set doing       $if      set recall       $if not set      $if       set leg qls_leg_mixedip_mono
* * * opean Learning-by-Doing
$if      set doing       $if      set recall       $if     set                        acc_q_recall2020
$if      set doing       $if      set recall       $if     set      $if       set leg acc_q_leg_recall2020
$if      set doing       $if      set recall       $if     set                        acc_q_recall
$if      set doing       $if      set recall       $if     set      $if       set leg acc_q_leg_recall
$if      set doing       $if      set continuous   $if     set                        acc_q_continuous2020
$if      set doing       $if      set continuous   $if     set      $if       set leg acc_q_leg_continuous2020
$if      set doing       $if      set continuous   $if     set                        acc_q_continuous
$if      set doing       $if      set continuous   $if     set      $if       set leg acc_q_leg_continuous
$if      set doing       $if      set discrete     $if     set                        acc_q_discrete2020
$if      set doing       $if      set discrete     $if     set      $if       set leg acc_q_leg_discrete2020
$if      set doing       $if      set discrete     $if     set                        acc_q_discrete
$if      set doing       $if      set discrete     $if     set      $if       set leg acc_q_leg_discrete
$if      set doing       $if      set constant     $if     set                        capex_constant
$if      set doing       $if      set nonlinear    $if     set                        capex_nonlinear
$if      set doing       $if      set nonlinear    $if     set                        acc_capex_nonlinear
$if      set doing       $if      set nonlinear    $if     set      $if       set leg acc_capex_leg_nonlinear
$if      set doing       $if      set mip          $if     set                        capex_mixedip
$if      set doing       $if      set mip          $if     set                        acc_capex_mixedip
$if      set doing       $if      set mip          $if     set      $if       set leg acc_capex_leg_mixedip
$if      set doing       $if      set mip          $if     set                        rho_mixedip
$if      set doing       $if      set mip          $if     set      $if       set leg rho_leg_mixedip
$if      set doing       $if      set mip          $if     set                        qlsLO_mixedip
$if      set doing       $if      set mip          $if     set      $if       set leg qlsLO_leg_mixedip
$if      set doing       $if      set mip          $if     set                        qlsUP_mixedip
$if      set doing       $if      set mip          $if     set      $if       set leg qlsUP_leg_mixedip
$if      set doing       $if      set mip          $if     set                        acc_qls_mixedip
$if      set doing       $if      set mip          $if     set      $if       set leg acc_qls_leg_mixedip
* Max constraints
$if      set doing       $if      set mip          $if     set                        acc_q_max
$if      set doing       $if      set mip          $if     set      $if       set leg acc_q_leg_max
* Monotonicity constraints
$if      set doing       $if      set recall       $if     set                        acc_q_mono
$if      set doing       $if      set recall       $if     set      $if       set leg acc_q_leg_mono
$if      set doing       $if      set recall       $if     set                        rho_mixedip_mono
$if      set doing       $if      set recall       $if     set      $if       set leg rho_leg_mixedip_mono
$if      set doing       $if      set recall       $if     set                        qls_mixedip_mono
$if      set doing       $if      set recall       $if     set      $if       set leg qls_leg_mixedip_mono
* * * Regional Learning-by-Searching
$if      set searching   $if      set mip          $if not set                        acc_k_continuous2020
$if      set searching   $if      set mip          $if not set                        acc_k_continuous
$if      set searching   $if      set mip          $if not set                        rho_mixedip_k
$if      set searching   $if      set mip          $if not set                        capex_mixedip_k
$if      set searching   $if      set mip          $if not set                        searching_helper1
$if      set searching   $if      set mip          $if not set                        searching_helper2
$if      set searching   $if      set mip          $if not set                        searching_helper3
$if      set searching   $if      set mip          $if not set                        searching_helper4
$if      set searching   $if      set mip          $if not set                        capcost_mixedip_k
$if      set searching   $if      set mip          $if not set                        klsLO_mixedip
$if      set searching   $if      set mip          $if not set                        klsUP_mixedip
$if      set searching   $if      set mip          $if not set                        acc_kls_mixedip
* Budget constraints
$if      set searching   $if      set mip          $if not set     $if      set budgetirt       eq_rd_budget_irt
$if      set searching   $if      set mip          $if not set     $if      set budgetrt        eq_rd_budget_rt
$if      set searching   $if      set mip          $if not set     $if      set budgetit        eq_rd_budget_it
$if      set searching   $if      set mip          $if not set     $if      set budgetir        eq_rd_budget_ir
$if      set searching   $if      set mip          $if not set     $if      set budgett         eq_rd_budget_t
$if      set searching   $if      set mip          $if not set     $if      set budgetr         eq_rd_budget_r
$if      set searching   $if      set mip          $if not set     $if      set budgeti         eq_rd_budget_i
$if      set searching   $if      set mip          $if not set     $if      set budget          eq_rd_budget
* * * opean Learning-by-Searching
$if      set searching   $if      set mip          $if     set                        acc_k_continuous2020
$if      set searching   $if      set mip          $if     set                        acc_k_continuous
$if      set searching   $if      set mip          $if     set                        rho_mixedip_k
$if      set searching   $if      set mip          $if     set                        capex_mixedip_k
$if      set searching   $if      set mip          $if     set                        searching_helper1
$if      set searching   $if      set mip          $if     set                        searching_helper2
$if      set searching   $if      set mip          $if     set                        searching_helper3
$if      set searching   $if      set mip          $if     set                        searching_helper4
$if      set searching   $if      set mip          $if     set                        capcost_mixedip_k
$if      set searching   $if      set mip          $if     set                        klsLO_mixedip
$if      set searching   $if      set mip          $if     set                        klsUP_mixedip
$if      set searching   $if      set mip          $if     set                        acc_kls_mixedip
* Budget constraints
$if      set searching   $if      set mip          $if     set     $if      set budgetit     eq_rd_budget_it
$if      set searching   $if      set mip          $if     set     $if      set budgeti      eq_rd_budget_i
$if      set searching   $if      set mip          $if     set     $if      set budgett      eq_rd_budget_t
$if      set searching   $if      set mip          $if     set     $if      set budget       eq_rd_budget
...
* * * Regional flheur Learning-by-sarching
...
$if      set flheur     capacity_noflheur
...
$if      set flh     capacity_noflh
$if      set flh     capacity_flh
* * * FLH budget constraints
$if      set flh        $if     set budget_irt      eq_flh_rdbudget_irt        
$if      set flh        $if     set budget_ir       eq_flh_rdbudget_rt 
...
$if      set flheur     $if     set budget_it       eq_flheur_rdbuddet_it 
