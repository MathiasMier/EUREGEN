...
ivrt(nuc(i),newv(v),r,t)$(sum(tt$(tt.val le t.val), invlimLO(i,r,tt)) eq 0 and t.val le 2035) = NO ;
...
jvrt("Storage_ST",v,r,t)$(v.val le 2021)        = NO ;
jvrt("Storage_LT",v,r,t)$(v.val le 2021)        = NO ;
