...
$if      set nuclear75         fomcost("Nuclear",v,r) = 0.75 * fomcost_int("Nuclear",v,r) ;
$if      set nuclear125        fomcost("Nuclear",v,r) = 1.25 * fomcost_int("Nuclear",v,r) ;
$if      set nuclear150        fomcost("Nuclear",v,r) = 1.5 * fomcost_int("Nuclear",v,r) ;
$if      set nuclear175        fomcost("Nuclear",v,r) = 1.5 * fomcost_int("Nuclear",v,r) ;
