...
$if      set strext         $if not set longrun af(s,ivrt("Nuclear","1990","Germany",t))$(reliability("Nuclear","1990","Germany") > 0 and t.val ge 2024) = sum(sm(s,m), af_mon2023_strext(m,"Nuclear","Germany")) + eps ;
