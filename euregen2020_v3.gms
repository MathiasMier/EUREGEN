...
$gdxin database\setpar_%n%.gdx
$load cap, invlimUP, invlimLO, invlimUP_eu, invlife, invdepr, capcost, fomcost, vomcost, effrate, co2captured, emit, reliability, capcred, mindisp
$load sclim_int=sclim, sclim_eu_int=sclim_eu, biolim_int=biolim, biolim_eu_int=biolim_eu
$gdxin

* Corresting SC limits because much of this potential is needed after 2050 when "sucking" technologies become competitive (to restore climate)
$if      set nofrictions       sclim_eu = 1   * sclim_eu_int ;
...
$if      set nofrictions       sclim(r) = 1   * sclim_int(r) ;
...
* Corresting biomass limits because not all biomass can go into the power plants (food, traffic, ...)
...
$if      set nofrictions      invlimLO(i,r,t)    = 0 ;
$if      set nofrictions      invlimUP(i,r,t)    = inf ;
$if      set nofrictions     tinvlimLO(k,r,rr,t) = 0 ;
$if      set nofrictions     tinvlimUP(k,r,rr,t) = inf ;
$if      set nofrictions     ginvlimLO(j,r,t)    = 0 ;
$if      set nofrictions     ginvlimUP(j,r,t)    = inf ;
...
af(s,i,v,r,t) = sum(sm(s,m), af_mon(m,i,r)) ;
...
* * * Regional Learning-by-doing module
set
...
capcost_lea(i,r)         Cost of learning technologies (EUR per kW)
...
capcost(i_lea(i),v,r)       = capcost_lea(i,v,r) ;
...
EQUATION
acc_q_recall2015(i,r,t)          Accumulation of capacity in 2015 (doing)
acc_q_leg_recall2015(i,r,t)      Accumulation of legacy capacity in 2015 (doing)
acc_q_recall(i,r,t)              Accumulation of capacity (doing)
acc_q_leg_recall(i,r,t)          Accumulation of legacy capacity (doing)
acc_q_continuous2015(i,r,t)      Accumulation of capacity in 2015 (doing)
acc_q_leg_continuous2015(i,r,t)  Accumulation of legacy capacity in 2015 (doing)
acc_q_continuous(i,r,t)          Accumulation of capacity (doing)
acc_q_leg_continuous(i,r,t)      Accumulation of legacy capacity (doing)
acc_q_discrete2015(i,r,t)        Accumulation of capacity in 2015 (doing)
acc_q_leg_discrete2015(i,r,t)    Accumulation of legacy capacity in 2015 (doing)
...
* with perfect recall
acc_q_recall2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= qSTART(i,r) * 1e-3 ;
acc_q_leg_recall2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= QTRY(i,r,t) ;
acc_q_recall(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= qSTART(i,r) * 1e-3 + sum(tt$(tt.val le t.val), IX(i,r,tt)) * 1e-3 ;
acc_q_leg_recall(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= QTRY(i,r,t-1) ;

* with continuous depreciation
acc_q_continuous2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= sum(oldv(v), delta_q_pa**(t.val - v.val) * cap(i,v,r)) * 1e-3  ;
acc_q_leg_continuous2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= QTRY(i,r,t);
acc_q_continuous(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= QTRY(i,r,t-1) * delta_q + IX(i,r,t) * 1e-3 ;                
acc_q_leg_continuous(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= QTRY(i,r,t-1) * delta_q ;

* with discrete depreciation
acc_q_discrete2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= sum(oldv, lifetime(i,oldv,r,t) * cap(i,oldv,r)) * 1e-3 ;
acc_q_leg_discrete2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= QTRY(i,r,t);
acc_q_discrete(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= sum(oldv, lifetime(i,oldv,r,t) * cap(i,oldv,r)) * 1e-3 + sum(newv(v)$(v.val < t.val), lifetime(i,v,r,t) * sum(tv(tt,v), IX.L(i,r,tt))) * 1e-3 + IX.L(i,r,t) * 1e-3 ;
acc_q_leg_discrete(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= sum(oldv, lifetime(i,oldv,r,t) * cap(i,oldv,r)) * 1e-3 + sum(newv(v)$(v.val < t.val), lifetime(i,v,r,t) * sum(tv(tt,v), IX.L(i,r,tt))) * 1e-3 ;                
...
acc_capex_leg_mixedip(i,r,t)$(i_lea(i) and r_lea(r))..
...
rho_mixedip(i,r,t)$(i_lea(i) and r_lea(r))..
                 sum(ls, RHO(i,r,t,ls))     =e= 1 ;
rho_leg_mixedip(i,r,t)$(i_lea(i) and r_lea(r))..
...
qlsLO_mixedip(i,r,t,ls)$(i_lea(i) and r_lea(r))..
                 QLS(i,r,t,ls)           =g= qlsLO(i,r,ls) * RHO(i,r,t,ls) * 1e-3 ;
qlsLO_leg_mixedip(i,r,t,ls)$(i_lea(i) and r_lea(r))..
...
qlsUP_mixedip(i,r,t,ls)$(i_lea(i) and r_lea(r))..
                 QLS(i,r,t,ls)           =l= qlsUP(i,r,ls) * RHO(i,r,t,ls) * 1e-3 ;
qlsUP_leg_mixedip(i,r,t,ls)$(i_lea(i) and r_lea(r))..
...
acc_qls_mixedip(i,r,t)$(i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)             =e= sum(ls, QLS(i,r,t,ls)) ;
acc_qls_leg_mixedip(i,r,t)$(i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)         =e= sum(ls, QLS_LEG(i,r,t,ls)) ;

* * * European Learning-by-doing module
PARAMETER
...
capcosteur_lea(i)         Capacity cost
...
EQUATION
acc_qeur_recall2015(i,t)         Accumulation of capacity in 2015 in Europe (doing)
acc_qeur_leg_recall2015(i,t)     Accumulation of legacy capacity in 2015 in Europe (doing)
...
acc_qeur_continuous2015(i,t)     Accumulation of capacity in 2015 in Europe (doing)
acc_qeur_leg_continuous2015(i,t) Accumulation of legacy capacity in 2015 in Europe (doing)
...
acc_qeur_discrete2015(i,t)       Accumulation of capacity in 2015 in Europe (doing)
acc_qeur_leg_discrete2015(i,t)   Accumulation of legacy capacity in 2015 in Europe (doing)
...
* * Accumulated capacity stock (legacy capacity concept is used to account for the fact that some capacity depreciates between period t and t-1 and to thus become cost right)
* with perfect recall
acc_qeur_recall2015(i,t)$(tbase(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= qeurSTART(i) * 1e-3 ;
acc_qeur_leg_recall2015(i,t)$(tbase(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= QTRYEUR(i,t) ;
acc_qeur_recall(i,t)$(not tbase(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= qeurSTART(i) * 1e-3 + sum(tt$(tt.val le t.val), sum(r, IX(i,r,tt))) * 1e-3  ;
acc_qeur_leg_recall(i,t)$(not tbase(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= QTRYEUR(i,t-1) ;

* with continuous depreciation
acc_qeur_continuous2015(i,t)$(tbase(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= sum(oldv(v), delta_q_pa**(t.val - v.val) * sum(r, cap(i,v,r))) * 1e-3 ;
acc_qeur_leg_continuous2015(i,t)$(tbase(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= QTRYEUR(i,t);
acc_qeur_continuous(i,t)$(not tbase(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= QTRYEUR(i,t-1) * delta_q + sum(r, IX(i,r,t)) * 1e-3 ;
acc_qeur_leg_continuous(i,t)$(not tbase(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= QTRYEUR(i,t-1) * delta_q ;

* with discrete depreciation
acc_qeur_discrete2015(i,t)$(tbase(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= sum(oldv, sum(r, lifetime(i,oldv,r,t) * cap(i,oldv,r))) * 1e-3 ;
acc_qeur_leg_discrete2015(i,t)$(tbase(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= QTRYEUR(i,t);
acc_qeur_discrete(i,t)$(not tbase(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= sum(oldv, sum(r, lifetime(i,oldv,r,t) * cap(i,oldv,r))) * 1e-3 + sum(newv(v)$(v.val < t.val), sum(r, lifetime(i,v,r,t) * sum(tv(tt,v), IX(i,r,tt)))) * 1e-3 + sum(r, IX(i,r,t)) * 1e-3 ;
acc_qeur_leg_discrete(i,t)$(not tbase(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= sum(oldv, sum(r, lifetime(i,oldv,r,t) * cap(i,oldv,r))) * 1e-3 + sum(newv(v)$(v.val < t.val), sum(r, lifetime(i,v,r,t) * sum(tv(tt,v), IX(i,r,tt)))) * 1e-3 ;
...
acc_capexeur_leg_mixedip(i,t)$(i_lea(i))..
...
EQUATION
acc_rdbudget
acc_k_continuous2015(i,r,t)      Accumulation of R&D (searching)
...
acc_rdbudget..
                 sum((i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r)), IK(i,r,t)) =l= sum((i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r)), rd_budget(i,r,t)) ;
* Accumulation of knowledge stock
acc_k_continuous2015(i,r,t)$(tbase(t) and i_lea(i) and r_lea(r))..
                 KTRY(i,r,t)       =e=    kSTART(i,r) + IK(i,r,t) ;
acc_k_continuous(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
...
capex_mixedip_k(i,r,t)$(not tbase(t) and i_lea(i) and r_lea(r))..
...
searching_helper1(i,r,t,kls)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 IXLS(i,r,t,kls)          =l=     2000 * KRHO(i,r,t-1,kls) ;
searching_helper2(i,r,t,kls)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 IXLS(i,r,t,kls)          =l=     IX(i,r,t) ;
searching_helper3(i,r,t,kls)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 IXLS(i,r,t,kls)          =g=     IX(i,r,t) - 2000 * (1 - KRHO(i,r,t-1,kls)) ;
searching_helper4(i,r,t,kls)$(not tbase(t) and i_lea(i) and r_lea(r))..
                 IXLS(i,r,t,kls)          =g=     0 ;
...
capcost_mixedip_k(i,r,t)$(i_lea(i) and r_lea(r))..
                 KCAPCOST_MIP(i,r,t)             =e= sum(kls, KRHO(i,r,t,kls) * kslope_mip(i,r,kls) ) ;
* This equation enforeces that always just one line segment is active
rho_mixedip_k(i,r,t)$(i_lea(i) and r_lea(r))..
...
klsLO_mixedip(i,r,t,kls)$(i_lea(i) and r_lea(r))..
...
klsUP_mixedip(i,r,t,kls)$(i_lea(i) and r_lea(r))..
...
acc_kls_mixedip(i,r,t)$(i_lea(i) and r_lea(r))..
                 KTRY(i,r,t)                     =e= sum(kls, KQLS(i,r,t,kls)) ;

* * * European Learning-by-Searching module
PARAMETER
...
EQUATION
acc_rdbudgeteur
acc_keur_continuous2015(i,t)     Accumulation of 2015 R&D (searching)
...
acc_rdbudgeteur..
                 sum((i,t)$(not tbase(t) and i_lea(i)), IKEUR(i,t)) =l= sum((i,t)$(not tbase(t) and i_lea(i)), rd_budgeteur(i,t))  ;
* Accumulation of knowledge stock
acc_keur_continuous2015(i,t)$(tbase(t) and ki_lea(i))..
                 KTRYEUR(i,t)       =e=    keurSTART(i) + IKEUR(i,t) ;
acc_keur_continuous(i,t)$(not tbase(t) and ki_lea(i))..
...
* * * Assume MIP approximation of NLP problem
* Capacity cost follow from the investment on a line segment and the slope of this line segment
capexeur_mixedip_k(i,t)$(not tbase(t) and ki_lea(i))..
                 KCAPEXEUR_MIP(i,t)        =e=  sum(kls, IXEURLS(i,t,kls) * kslopeeur_mip(i,kls)) ;
* Additional constraints in order to linearise IX*RHO, which is replaced by a new helper variable IXLS above
* RHO of t-1 to realise the time lag of one period until the cost degressions materialise
searchingeur_helper1(i,t,kls)$(not tbase(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =l=     2000 * KRHOEUR(i,t-1,kls) ;
searchingeur_helper2(i,t,kls)$(not tbase(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =l=     sum(r, IX(i,r,t)) ;
searchingeur_helper3(i,t,kls)$(not tbase(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =g=     sum(r, IX(i,r,t)) - 2000 * (1 - KRHOEUR(i,t-1,kls)) ;
searchingeur_helper4(i,t,kls)$(not tbase(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =g=     0 ;
* Capacity cost follow from the linear approximation of the learning curve (Learning by searching) (just placeholder equation, maybe delete later)
capcosteur_mixedip_k(i,t)$(ki_lea(i))..
                 KCAPCOSTEUR_MIP(i,t)             =e= sum(kls, KRHOEUR(i,t,kls) * kslopeeur_mip(i,kls) ) ;
* This equation enforeces that always just one line segment is active
rhoeur_mixedip_k(i,t)$(ki_lea(i))..
                 sum(kls, KRHOEUR(i,t,kls))       =e= 1 ;
* Capacity stock per line segment is greater than the lower bound of that line segment (Learning by searching)
keurlsLO_mixedip(i,t,kls)$(ki_lea(i))..
                 KEURLS(i,t,kls)                  =g= keurlsLO(i,kls) * KRHOEUR(i,t,kls) ;
* Capacity stock per line segment is lower than the upper bound of that line segment (Learning by searching)
keurlsUP_mixedip(i,t,kls)$(ki_lea(i))..
                 KEURLS(i,t,kls)                  =l= keurlsUP(i,kls) * KRHOEUR(i,t,kls) ;
* Capacity stock per "active" (rho = 1) line segment is equal to capacity stock (Learning by searching)
acc_keurls_mixedip(i,t)$(ki_lea(i))..
                 KTRYEUR(i,t)                     =e= sum(kls, KEURLS(i,t,kls)) ;

* * * Learning module addings
EQUATION
nuclear_restriction(i)           Restricts nuclear expansion to 100 GW
;

nuclear_restriction(i)$(sameas(i,"Nuclear"))..
                 sum((r,t), IX(i,r,t)) =l= 150 ;
                 
* * Learning-by-searching upper bounds on RD investments
$if      set searching   $if      set eur IK.UP(i,r,t)$(ki_lea(i) and kr_lea(r) and rd_budget(i,r,t)) = rd_budget(i,r,t) ;
$if      set searching   $if not  set eur IKEUR(i,t)$(ki_lea(i) and rd_budgeteur(i,t)) = rd_budgeteur(i,t) ;

* * * Warm-start calibration routine for MIP and NLP problems
set
ls_int_%cv%
kls_int_%cv%
;
...
IT_int_%cv%(transmission,r,r,t)               Investment in transmission (total GW to be added from t-1 to t)
TC_int_%cv%(transmission,r,r,t)               New Trade flow capacity (GW)
TCS_int_%cv%(s,transmission,r,r,t)            New Trade flow capacity (GW)
...
$gdxin calibration_%cv%\%ncal%.gdx
$load BS_int_%cv%,X_int_%cv%,XC_int_%cv%,IX_int_%cv%,XCS_int_%cv%,XTWH_int_%cv%,G_int_%cv%,GD_int_%cv%,GC_int_%cv%,GCS_int_%cv%,IG_int_%cv%,GB_int_%cv%,E_int_%cv%,IT_int_%cv%,TC_int_%cv%,BC_r_int_%cv%,SC_r_int_%cv%,EC_int_%cv%,SURPLUS_int_%cv%
...
E.L(s,transmission,r,rr,t) = E_int_%cv%(s,transmission,r,rr,t) ;
IT.L(transmission,r,rr,t)  = IT_int_%cv%(transmission,r,rr,t) ;
TC.L(transmission,r,rr,t)  = TC_int_%cv%(transmission,r,rr,t) ;
*TCS.L(s,transmission,r,rr,t) = TCS_int_%cv%(s,transmission,r,rr,t) ;
...
exlife(ivrt(i,oldv(v),r,t))$(not sameas(t,"2020") and tmyopic(t)
         ) ..
         XC(i,v,r,t)
...
cumbio(t)$(biolim_eu(t) and (biolim_eu(t) < inf) and tmyopic(t))..          BC(t)           =l= biolim_eu(t) ;
* for each region (does not allow for system-wide trade)
...
IX.FX(i,r,tbase) = 0 ;
$if      set trans       IT.FX(k,r,rr,tbase) = 0 ;
$if      set storage     IG.FX(j,r,tbase) = 0 ;
* Avoidance of frictions
$if not  set nofrictions IX.FX(ccs(i),r,t)$(t.val le 2025) = 0 ;
$if not  set nofrictions IX.FX(nuc(i),r,t)$(t.val le 2030 and not invlimLO(i,r,t) > 0) = 0 ;
