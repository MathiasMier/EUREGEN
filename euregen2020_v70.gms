...
$gdxin database\setpar_%n%.gdx
$load daref_sec=daref_sec_r, dref_sec=dref_sec_r
$gdxin

dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 1.0) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
...
$if     set newdemand =g=                     1e-3 * hours(s) * round(load_st(s,r,t) *
$if     set newdemand $if not set lossnewtemp (1 + loss(r)),4)
$if     set newdemand $if     set lossnewtemp (1 + losss(s,r,t)),4)
...
$if not set newdemand   dtwhdef(r,t)$tmyopic(t)..                           DTWH(r,t)       =e= 1e-3 * sum(s, hours(s) * (round(load(s,r) * dref(r,t),4) - BS(s,r,t) - sum(bse, BSELAS(bse,s,r,t)))) ;
$if     set newdemand   dtwhdef(r,t)$tmyopic(t)..                           DTWH(r,t)       =e= 1e-3 * sum(s, hours(s) * (load_st(s,r,t) - BS(s,r,t) - sum(bse, BSELAS(bse,s,r,t)))) ;
...
convtarget(i,r,t)$(sameas(i,"Nuclear") and sameas(r,"France") and t.val ge 2035 and tmyopic(t))..
    sum(ivrt(i,v,r,t)$(v.val le t.val), XTWH(i,v,r,t)) =g= round(frnuctgt(t) * daref(r,t),4) ;
