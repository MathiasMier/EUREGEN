...
lign_out(r,t)$(t.val ge 2022) = smax(t$(t.val le 2021), lign_out(r,t)) ;

genUP_lign(r,t)$(tmyopic(t) and rlignite(r))..
    sum(ivrt("Lig_CHP",oldv(v),r,t), XTWH("Lig_CHP",v,r,t)/effrate("Lig_CHP",v,r)) + sum(ivrt("Lignite",oldv(v),r,t), XTWH("Lignite",v,r,t)/effrate("Lignite",v,r)) =l= lign_out(r,t) * 1.2 ;
 
genLO_lign(r,t)$(tmyopic(t) and rlignite(r))..
    sum(ivrt("Lig_CHP",oldv(v),r,t), XTWH("Lig_CHP",v,r,t)/effrate("Lig_CHP",v,r)) + sum(ivrt("Lignite",oldv(v),r,t), XTWH("Lignite",v,r,t)/effrate("Lignite",v,r)) =g= lign_out(r,t) * 0.8 ;
