...
*weldef..
*        WELFARE =e= - sum(t$(tmyopic(t)), dfact(t) * sum(r, surplus_adj(r,t) * weight_short * WELFARE_short(r,t) + weight_long * surplus_adj(r,t) * surplus_fact(r,t) * WELFARE_LONG(r,t))) + SURPLUS ;

*weldef_short(r,t)..
*        WELFARE_short(r,t) =e= sum(s, hours(s) * sum(bse,  DS(bse,s,r,t)        * 1e+3 * cb_1(bse,s,r,t) + 0.5 * DS(bse,s,r,t)    * DS(bse,s,r,t)    * 1e+6  * cb_2(bse,s,r,t))) * 1e-6 ;       
*weldef_long(r,t)..
*        WELFARE_long(r,t)  =e= 8760 *                     (DTWH(r,t) / 8760     * 1e+6 * cb_1dtwh(r,t)   + 0.5 * DTWH(r,t) / 8760 * DTWH(r,t) / 8760 * 1e+12 * cb_2dtwh(r,t))    * 1e-6 ;

weldef..
        WELFARE =e= - sum(t$(tmyopic(t)), dfact(t) * sum(r,  weight_short * surplus_adj(r,t) * sum(s, hours(s) * sum(bse,  DS(bse,s,r,t)        * 1e+3 * cb_1(bse,s,r,t) + 0.5 * DS(bse,s,r,t)    * DS(bse,s,r,t)    * 1e+6  * cb_2(bse,s,r,t))) * 1e-6
...
DS.UP(bse,s,r,t) = 1.25 * bse_share(bse,r,t) * load_st(s,r,t) ;
DS.LO(bse,s,r,t) = 0.75 * bse_share(bse,r,t) * load_st(s,r,t) ;
