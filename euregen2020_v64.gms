...
$if     set priceref p0(bse,s,r,t) = price(s,r,t) ;
$if     set priceref d0(bse,s,r,t) = load(s,r,t) * dref(r,t) * 1e+3 ;
...
eqs_msrout2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 100 + LOWMID(t-1) * 100 ;
...
eqs_msroutfinal(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..     MSROUT(t)                   =e= MSRFULL(t) * MSROUT_INT(t) + MSREMPTY(t) * MSROUT_MAX(t) ;
...
eqs_cancelup(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1) + MSRIN(t) - MSROUT(t) =g=                                                                   CANCELYES(t) * (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) ;             
eqs_cancello(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1) + MSRIN(t) - MSROUT(t) =l= CANCELNO(t) * (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) + CANCELYES(t) * 5000 ;
...
$if      set co2mips    $if      set euetsold                                   eqs_cancelup             
$if      set co2mips    $if      set euetsold                                   eqs_cancello

$if      set co2mips    $if      set euetsmsrin                                 eqs_cancelfinal
$if      set co2mips    $if      set euetsmsrin                                 eqs_binarycancel
$if      set co2mips    $if      set euetsmsrin                                 eqs_cancelup             
$if      set co2mips    $if      set euetsmsrin                                 eqs_cancello
