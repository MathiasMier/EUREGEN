...
$if not  set bauprice   $if not set frnucnormal af(s,i,oldv(v),r,t)$(sameas(t,"2022") and sameas(i,"Nuclear") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r)) / reliability(i,v,r), 4) ;

$if      set streckbetrieb  af_mon("1","Nuclear","Germany") = 0.75 / reliability("Nuclear","1990","Germany") ;
$if      set streckbetrieb  af_mon("2","Nuclear","Germany") = 0.8  / reliability("Nuclear","1990","Germany") ;
$if      set streckbetrieb  af_mon("3","Nuclear","Germany") = 0.7  / reliability("Nuclear","1990","Germany") ;
$if      set streckbetrieb  af_mon("4","Nuclear","Germany") = 0.7  / reliability("Nuclear","1990","Germany") ;
$if      set streckbetrieb  af_mon(m,"Nuclear","Germany")$(m.val >= 5) = 0 ;
$if      set streckbetrieb  af(s,"Nuclear","1990","Germany","2023")$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon(m,"Nuclear","Germany")), 4) ; 
