...
dref_all(t) = sum(r, daref(r,t)) / sum(r, daref(r,"2020")) ;
dref(r,t)   = dref_all(t) ;
daref(r,t)  = daref(r,"2020") * dref(r,t) ;

dref_sec(r,t,l) = daref_sec(rr,t,l)) / sum(rr, daref(rr,"2020",l)) ;

* Normalize 2020 sector demand to demand adjustments
daref_sec_int(r,t,l) = daref_sec(r,t,l) ;
daref_sec(r,t,l) = daref_sec_int(r,t,l) * daref(r,t) / sum(l, daref_sec_int(r,t,l)) ;
* 2020 sector share is real data
share_sec_all("2020",l) = sum(r, daref_sec(r,"2020",l) / sum((r,l), daref_sec(r,"2020",l)) ;
* 2050 sector share as projections from ENERDATA
share_sec_all("2050","res") = 0.3733 * daref_sec("2020","res") / (daref_sec("2020","res") + daref_sec("2020","com")) ;
share_sec_all("2050","com") = 0.3733 * daref_sec("2020","com") / (daref_sec("2020","res") + daref_sec("2020","com")) ;
share_sec_all("2050","tra") = 0.1433 ;
share_sec_all("2050","ind") = 0.4834 ;
* 2020 sector region-share is real data
share_sec(r,"2020",l) = daref_sec(r,"2020",l) / sum(l, daref_sec(r,"2020",l)) ;
* 2050 sector region-share is higher than average for countries with initially higher share (and vice versa)
share_sec(r,"2050",l) = share_sec_all("2050",l) * daref_sec(r,"2020",l) / share_sec_all("2020",l) ;
* Region demand shares are assumed to keep constant
share_reg(r,t) = daref(r,t) / sum(r, daref(r,t)) ;
* Determine 2050 sec reg demand and interpolate between 2020 and 2050
daref_sec(r,"2050",l) = 4182 * share_reg(r,"2050") * share_sec(r,"2050",l) ;



daref_sec(r,"2050",l) = daref_sec(r,"2020")
...
share_sec(r,"2050","res") = 0.3733 ;




$if set gerind20    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 1.0) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind19    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.9) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind18    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.8) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind17    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.7) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind16    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.6) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind15    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.5) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind14    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.4) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind13    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.3) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind12    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.2) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind11    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 + 0.1) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind09    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 - 0.1) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind08    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 - 0.2) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind07    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 - 0.3) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind06    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 - 0.4) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;
$if set gerind05    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = (1 - 0.5) * (t.val - 2020) / (2050 - 2020) * dref_sec(r,t,l) ;

dref_sec(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = dref_sec_int(r,t,l) ;


dref_sec("Germany","ind") =  



daref_sec(r,t,l) = daref_rec(r,"2020",l) * dref_sec(t,l) ;


daref_ind(r,t) = daref(r,t) -
...
$if     set priceref $gdxin elastic\%s%_priceref.gdx
...
$if not set priceref p0(bse,s,r,t) = Electricity1_rpt(t,r,"price-avg") ;
$if not set priceref d0(bse,s,r,t) = Electricity1_rpt(t,r,"elec-demand-ave") * 1e+3 ;

$if     set priceref p0(bse,s,r,t) = price(s,r,"2022") ;
$if     set priceref d0(bse,s,r,t) = load(s,r) * dref(r,t) * 1e+3 ;

cb_1(bse,s,r,t)$pelas(bse,s,r,t) = p0(bse,s,r,t) * (1 - 1 / pelas(bse,s,r,t)) ;
cb_2(bse,s,r,t)$pelas(bse,s,r,t) = (1 / pelas(bse,s,r,t)) * (p0(bse,s,r,t) / d0(bse,s,r,t)) ;
...
weldef..
        WELFARE =e= sum(t$(tmyopic(t)), dfact(t) * sum(r, sum(s, hours(s) * sum(bse, DS(bse,s,r,t) * 1e+3 * cb_1(bse,s,r,t) + DS(bse,s,r,t) * DS(bse,s,r,t) * 1e+6 * cb_2(bse,s,r,t))))) * 1e-6 - SURPLUS ;
...
$if not set elastic =e=                     1e-3 * hours(s) * round(dref(r,t) * load(s,r) *
$if not set elastic $if not set lossnewtemp (1 + loss(r)),4)
$if not set elastic $if     set lossnewtemp (1 + losss(s,r,t)),4)
...
*        Equals (annually scaled) demand including losses
$if not set elastic =g=                     1e-3 * hours(s) * round(dref(r,t) * load(s,r) *
$if not set elastic $if not set lossnewtemp (1 + loss(r)),4)
$if not set elastic $if     set lossnewtemp (1 + losss(s,r,t)),4)
...
dtwhdef(r,t)$tmyopic(t)..                           DTWH(r,t)       =e= 1e-3 * sum(s, hours(s) * (load(s,r) * dref(r,t) - BS(s,r,t) - sum(bse, BSELAS(bse,s,r,t)))) ;
...
$if set loadnew     daref(r,"2020")$(daref(r,"2025") > daref_new(r,"2022")) = daref_new(r,"2020") ;
$if set loadnew     daref(r,"2021")$(daref(r,"2025") > daref_new(r,"2022")) = daref_new(r,"2021") ;
$if set loadnew     daref(r,"2022")$(daref(r,"2025") > daref_new(r,"2022")) = daref_new(r,"2022") ;
$if not set longrun $if set loadnew     daref(r,"2023")$(daref(r,"2025") > daref_new(r,"2022")) = daref(r,"2022") + 1/3 * (daref(r,"2025") - daref(r,"2022")) ;
$if not set longrun $if set loadnew     daref(r,"2024")$(daref(r,"2025") > daref_new(r,"2022")) = daref(r,"2022") + 2/3 * (daref(r,"2025") - daref(r,"2022")) ;
...
frnuctgt(t) = 0 ;
$if set frnuc10     frnuctgt(t) = 0.1 ;
$if set frnuc20     frnuctgt(t) = 0.2 ;
$if set frnuc30     frnuctgt(t) = 0.3 ;
$if set frnuc40     frnuctgt(t) = 0.4 ;
$if set frnuc50     frnuctgt(t) = 0.5 ;
$if set frnuc60     frnuctgt(t) = 0.6 ;
$if set frnuc70     frnuctgt(t) = 0.7 ;
$if set frnuc80     frnuctgt(t) = 0.8 ;
$if set frnuc90     frnuctgt(t) = 0.9 ;
$if set frnuc100    frnuctgt(t) = 1.0 ;
...
convtarget(i,r,t)$(sameas(i,"Nuclear") and sameas(r,"France") and t.val ge 2035 and tmyopic(t))..
    sum(ivrt(i,v,r,t)$(v.val le t.val), XTWH(i,v,r,t)) =g= frnuctgt(t) * daref(r,t) ;
...
$if      set elastic                      solve euregen using qcp maximizing WELFARE ;
