...
vrsc_nor(s,ir_flh(i,r)) = vrsc(s,i,"2022",r) * flheur(i,"2022") / sum(ss, hours(ss) * vrsc(ss,i,"2022",r)) ;
...
capacity_flheur(s,ivrt(i,v,r,t))$(tmyopic(t) and i_flh(i) and v.val ge 2023)..
                X(s,i,v,r,t) =l=  sum(flhls, XCFLHEUR(i,v,r,t,flhls)) * vrsc_nor(s,i,r) * flheurindex_reg(i,r,v) ;  
...
co2diff(t)$(t.val ge 2023 and tmyopic(t)) = co2ele_in(t) - co2ele_in(t-1) ;

eqs_co2mono2020(t)$(tmyopic(t) and t.val le 2022)..
                        ECEU(t) =l= co2ele_in(t)
$if     set bauprice    + 50                        
$if not set bauprice    + 400
                        ;
