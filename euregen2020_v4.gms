...
$gdxin database\setpar_%n%.gdx
$load new, exi, dspt, ndsp, ccs, irnw, conv, sol, wind, windoff, rnw, lowcarb, nuc, type, idef, gas, bio, chp, nochp, mapchp
$gdxin
...
af(s,i,oldv(v),r,t)$(sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;
af(s,i,oldv(v),r,t)$(sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;
af(s,i,oldv(v),r,t)$(sameas(i,"Hydro")     and reliability(i,v,r) > 0)          = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;
$if not  set bauprice   af(s,i,oldv(v),r,t)$(t.val le 2025 and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0)   = round(sum(sm(s,m), af_mon_ivrt(m,i,v,r,t)) / reliability(i,v,r), 4) ;
...
exlife_bio(ivrt(i,oldv(v),r,t))$(sameas(i,"Bioenergy") and t.val ge 2022 and tmyopic(t))..
         XC(i,v,r,t) =e= cap(i,v,r) * lifetime(i,v,r,t) ;
...
*$if      set co2iter  $if      set shortrun                           EC.UP(t)  = co2ele_in(t) + 100 ;
*$if      set co2iter  $if      set shortrun                           EC.LO(t)  = co2ele_in(t) - 100 ;
...
$if not  set bauprice                           XC.FX(i,v,r,t)$(t.val le 2022)          = xcfx(i,v,r,t) ;
