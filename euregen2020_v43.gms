...
eqs_msrout2045(t)$((t.val ge 2031 and t.val le 2045) and tmyopic(t))..      MSROUT(t)                   =l= MSR(t-1) / nyrs(t) ;
...
$if      set co2mips    $if      set euetsold       $if not  set msrout2030_45  eqs_msrout_old
$if      set co2mips    $if      set euetscancel    $if not  set msrout2030_45  eqs_msrout_old
$if      set co2mips    $if      set euetsmsrin     $if not  set msrout2030_45  eqs_msrout_new
$if      set co2mips    $if      set euetsnew       $if not  set msrout2030_45  eqs_msrout_new
$if      set co2mips    $if      set euetsold       $if      set msrout2030_45  eqs_msrout2030_old
$if      set co2mips    $if      set euetscancel    $if      set msrout2030_45  eqs_msrout2030_old
$if      set co2mips    $if      set euetsmsrin     $if      set msrout2030_45  eqs_msrout2030_new
$if      set co2mips    $if      set euetsnew       $if      set msrout2030_45  eqs_msrout2030_new
$if      set co2mips    $if      set msrin2030_45   $if      set msrout2030_45  eqs_msrout2045_new
