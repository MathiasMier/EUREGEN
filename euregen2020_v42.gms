...
$if set co2iter ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 150 ;
$if set co2iter ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) - 25 ;

$if set co2iter ECEU.UP(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) + 150 ;
$if set co2iter ECEU.LO(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) - 25 ;

$if set co2iter ECEU.UP("2045") = co2ele_org("2045") + 25 ;
$if set co2iter ECEU.LO("2045") = co2ele_org("2045") - 150 ;
