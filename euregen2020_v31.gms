...
eqs_msrout833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       MSROUT(t)                   =l= LOW(t-1) * 200 + LOWMID(t-1) * 2.5 * (400 - TNAC(t-1)) ;
eqs_tnacup833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       TNAC(t)                     =g=                LOWMID(t) * 320 + MID(t) * 400 + UPPMID(t) *  833 + UPP(t) * 1096 ;
eqs_tnaclo833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       TNAC(t)                     =l= LOW(t) * 320 + LOWMID(T) * 400 + MID(t) * 833 + UPPMID(t) * 1096 + UPP(t) * 2000 ;
...
$if      set co2mips833     LOW.L(t)$(tnac_in(t) <  320) = 1 ;
$if      set co2mips833     LOW.L(t)$(tnac_in(t) >= 320) = 0 ;
$if      set co2mips833     LOWMID.L(t)$(tnac_in(t) <  400 and tnac_in(t) >= 320) = 1 ;
$if      set co2mips833     LOWMID.L(t)$(tnac_in(t) >= 400 or  tnac_in(t) < 320) = 0 ;
...
eqs_co2mono2020(t)$(tmyopic(t) and t.val le 2022)..
                        ECEU(t) =l= co2ele_in(t) + co2diff(t) + 50 ;                      
                        ;
                        
eqs_co2mono(t)$(tmyopic(t) and t.val ge 2023 and t.val le 2030)..
    ECEU(t) =l= ECEU(t-1) + co2diff(t) + 50 ;
