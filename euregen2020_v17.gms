...
$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 500 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) + 0 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2023")) = co2ele_org(t) + 360 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2023")) = co2ele_org(t) + 0 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2024")) = co2ele_org(t) + 250 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2024")) = co2ele_org(t) + 0 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2025")) = co2ele_org(t) + 150 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2025")) = co2ele_org(t) - 25 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) + 35 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) - 85 ;
