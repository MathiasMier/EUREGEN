...
$if      set extstr         af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_strext(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
...
storagebal_st(s,j,v,r,t)         Storage balance accumulation
storagebal_lt(s,j,v,r,t)         Storage balance accumulation
...
tinvestexi(k,r,rr,tbase(t))$(tmap(k,r,rr) and tmyopic(t))..
...
* Upper limit
tinvestlimUP(k,r,rr,t)$(tinvlimUP(k,r,rr,t) and t.val ge 2023 and tmyopic(t))..
         TC(k,r,rr,t) =l= tinvlimUP(k,r,rr,t) ;
* Lower limit
tinvestlimLO(k,r,rr,t)$(tinvlimLO(k,r,rr,t) and t.val ge 2023 and tmyopic(t))..
         TC(k,r,rr,t) =g= tinvlimLO(k,r,rr,t) ;
* Upper limit for whole system (in general deactivated)
tinvestlimUP_eu(k,t)$(tinvlimUP_eu(k,t) < inf and t.val ge 2023 and tmyopic(t))..
...
storagebal(s,j,v,r,t)$(sameas(j,"PumpStorage") and tmyopic(t))..
...
* Dynamic accumulation of storage balance (automatic discharge and charge efficiency apply here)
storagebal_lt(s,j,v,r,t)$(sameas(j,"Storage_LT") and tmyopic(t))..
         GB(s,j,v,r,t) =e= GB(s-1,j,v,r,t) * (1 - dischrg(j,v,r)) + hours(s) * (G(s,j,v,r,t) * chrgpen(j,v,r)  - GD(s,j,v,r,t)) * 1e-3 ;

* Dynamic accumulation of storage balance (automatic discharge and charge efficiency apply here)
storagebal_st(s,j,v,r,t)$(sameas(j,"Storage_ST") and tmyopic(t))..
...
* Upper limit
ginvestlimUP(j,r,t)$(t.val ge 2023 and tmyopic(t))..
         IG(j,r,t) =l= ginvlimUP(j,r,t) ;
* Lower limit
ginvestlimLO(j,r,t)$(t.val ge 2023 and tmyopic(t))..
...
msrstart_in = round(msr_int("2021"), 8) ;
tnacstart_in = round(tnac_int("2021"), 8) ;
...
it_euets_indformula(t)$(tmyopic(t))..                     EC(t) * (1 - co2indfix_in(t)) * co2indshare_in(t) + co2indfix_in(t) * co2ind_in(t) + co2can_in(t)
                                                                                                 =e= co2sup2(t) + TNACUSE(t) ;
it_tnac(t)$(t.val le 2045 and tmyopic(t))..               TNAC(t)              =e= tnacstart_in - sum(tt$(tt.val le t.val), TNACUSE(tt) * nyrs(tt)) ;
...
IX.FX(i,r,t)$(t.val le 2022) = 0 ;
$if      set trans       IT.FX(k,r,rr,t)$(t.val le 2022) = 0 ;
