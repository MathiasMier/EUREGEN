...
$if not   set uselimits     2022 and tmyopic(t))..
...
$if set extension       gen_nucl(r,t)$(t.val ge 2023 and t.val le 2029    sameas(r,"Germany")) = gen_nucl(r,"2022") ;
$if set strext          gen_nucl(r,t)$(sameas(t,"2023") and               sameas(r,"Germany")) = 6.74 + round(gen_nucl(r,"2022") / 3, 4) ;  
$if set strext          gen_nucl(r,t)$(t.val ge 2024 and t.val le 2030    sameas(r,"Germany")) = gen_nucl(r,"2022") ; 
...
genLO_coal(r,t)$(tmyopic(t) and sameas(t,"2022") and ( sum(ivrt(i,v,r,t)$(sameas(i,"Coal")), cap(i,v,r) * lifetime(i,v,r,t)) > 0
                                                  or   sum(ivrt(i,v,r,t)$(sameas(i,"Coa_CHP")), cap(i,v,r) * lifetime(i,v,r,t)) > 0
                                                  or   sum(ivrt(i,v,r,t)$(sameas(i,"Lig_CHP")), cap(i,v,r) * lifetime(i,v,r,t)) > 0
                                                  or   sum(ivrt(i,v,r,t)$(sameas(i,"Lignite")), cap(i,v,r) * lifetime(i,v,r,t)) > 0
                                                  ))..
    sum(ivrt("Coal",oldv(v),r,t), XTWH("Coal",v,r,t)) + sum(ivrt("Coa_CHP",oldv(v),r,t), XTWH("Coa_CHP",v,r,t)) +
    sum(ivrt("Lig_CHP",oldv(v),r,t), XTWH("Lig_CHP",v,r,t)) + sum(ivrt("Lignite",oldv(v),r,t), XTWH("Lignite",v,r,t)) =g= gen_coal(r,t) * 0.95 ;
...
lign_min(r,t) = min(lign_af(r,t), lign_out(r,t), gen_coal(r,t)) ;
...
genLO_lign(r,t)$(tmyopic(t) and rlignite(r) and ( sum(ivrt(i,oldv(v),r,t)$(sameas(i,"Lig_CHP")), cap(i,v,r) * lifetime(i,v,r,t)) > 0
                                             or   sum(ivrt(i,oldv(v),r,t)$(sameas(i,"Lignite")), cap(i,v,r) * lifetime(i,v,r,t)) > 0
                                                  ))..
