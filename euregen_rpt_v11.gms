...
$if      set co2iter                        + abs(it_euets_indformula.M(t)) / dfact(t)
...
$if      set co2iter    execute_unload   'euetsmsr\co2elec_%l%_%f%.gdx',            co2elec_out, co2ind_out ;
$if      set co2iter    execute          'gdxxrw.exe euetsmsr\co2elec_%l%_%f%.gdx   o=euetsmsr\EUETS_MSR_CO2ITER_%f%_shortrun.xlsx   par=co2elec_out rng=co2elec_out!a1 par=co2ind_out rng=co2ind_out!a1'
