...
$gdxin elastic\priceref.gdx
$load price, Electricity1_rpt
$gdxin
...
p0(bse,s,r,t) = Electricity1_rpt(t,r,"price-avg") ;
d0(bse,s,r,t) = Electricity1_rpt(t,r,"elec-demand-ave") * 1e+3 ;
...
$if set frnucnormal gen_nucl(r,"2022")$(not sameas(r,"France")) = gen_nucl(r,"2022") ;
$if set frnucnormal gen_nucl(r,"2022")$(    sameas(r,"France")) = gen_nucl(r,"2020")/2 + gen_nucl(r,"2021")/2 ;
$if set hydronormal gen_hydr(r,"2022")                          = gen_hydr(r,"2020")/2 + gen_hydr(r,"2020")/2 ;

gen_biom(r,t)$(t.val ge 2023) = gen_biom(r,"2022") ;
gen_nucl(r,t)$(t.val ge 2023 and not sameas(r,"France")) = gen_nucl(r,"2020") / 2 + gen_nucl(r,"2021") / 2 ;
gen_nucl(r,t)$(t.val ge 2023 and     sameas(r,"France")) = gen_nucl(r,"2020") / 2 + gen_nucl(r,"2021") / 2 ;
gen_nucl(r,t)$(t.val ge 2023 and     sameas(r,"Germany")) = 0 ;
...
gen_af_biom(r,t) = sum(ivrt(bio(i),oldv(v),r,t), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * af(s,i,v,r,t))) * 1e-3 ;
...
gen_af_nucl(r,t) = sum(ivrt(nuc(i),oldv(v),r,t), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * af(s,i,v,r,t))) * 1e-3 ;
...
$if set frnuc2023 af(s,nuc(i),oldv(v),r,t)$(sameas(t,"2023"))                = af_iint(s,i,v,r,t) ;
$if set frnuc2024 af(s,nuc(i),oldv(v),r,t)$(t.val ge 2023 and t.val le 2024) = af_iint(s,i,v,r,t) ;
$if set frnuc2025 af(s,nuc(i),oldv(v),r,t)$(t.val ge 2023 and t.val le 2025) = af_iint(s,i,v,r,t) ;
$if set frnuc20XX af(s,nuc(i),oldv(v),r,t)$(t.val ge 2023)                   = af_iint(s,i,v,r,t) ;
...
gen_af_hydr(r,t) = sum(ivrt(i,oldv(v),r,t)$(sameas(i,"Hydro")), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * vrsc(s,i,v,r) * af(s,i,v,r,t))) * 1e-3 ;
...
rcoal(r)$(sameas(r,"Italy") or sameas(r,"Netherlands") or sameas(r,"Norway") or sameas(r,"Spain") or sameas(r,"Sweden")) = YES ;
...
eqs_msroutlo(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1)                    =l= MSREMPTY(t-1) * MSROUT_INT(t) * nyrs(t) + MSRFULL(t-1) * 10000 ;
...
$if not  set lostload    BSELAS.FX(s,r,t) = 0 ;
