...
$if      set lbseur                                                 1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$(ki_lea(i)), sum(tv(t,v)$ivt(i,v,t), KCAPEXEUR_MIP(i,t)        * kendeffecteur(i,t))) +
...
$if      set lbs                                                  + sum(new(i)$(kir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t), KCAPEX_MIP(i,r,t)        * kendeffect(i,r,t) )) 
               )
...
msrstart_in = 
$if     set co2mips     round(msr_int("2022"), 4) ;
$if not set co2mips     round(msr_int("2021"), 4) ;

tnacstart_in =
$if     set co2mips     round(tnac_int("2022"), 4) ;
...
$if     set co2mips     TNAC.FX("2022") = tnac_in("2022") ;   
TNAC.FX("2045") = 0 ;
TNAC.FX("2050") = 0 ;

TNACUSE.FX("2020") = tnacuse_in("2020") ;
TNACUSE.FX("2021") = tnacuse_in("2021") ;
$if     set co2mips     TNACUSE.FX("2022") = tnacuse_in("2022") ;
TNACUSE.FX("2050") = 0 ;

*$if     set real2022    TNAC.FX("2022") = tnac_in("2022") ;
*$if     set real2022    TNACUSE.FX("2022") = tnacuse_in("2022") ;  

$if not set real2022    TNAC.UP("2022") = tnac_in("2022") + 100 ;
$if not set real2022    TNAC.LO("2022") = tnac_in("2022") - 100 ;
$if not set real2022    TNACUSE.UP("2022") = tnacuse_in("2022") + 100 ;  
$if not set real2022    TNACUSE.LO("2022") = tnacuse_in("2022") - 100 ;

$if not set banking     TNAC.FX(t)     = tnac_in(t) ;
$if not set banking     TNACUSE.FX(t)  = tnacuse_in(t) ;

ECEU.UP(t)$(sameas(t,"2050")) = co2ele_org(t) ;
ECEU.LO(t)$(sameas(t,"2050")) = co2ele_org(t) - 1 ;
...
$if set co2iter ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 50 ;
$if set co2iter ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) - 50 ;

$if set co2iter ECEU.UP(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) + 150 ;
$if set co2iter ECEU.LO(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) - 50 ;

$if set co2iter ECEU.UP("2045") = co2ele_org("2045") + 10 ;
$if set co2iter ECEU.LO("2045") = co2ele_org("2045") - 100 ;
...
*eqs_msrin2022(t)$(sameas(t,"2022"))..                                       MSRIN(t)                    =e= msrin_in(t) ;
*$if set shortrun    eqs_msrin2023(t)$(sameas(t,"2023"))..                   MSRIN(t)                    =e= 0.12 * TNAC(t-1) ;
...
*$if set shortrun    eqs_msrout2023(t)$(sameas(t,"2023"))..                  MSROUT(t)                   =e= 0 ;
...
eqs_msrout_old(t)$((t.val ge 2024 and t.val le 2030) and tmyopic(t))..      MSROUT(t)                   =l= LOW(t-1) * 100 + LOWMID(t-1) * 2.5 * (400 - TNAC(t-1)) ;
eqs_msrout_new(t)$((t.val ge 2024 and t.val le 2030) and tmyopic(t))..      MSROUT(t)                   =l= LOW(t-1) * 200 + LOWMID(t-1) * 5 * (400 - TNAC(t-1)) ;
eqs_msrout2030(t)$((t.val ge 2031 and t.val le 2045) and tmyopic(t))..      MSROUT(t)                   =l= LOW(t-1) * 80 + LOWMID(t-1) * 80 ;

eqs_msrinout(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSRIN(t) * MSROUT(t)        =e= 0 ;

eqs_tnac(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..            TNAC(t)                     =e= tnacstart_in - sum(tt$(tt.val le t.val and tt.val ge 2023), TNACUSE(tt) * nyrs(tt)) ;
eqs_msr(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..             MSR(t)                      =e= msrstart_in  + sum(tt$(tt.val le t.val and tt.val ge 2023), (MSRIN(tt) - MSROUT(tt) - CANCEL(tt)) * nyrs(tt)) ;
eqs_msrUP_old(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..       MSR(t)                      =l= (co2auctioned_in(t-1) - MSR(t-1)) ;
eqs_msrUP_new(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..       MSR(t)                      =l= 400 ;

eqs_tnacup(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..          TNAC(t)                     =g=                LOWMID(t) * 360 + MID(t) * 400 + UPPMID(t) *  833 + UPP(t) * 1096 ;
eqs_tnaclo(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..          TNAC(t)                     =l= LOW(t) * 360 + LOWMID(t) * 400 + MID(t) * 833 + UPPMID(t) * 1096 + UPP(t) * 2000 ;
eqs_binary(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..          LOW(t) + LOWMID(t) + UPP(t) + UPPMID(t) + MID(t) =e= 1 ;

$if set shortrun    eqs_cancel2023(t)$(sameas(t,"2023"))..                  CANCEL(t)                   =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) ;
...
$if      set co2mips  MSRIN.FX("2023") = msrin_in("2023") ;
...
$if      set co2mips  MSROUT.FX("2023") = 0 ;
...
eqs_co2mono2020(t)$(sameas(t,"2022"))..
                        ECEU(t) 
$if not set real2022            =l= co2ele_in(t) + 50 ;
$if     set real2022            =l= co2ele_in(t) ;      
                        
eqs_co2monoUP(t)$(tmyopic(t) and t.val ge 2023 and t.val le 2045)..
    ECEU(t) =l= ECEU(t-1) + co2diff(t) + 150 ;
    
eqs_co2monoLO(t)$(tmyopic(t) and t.val ge 2023 and t.val le 2045)..
...
$if      set co2mips        $if      set euetsold       eqs_msrUP_old
...
$if      set co2mips        $if      set euetsmsrin     eqs_msrUP_old
...
$if      set co2mips        $if      set euetscancel    eqs_msrUP_new
...
$if      set co2mips        $if      set euetsnew       eqs_msrUP_new
$if      set co2mips                                    co2flowuk
$if      set co2mips                                    ukets
eqs_co2mono2020
$if      set co2mono                                    eqs_co2monoUP
$if      set co2mono                                    eqs_co2monoLO
* Policy
...
$if      set calibration2022plus                 genUP_coal
