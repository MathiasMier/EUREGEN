...
$if      set corr_peak                          vrsc(s,i,v,r)$(vrsccorr(i,v,r) > 0) = round(min(vrsccorr(i,v,r) * vrsc_s(s,i,v,r), 1), 4) + eps ;
...
$gdxin database\setpar_%n%.gdx
$load cap_int=cap, invlimUP, invlimLO, invlimUP_eu, invlife, invdepr, capcost, fomcost_int=fomcost, vomcost, effrate, co2captured_int=co2captured, emit_int=emit, reliability, capcred, mindisp
...
capcost(i,v,r)$(i_lea(i)) = capcost_int(i,v,r) ;
capcost(i_del(i),v,r) = 0 ;

lifetime(i_del(i),v,r,t) = NO ;
deprtime(i_del(i),v,r,t) = NO ;
capcost(i_del(i),v,r)    = 0 ;
vrsc(s,i_del(i),r)       = 0 ;
invlimLO(i_del(i),r,t)   = 0 ;
cap(i_del(i),v,r)        = 0 ;
...
acc_q_continuous2020(i,r,t)$(t.val le 2022 and tmyopic(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= sum(oldv(v), delta_q_pa**(t.val - v.val) * cap(i,v,r)) * 1e-3  ;
...
acc_q_continuous(i,r,t)$(t.val ge 2023 and tmyopic(t) and i_lea(i) and r_lea(r))..
                 QTRY(i,r,t)        =e= QTRY(i,r,t-1) * delta_q + IX(i,r,t) * 1e-3 ;                
acc_q_leg_continuous(i,r,t)$(t.val ge 2023 and tmyopic(t) and i_lea(i) and r_lea(r))..
                 QTRY_LEG(i,r,t)    =e= QTRY(i,r,t-1) * delta_q ;
...
acc_qeur_continuous2020(i,t)$(t.val le 2022 and tmyopic(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= sum(oldv(v), delta_q_pa**(t.val - v.val) * sum(r, cap(i,v,r))) * 1e-3 ;
...
acc_qeur_continuous(i,t)$(t.val ge 2023 and tmyopic(t) and i_lea(i))..
                 QTRYEUR(i,t)        =e= QTRYEUR(i,t-1) * delta_q + sum(r, IX(i,r,t)) * 1e-3 ;
acc_qeur_leg_continuous(i,t)$(t.val ge 2023 and tmyopic(t) and i_lea(i))..
                 QTRYEUR_LEG(i,t)    =e= QTRYEUR(i,t-1) * delta_q ;
...
kir_lea(i,r) = YES$(ki_lea(i) and kr_lea(r)) ;

$if      set searching   capcost(i,v,r)$(ki_lea(i)) = kcapcost_int(i,v,r) ;
$if      set searching   capcost(ki_del(i),v,r) = 0 ;

lifetime(ki_del(i),v,r,t) = NO ;
deprtime(ki_del(i),v,r,t) = NO ;
capcost(ki_del(i),v,r)    = 0 ;
vrsc(s,ki_del(i),r)       = 0 ;
invlimLO(ki_del(i),r,t)   = 0 ;
cap(ki_del(i),v,r)        = 0 ;
...
$gdxin database\setpar_%n%.gdx
$load kls_weight,delta_k_pa, delta_k
$gdxin
...
KCAPCOST_MIP(i,r,t)         Per unit capacity cost of learning technologies (EUR per kW)
KCAPEX_MIP(i,r,t)           Capacity cost of learning technologies (million)
...
equation
* Regional Learning-by-Searching
acc_k_continuous2020(i,r,t)      Accumulation of R&D (searching)
acc_k_continuous(i,r,t)          Accumulation of R&D (searching)
rho_mixedip_k(i,r,t)             Equation that enforeces one rho = 1
capex_mixedip_k(i,r,t)           Equation that describes evolution of CAPEX
searching_helper1(i,r,t,kls)     Equation that helps to linearise the nonlinear product IX*RHO
searching_helper2(i,r,t,kls)     Equation that helps to linearise the nonlinear product IX*RHO
searching_helper3(i,r,t,kls)     Equation that helps to linearise the nonlinear product IX*RHO
searching_helper4(i,r,t,kls)     Equation that helps to linearise the nonlinear product IX*RHO
...
acc_k_continuous2020(i,r,t)$(t.val le 2022 and tmyopic(t) and kir_lea(i,r))..
                 KTRY(i,r,t)       =e=    kSTART(i,r) ;
acc_k_continuous(i,r,t)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r) and not sameas(t,"2050"))..
                 KTRY(i,r,t)       =e=    KTRY(i,r,t-1) * delta_k + IK(i,r,t) ;
* * * Assume nonlinear unit cost (leads to NLP)
* Comment/ToDo JA: Add NLP implementation for learning by searching
...
capex_mixedip_k(i,r,t)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r))..
                 KCAPEX_MIP(i,r,t)        =e=  sum(kls, IXLS(i,r,t,kls) * kslope_mip(i,r,kls)) ;
...
searching_helper1(i,r,t,kls)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r))..
                 IXLS(i,r,t,kls)          =l=     200 * KRHO(i,r,t-1,kls) ;
searching_helper2(i,r,t,kls)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r))..
                 IXLS(i,r,t,kls)          =l=     IX(i,r,t) ;
searching_helper3(i,r,t,kls)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r))..
                 IXLS(i,r,t,kls)          =g=     IX(i,r,t) - 200 * (1 - KRHO(i,r,t-1,kls)) ;
searching_helper4(i,r,t,kls)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r))..
                 IXLS(i,r,t,kls)          =g=     0 ;
* Capacity cost follow from the linear approximation of the learning curve (Learning by searching) (just placeholder equation, maybe delete later)
...
* Capacity stock per line segment is greater than the lower bound of that line segment (Learning by searching)
klsLO_mixedip(i,r,t,kls)$(kir_lea(i,r) and not sameas(t,"2050") and tmyopic(t))..
                 KQLS(i,r,t,kls)                 =g= klsLO(i,r,kls) * KRHO(i,r,t,kls) ;
* Capacity stock per line segment is lower than the upper bound of that line segment (Learning by searching)
klsUP_mixedip(i,r,t,kls)$(kir_lea(i,r) and not sameas(t,"2050") and tmyopic(t))..
                 KQLS(i,r,t,kls)                 =l= klsUP(i,r,kls) * KRHO(i,r,t,kls) ;
* Capacity stock per "active" (rho = 1) line segment is equal to capacity stock (Learning by searching)
...
$gdxin database\setpar_%n%.gdx
$load b_keur,keurFIRST,keurSTART,keurLAST,keurlsLO,keurlsUP,kcapcosteur0,kcapcosteurSTART,kcapcosteurLAST,kcapcosteurLO,kcapcosteurUP,kcapcosteurAV,kacc_capexeurFIRST,kacc_capexeurSTART,kacc_capexeurLAST,kacc_capexeurLO,kacc_capexeurUP,kslopeeur_lin,kslopeeur_mip,ktest_slopeeur,ktest_slopeeur2,rd_budgeteur
$gdxin
...
equation
acc_keur_continuous2020(i,t)     Accumulation of 2015 R&D (searching)
acc_keur_continuous(i,t)         Accumulation of R&D (searching)
...
searchingeur_helper1(i,t,kls)    Equation that helps to linearise the nonlinear product IX*RHO
searchingeur_helper2(i,t,kls)    Equation that helps to linearise the nonlinear product IX*RHO
searchingeur_helper3(i,t,kls)    Equation that helps to linearise the nonlinear product IX*RHO
searchingeur_helper4(i,t,kls)    Equation that helps to linearise the nonlinear product IX*RHO
...
* Additional constraints in order to linearise IX*RHO, which is replaced by a new helper variable IXLS above
* RHO of t-1 to realise the time lag of one period until the cost degressions materialise
searchingeur_helper1(i,t,kls)$(t.val ge 2023 and tmyopic(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =l=     2000 * KRHOEUR(i,t-1,kls) ;
searchingeur_helper2(i,t,kls)$(t.val ge 2023 and tmyopic(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =l=     sum(r, IX(i,r,t)) ;
searchingeur_helper3(i,t,kls)$(t.val ge 2023 and tmyopic(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =g=     sum(r, IX(i,r,t)) - 2000 * (1 - KRHOEUR(i,t-1,kls)) ;
searchingeur_helper4(i,t,kls)$(t.val ge 2023 and tmyopic(t) and ki_lea(i))..
                 IXEURLS(i,t,kls)          =g=     0 ;
* Capacity cost follow from the linear approximation of the learning curve (Learning by searching) (just placeholder equation, maybe delete later)
capcosteur_mixedip_k(i,t)$(ki_lea(i) and t.val ge 2023 and tmyopic(t))..
                 KCAPCOSTEUR_MIP(i,t)             =e= sum(kls, KRHOEUR(i,t-1,kls) * kslopeeur_mip(i,kls) ) ;
* This equation enforeces that always just one line segment is active
...
* * Regional metric
* annual technology regional budget
eq_rd_budget_irt(i,r,t)$(kir_lea(i,r))..
IK(i,r,t) =l= rd_budget(i,r,t) ;
* annual regional budget
eq_rd_budget_rt(r,t)$(kr_lea(r))..
$if not set fixbudget sum(ki_lea(i), IK(i,r,t)) =l= sum(ki_lea(i), rd_budget(i,r,t)) ;
$if     set fixbudget sum(ki_lea(i), IK(i,r,t)) =e= sum(ki_lea(i), rd_budget(i,r,t)) ;
* annual technology budget
eq_rd_budget_it(i,t)$(ki_lea(i))..
$if not set fixbudget sum(kr_lea(r), IK(i,r,t)) =l= sum(kr_lea(r), rd_budget(i,r,t)) ;
$if     set fixbudget sum(kr_lea(r), IK(i,r,t)) =e= sum(kr_lea(r), rd_budget(i,r,t)) ;
* intertemporal technology regional budget
eq_rd_budget_ir(i,r)$(kir_lea(i,r))..
$if not set fixbudget sum(t, IK(i,r,t)) =l= sum(t, rd_budget(i,r,t)) ;
$if     set fixbudget sum(t, IK(i,r,t)) =e= sum(t, rd_budget(i,r,t)) ;
* annual budget
eq_rd_budget_t(t)..
$if not set fixbudget sum(kir_lea(i,r), IK(i,r,t)) =l= sum(kir_lea(i,r), rd_budget(i,r,t)) ;
$if     set fixbudget sum(kir_lea(i,r), IK(i,r,t)) =e= sum(kir_lea(i,r), rd_budget(i,r,t)) ;
* intertemporal regional budget
eq_rd_budget_r(r)$(kr_lea(r))..
$if not set fixbudget sum((ki_lea(i),t), IK(i,r,t)) =l= sum((ki_lea(i),t), rd_budget(i,r,t)) ;
$if     set fixbudget sum((ki_lea(i),t), IK(i,r,t)) =e= sum((ki_lea(i),t), rd_budget(i,r,t)) ;
* intertemporal technology budget
eq_rd_budget_i(i)$(ki_lea(i))..
$if not set fixbudget sum((kr_lea(r),t), IK(i,r,t)) =l= sum((kr_lea(r),t), rd_budget(i,r,t)) ;
$if     set fixbudget sum((kr_lea(r),t), IK(i,r,t)) =e= sum((kr_lea(r),t), rd_budget(i,r,t)) ;
* intertemporal budget
eq_rd_budget..
$if not set fixbudget sum((kir_lea(i,r),t), IK(i,r,t)) =l= sum((kir_lea(i,r),t), rd_budget(i,r,t)) ;
$if     set fixbudget sum((kir_lea(i,r),t), IK(i,r,t)) =e= sum((kir_lea(i,r),t), rd_budget(i,r,t)) ;
* * European metric
* annual technology budget
eq_rd_budgeteur_it(i,t)$(ki_lea(i))..
$if not set fixbudget IKEUR(i,t) =l= rd_budgeteur(i,t) ;
$if     set fixbudget IKEUR(i,t) =e= rd_budgeteur(i,t) ;
* intertemporal technology budget
eq_rd_budgeteur_i(i)$(ki_lea(i))..
$if not set fixbudget sum(t, IKEUR(i,t)) =l= sum(t, rd_budgeteur(i,t)) ;
$if     set fixbudget sum(t, IKEUR(i,t)) =e= sum(t, rd_budgeteur(i,t)) ;
* annual budget
eq_rd_budgeteur_t(t)..
$if not set fixbudget sum(ki_lea(i), IKEUR(i,t)) =l= sum(ki_lea(i), rd_budgeteur(i,t)) ;
$if     set fixbudget sum(ki_lea(i), IKEUR(i,t)) =e= sum(ki_lea(i), rd_budgeteur(i,t)) ;
* intertemporal budget
eq_rd_budgeteur..
$if not set fixbudget sum((ki_lea(i),t), IKEUR(i,t)) =l= sum((ki_lea(i),t), rd_budgeteur(i,t)) ;
$if     set fixbudget sum((ki_lea(i),t), IKEUR(i,t)) =e= sum((ki_lea(i),t), rd_budgeteur(i,t)) ;
...
XCFLHEUR(i,v,r,t) XCS per line segment
;
...
FLHTRYEUR(i,t) =e= FLHTRYEUR(i,t - 1) * delta_qa**nyrs(t) + IFLHEUR(i,t) ;

* RHO equations
rhoflh_mixedip(i,t)$(i_flh(i) and not sameas(t,"2050") and tmyopic(t))..
...
* Helper equations
flheur_helper1(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i))..
                XCFLHEUR(i,v,r,t,flhls) =l= irnwlimUP_quantiles(i,r,"q90") * RHOFLH(i,t-1,flhls) * flheurindexSLOPE(i,flhls) ;
flheur_helper2(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i))..
                XCFLHEUR(i,v,r,t,flhls) =l= XC(i,v,r,t) * flheurindexSLOPE(i,flhls) ;
flheur_helper3(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i))..
                XCFLHEUR(i,v,r,t,flhls) =g= XC(i,v,r,t) * flheurindexSLOPE(i,flhls) - irnwlimUP_quantiles(i,r,"q90") * flheurindexSLOPE(i,flhls)* (1 - RHOFLHEUR(i,t-1,flhls)) ;
flheur_helper4(ivrt(i,v,r,t),flhls)$(t.val ge 2023 and tmyopic(t) and i_flh(i))..
                XCFLHEUR(i,v,r,t,flhls) =g= 0 ;

* Capacity equations
capacity_noflh(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and not i_flh(i))..
...
capacity_flh(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and i_flh(i))..
                X(s,i,v,r,t) =l=  sum(flhls, XCFLH(i,v,r,t,flhls) * vrsc(s,i,"2022",r) * flheurindex_reg(i,r,v)) ;  
...
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2020") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2020") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;

af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2021") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon2021(m,i,r)) / reliability(i,v,r), 4) ;
af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2021") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon2021(m,i,r)) / reliability(i,v,r), 4) ;

* New hydro timeseries out of calibration data created above and now higher availability used in case necessary
$if     set newhydrotimeseries      vrsc(s,i,v,r)$(sameas(i,"Hydro") and cap(i,v,r) > 0) = round(sum(sm(s,m), af_mon(m,i,r)) * (irnwflh2020(i,r) / sum(ss, hours(ss) * sum(sm(ss,m), af_mon(m,i,r)))), 4) ;

irnwflh_check(i,v,r) = sum(s, hours(s) * vrsc(s,i,v,r)) ;

$if     set newhydrotimeseries      af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2020") and sameas(i,"Hydro") and reliability(i,v,r) > 0)                                     = 1 ;
$if     set newhydrotimeseries      af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2021") and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0) = round(sum(sm(s,m), af_mon2021(m,i,r) / af_mon(m,i,r)), 4) ;

* General af calibration
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2022 and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)                            = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2021 and sameas(i,"Nuclear")   and sameas(r,"France") and reliability(i,v,r) > 0)     = round(af(s,i,v,r,"2020"), 4) ;
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2022 and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)                            = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2022 and sameas(i,"Hydro")     and reliability(i,v,r) > 0)                            = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;

* Hydro adjustments due to droughts
$if not  set bauprice   $if not set hydronormal af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2022")                        and sameas(i,"Hydro")   and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r) / af_mon(m,i,r)) / reliability(i,v,r), 4) ;
$if not  set bauprice   $if not set frnucnormal af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2022") and sameas(r,"France") and sameas(i,"Nuclear") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r)) / reliability(i,v,r), 4) ;

$if not  set bauprice   $if     set hydro2023   af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2023")                        and sameas(i,"Hydro")   and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r) / af_mon(m,i,r)) / reliability(i,v,r), 4) ;
$if not  set bauprice   $if     set frnuc2023   af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2023") and sameas(r,"France") and sameas(i,"Nuclear") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r)) / reliability(i,v,r), 4) ;
...
af_mon2022_ger(m,i,r)$(m.val le 4 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon2022(m,i,r) * 2 ;
af_mon2022_ger(m,i,r)$(m.val ge 5 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;

af_mon2023_ext(m,i,r)$(m.val le 4 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;
af_mon2023_ext(m,i,r)$(m.val ge 5 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;
...
af_mon2023_strext(m,i,r)$(m.val ge 9 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;

$if not  set bauprice       af(s,ivrt("Nuclear","1990","Germany","2022"))$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2022_ger(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ;   
$if      set extension      af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_ext(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
$if      set streckbetrieb  af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_str(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
$if      set strext         af(s,ivrt("Nuclear","1990","Germany","2023"))$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_strext(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
...
storagebal0(s,j,v,r,t)           Storage balance accumulation seas tech
...
demand_rsa(peak(s,r),t)$(t.val ge 2023 and tmyopic(t))..
...
capacity(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t))..
                 X(s,i,v,r,t) =l=  XCS(s,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) ;
* CHP are mustrun
capacity_chp(s,ivrt(chp(i),oldv(v),r,t))$(tmyopic(t))..
...
capacity_bio(s,ivrt(i,oldv(v),r,t))$(sameas(i,"Bioenergy") and t.val le 2030 and tmyopic(t))..
                 X(s,i,v,r,t) =e=  XCS(s,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r))* (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) ;
...
exlife2030_chp(ivrt(chp(i),oldv(v),r,t))$(t.val ge 2023 and t.val le 2035 and tmyopic(t))..
         XC(i,v,r,t) =e= cap(i,v,r) * lifetime(i,v,r,t) ;
exlife_chp(ivrt(chp(i),oldv(v),r,t))$(t.val ge 2036 and tmyopic(t))..
         XC(i,v,r,t) =l= cap(i,v,r) * lifetime(i,v,r,t) ;
* Bioenergy cannot be decommissioned before lifetime
exlife_bio(ivrt(i,oldv(v),r,t))$(sameas(i,"Bioenergy") and t.val ge 2023 and t.val le 2030 and tmyopic(t))..
         XC(i,v,r,t) =e= cap(i,v,r) * lifetime(i,v,r,t) ;
...
* * * * * Storage equations
parameter
inflows(s,j,v,r,t) segment specific inflow (TWh per s)
inflow(j,v,r,t) annual inflow (TWh per a)
;

inflows(s,"PumpStorage","2020",r,t) = 0 ;
inflow("PumpStorage","2020",r,t) = 0 ;

* Via inflow one could model hydrogen imports (storage would still need to get build and hydrogen demand satisfied)
...
* * Initial storage level (finial storage level can be steered easier via .FX)
storagebal0(s,jvrt(j,v,r,t))$(sameas(s,"1") and tmyopic(t))..
         GB(s,j,v,r,t) =e= 0.75 * ghours(j,v,r) * GCS(s,j,v,r,t) * (1 - dischrg(j,v,r)) * 1e-3
$if      set storage_inflows      + inflows(s,j,v,r,t)
$if      set storage_inflow       + inflow(j,v,r,t)/8760 * hours(s)
* Storage peak treatment is by default
...
* * Further storage level including last segment via .FX
storagebal(s,jvrt(j,v,r,t))$(s.val ge 2) and tmyopic(t))..
...
$if      set storage_relweights   + hours(s) * round(number / 8760,4) *
         + (G(s,j,v,r,t) * chrgpen(j,v,r)  - GD(s,j,v,r,t)) * 1e-3 ; 
* * Storage annual balance (charge*eff must be greater than discharge due to automatic discharge)   
storagebalann(jvrt(j,v,r,t))$(tmyopic(t))..
         sum(s, hours(s) * G(s,j,v,r,t) * chrgpen(j,v,r) - GD(s,j,v,r,t)) * 1e-3
$if      set storage_inflow     + inflow(j,v,r,t)      
$if      set storage_inflows    + sum(s, hours(s) * inflow(j,v,r,t))  
          =g= 0 ;
* * Technology specific equations
* Pumpstorage (can be treated seasonally by default or set pumppeak)
...
storagebalann_ps(jvrt(j,v,r,t))$(sameas(j,"PumpStorage") and tmyopic(t))..
         sum(s, hours(s) * G(s,j,v,r,t) * chrgpen(j,v,r) - GD(s,j,v,r,t)) $if      set storage_inflows    + sum(s, hours(s) * inflow(j,v,r,t))  
          =g= 0 ;
* Power-to-gas
storagebal_lt0(s,jvrt(j,v,r,t))$(sameas(s,"1") and sameas(j,"Storage_LT") and tmyopic(t))..
         GB(s,j,v,r,t) =e= 0.75 * ghours(j,v,r) * GCS(s,j,v,r,t) * (1 - dischrg(j,v,r)) * 1e-3 + hours(s) * (G(s,j,v,r,t) * chrgpen(j,v,r)  - GD(s,j,v,r,t)) * 1e-3 ;
...
storagebalann_lt(jvrt(j,v,r,t))$(sameas(j,"Storage_LT") and tmyopic(t))..
         sum(s, hours(s) * G(s,j,v,r,t) * chrgpen(j,v,r) - GD(s,j,v,r,t)) =g= 0 ;
* Batteries
storagebal_st0(s,jvrt(j,v,r,t))$(sameas(s,"1") and sameas(j,"Storage_ST") and tmyopic(t))..
         GB(s,j,v,r,t) =e= 0.5 * ghours(j,v,r) * GCS(s,j,v,r,t) * (1 - dischrg(j,v,r)) * 1e-3 +  (G(s,j,v,r,t) * chrgpen(j,v,r)  - GD(s,j,v,r,t)) * 1e-3 ;
...
$if     set co2iter $if     set iter0   $if     set shortrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2ITER0_%f%_shortrun.xlsx o=euetsmsr\EUETS_MSR_CO2ITER0_%f%_shortrun.gdx trace=3 log=temp\EUETS_MSR_CO2ITER0_%f%_shortrun.log @temp\gdxxrw.rsp';
$if     set co2iter $if not set iter0   $if     set shortrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2ITER_%f%_shortrun.xlsx  o=euetsmsr\EUETS_MSR_CO2ITER_%f%_shortrun.gdx  trace=3 log=temp\EUETS_MSR_CO2ITER_%f%_shortrun.log  @temp\gdxxrw.rsp';
$if     set co2iter $if     set iter0   $if     set shortrun    $gdxin          euetsmsr\EUETS_MSR_CO2ITER0_%f%_shortrun
$if     set co2iter $if not set iter0   $if     set shortrun    $gdxin          euetsmsr\EUETS_MSR_CO2ITER_%f%_shortrun

$if     set co2mark                     $if     set shortrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MARK_%f%_shortrun.xlsx  o=euetsmsr\EUETS_MSR_CO2MARK_%f%_shortrun.gdx  trace=3 log=temp\EUETS_MSR_CO2MARK_%f%_shortrun.log  @temp\gdxxrw.rsp';
$if     set co2mark                     $if     set shortrun    $gdxin          euetsmsr\EUETS_MSR_CO2MARK_%f%_shortrun
$if     set co2mips                     $if     set shortrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortrun.xlsx  o=euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortrun.gdx  trace=3 log=temp\EUETS_MSR_CO2MIPS_%f%_shortrun.log  @temp\gdxxrw.rsp';
$if     set co2mips                     $if     set shortrun    $gdxin          euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortrun

$if     set co2iter $if     set iter0   $if     set shortlong    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2ITER0_%f%_shortlong.xlsx o=euetsmsr\EUETS_MSR_CO2ITER0_%f%_shortlong.gdx trace=3 log=temp\EUETS_MSR_CO2ITER0_%f%_shortlong.log @temp\gdxxrw.rsp';
$if     set co2iter $if not set iter0   $if     set shortlong    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2ITER_%f%_shortlong.xlsx  o=euetsmsr\EUETS_MSR_CO2ITER_%f%_shortlong.gdx  trace=3 log=temp\EUETS_MSR_CO2ITER_%f%_shortlong.log  @temp\gdxxrw.rsp';
$if     set co2iter $if     set iter0   $if     set shortlong    $gdxin          euetsmsr\EUETS_MSR_CO2ITER0_%f%_shortlong
$if     set co2iter $if not set iter0   $if     set shortlong    $gdxin          euetsmsr\EUETS_MSR_CO2ITER_%f%_shortlong

$if     set co2mark                     $if     set shortlong    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MARK_%f%_shortlong.xlsx  o=euetsmsr\EUETS_MSR_CO2MARK_%f%_shortlong.gdx  trace=3 log=temp\EUETS_MSR_CO2MARK_%f%_shortlong.log  @temp\gdxxrw.rsp';
$if     set co2mark                     $if     set shortlong    $gdxin          euetsmsr\EUETS_MSR_CO2MARK_%f%_shortlong
$if     set co2mips                     $if     set shortlong    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortlong.xlsx  o=euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortlong.gdx  trace=3 log=temp\EUETS_MSR_CO2MIPS_%f%_shortlong.log  @temp\gdxxrw.rsp';
$if     set co2mips                     $if     set shortlong    $gdxin          euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortlong

$if     set co2iter $if     set iter0   $if     set longrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2ITER0_%f%_longrun.xlsx o=euetsmsr\EUETS_MSR_CO2ITER0_%f%_longrun.gdx trace=3 log=temp\EUETS_MSR_CO2ITER0_%f%_longrun.log @temp\gdxxrw.rsp';
$if     set co2iter $if not set iter0   $if     set longrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2ITER_%f%_longrun.xlsx  o=euetsmsr\EUETS_MSR_CO2ITER_%f%_longrun.gdx  trace=3 log=temp\EUETS_MSR_CO2ITER_%f%_longrun.log  @temp\gdxxrw.rsp';
$if     set co2iter $if     set iter0   $if     set longrun    $gdxin          euetsmsr\EUETS_MSR_CO2ITER0_%f%_longrun
$if     set co2iter $if not set iter0   $if     set longrun    $gdxin          euetsmsr\EUETS_MSR_CO2ITER_%f%_longrun

$if     set co2mark                     $if     set longrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MARK_%f%_longrun.xlsx  o=euetsmsr\EUETS_MSR_CO2MARK_%f%_longrun.gdx  trace=3 log=temp\EUETS_MSR_CO2MARK_%f%_longrun.log  @temp\gdxxrw.rsp';
$if     set co2mark                     $if     set longrun    $gdxin          euetsmsr\EUETS_MSR_CO2MARK_%f%_longrun
$if     set co2mips                     $if     set longrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MIPS_%f%_longrun.xlsx  o=euetsmsr\EUETS_MSR_CO2MIPS_%f%_longrun.gdx  trace=3 log=temp\EUETS_MSR_CO2MIPS_%f%_longrun.log  @temp\gdxxrw.rsp';
$if     set co2mips                     $if     set longrun    $gdxin          euetsmsr\EUETS_MSR_CO2MIPS_%f%_longrun
...
$if     set banking     $if not set onlyelec            TNACUSE.FX(t)$(t.val le 2021) = 0 ;
$if     set banking     $if not set onlyeleccrisis      TNACUSE.FX(t)$(t.val le 2021) = 0 ;
...
$if     set banking     TNAC.FX("2020") = tnac_in("2020") ;
$if     set banking     TNAC.FX("2021") = tnac_in("2021") ;
$if     set banking     TNAC.FX("2045") = 0 ;
$if     set banking     TNAC.FX("2050") = 0 ;
$if     set banking     TNACUSE.FX("2020") = tnacuse_in("2020") ;
$if     set banking     TNACUSE.FX("2021") = tnacuse_in("2021") ;
$if     set banking     TNACUSE.FX("2050") = 0 ;
$if     set banking30   TNACUSE.FX(t)$(t.val ge 2025) = 0 ;
...
PARAMETER
co2sup1(t) banking is fixed and included in co2sup
co2sup1_indformula(t) banking is fixed and included in co2sup
co2sup2(t) banking is free and not included in co2sup
co2sup2_indformula(t) banking is free and not included in co2sup
;
...
co2tnac(t)$(tmyopic(t))..               TNAC(t)                                                                                           =e= tnacstart_in - sum(tt$(tt.val le t.val and tt.val ge 2022), TNACUSE(tt) * nyrs(tt)) ;
...
it_co2floweu(t)$tmyopic(t)..                              ECEU(t)                               =e= sum(ivrt(i,v,reu(r),t), emit(i,v,r) * XTWH(i,v,r,t))) ;
it_euets(t)$(tmyopic(t))..                                ECEU(t) + co2ind_in(t) + co2can_in(t) =e= co2sup2(t) + TNACUSE(t) ;
it_euets_indformula(t)$(tmyopic(t))..                     ECEU(t) * (1 - co2indfix_in(t)) * co2indshare_in(t) + co2indfix_in(t) * co2ind_in(t) + co2can_in(t)
                                                                                                =e= co2sup2(t) + TNACUSE(t) ;
it_tnac(t)$(t.val le 2045 and tmyopic(t))..               TNAC(t)                               =e= tnacstart_in - sum(tt$(tt.val le t.val and tt.val ge 2022), TNACUSE(tt) * nyrs(tt)) ;

* Constrain freedom of variables to be closer to the simulation model and prevent "race-to-the-bottom" (i.e., cancelling circle)
*$if      set co2iter  $if      set shortrun                           EC.UP(t)  = co2ele_in(t) + 25 ;
*$if      set co2iter  $if      set shortrun                           EC.LO(t)  = co2ele_in(t) - 25 ;
...
eqs_co2floweu(t)$(tmyopic(t))..                                             ECEU(t)                     =e= sum(ivrt(i,v,reu(r),t), emit(i,v,r) * XTWH(i,v,r,t))) ;
eqs_euets(t)$(tmyopic(t))..                                                 ECEU(t) + co2ind_in(t) + co2can_in(t) 
                                                                                                        =e= co2add_in(t) + co2allocated_in(t) + co2auctioned_in(t) - MSRIN(t) + MSROUT(t) + TNACUSE(t) ;
eqs_euets_indformula(t)$(tmyopic(t))..                                      ECEU(t) * (1 - co2indfix_in(t)) * co2indshare_in(t) + co2indfix_in(t) * co2ind_in(t) + co2can_in(t) 
                                                                                                        =e= co2add_in(t) + co2allocated_in(t) + co2auctioned_in(t) - MSRIN(t) + MSROUT(t) + TNACUSE(t) ;
eqs_msrin2023(t)$(t.val le 2023 and tmyopic(t))..                           MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) ;
eqs_msrin(t)$((t.val ge 2024 and t.val le 2040) and tmyopic(t))..           MSRIN(t)                    =e= UPP(t-1) * 0.12 * TNAC(t-1) ;
eqs_msrout2023(t)$(t.val le 2023 and tmyopic(t))..                          MSROUT(t)                   =e= LOW(t-1) * 200 ;
eqs_msrout(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..          MSROUT(t)                   =e= LOW(t-1) * 100 ;
...
eqs_cancel(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..          CANCEL(t)                   =e= MSR(t-1) + MSRIN(t-1) - MSROUT(t-1) + MSRIN(t) - MSROUT(t) - co2auctioned_in(t-1) ;
eqs_tnacup(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..          TNAC(t)                     =g=                MID(t) * 400 + UPP(t) *  833 ;
eqs_tnaclo(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..          TNAC(t)                     =l= LOW(t) * 400 + MID(t) * 833 + UPP(t) * 2000 ;
eqs_binary(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..          LOW(t) + UPP(t) + MID(t)    =e= 1 ;


*$ontext
$if      set co2mips  $if      set shortrun   TNACUSE.L(t)                = tnacuse_in(t) ;
$if      set co2mips  $if      set shortrun   TNAC.L(t)                   = tnac_in(t) ;
*$if      set co2mips  $if      set shortrun   CANCEL.L(t)                   = cancel_in(t) ;
$if      set co2mips  $if      set shortrun   MSRIN.L(t)$(msr_in(t) >= 0) =   msrin_in(t) ;
$if      set co2mips  $if      set shortrun   MSRIN.L(t)$(msr_in(t) < 0) =   0 ;
$if      set co2mips  $if      set shortrun   MSROUT.L(t)$(msr_in(t) < 0) = - msrin_in(t) ;
$if      set co2mips  $if      set shortrun   MSROUT.L(t)$(msr_in(t) >= 0) = 0 ;
$if      set co2mips  $if      set shortrun   MSR.L(t)                    = msr_in(t) ;
...
$if      set co2mips  $if      set shortrun   MSR.FX("2020") = msr_in("2020") ;
$if      set co2mips  $if      set shortrun   MSR.FX("2021") = msr_in("2021") ;
*$if      set co2mips  $if      set shortrun   MSR.FX("2022") = msr_in("2022") ;
$if      set co2mips  $if      set shortrun   MSR.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   MSR.FX("2050") = 0 ;

$if      set co2mips  $if      set shortrun   MSRIN.FX("2020") = msrin_in("2020") ;
$if      set co2mips  $if      set shortrun   MSRIN.FX("2021") = msrin_in("2021") ;
*$if      set co2mips  $if      set shortrun   MSRIN.FX("2022") = msrin_in("2022") ;
$if      set co2mips  $if      set shortrun   MSRIN.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   MSRIN.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   MSROUT.FX("2020") = 0 ;
$if      set co2mips  $if      set shortrun   MSROUT.FX("2021") = 0 ;
*$if      set co2mips  $if      set shortrun   MSROUT.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   MSROUT.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   LOW.FX("2020") = 0 ;
$if      set co2mips  $if      set shortrun   LOW.FX("2021") = 0 ;
*$if      set co2mips  $if      set shortrun   LOW.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   LOW.FX("2045") = 1 ;
$if      set co2mips  $if      set shortrun   LOW.FX("2050") = 1 ;
$if      set co2mips  $if      set shortrun   MID.Fx("2020") = 0 ;
$if      set co2mips  $if      set shortrun   MID.FX("2021") = 0 ;
*$if      set co2mips  $if      set shortrun   MID.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   MID.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   MID.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   UPP.FX("2020") = 1 ;
$if      set co2mips  $if      set shortrun   UPP.FX("2021") = 1 ;
*$if      set co2mips  $if      set shortrun   UPP.FX("2022") = 1 ;
$if      set co2mips  $if      set shortrun   UPP.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   UPP.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   CANCEL.FX("2020") = 0 ;
$if      set co2mips  $if      set shortrun   CANCEL.FX("2021") = 0 ;
$if      set co2mips  $if      set shortrun   CANCEL.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   CANCEL.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   CANCEL.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEU.UP(t)$(t.val le 2022) = co2ele_in(t) + 50 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEU.LO(t)$(t.val le 2022) = co2ele_in(t) - 50 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEU.UP(t)$(t.val ge 2023) = co2ele_in(t) + 150 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEU.LO(t)$(t.val ge 2023) = co2ele_in(t) - 150 ;
...
maptmips(tmips,t)$(tmips.val le 2030 and tmips.val eq t.val) = YES ;
maptmips(tmips,"2035")$(tmips.val ge 2031 and tmips.val le 2035) = YES ;
maptmips(tmips,"2040")$(tmips.val ge 2036 and tmips.val le 2040) = YES ;
maptmips(tmips,"2045")$(tmips.val ge 2041 and tmips.val le 2045) = YES ;
maptmips(tmips,"2050")$(tmips.val ge 2046 and tmips.val le 2050) = YES ;

alias(tmips,ttmips) ;

$onecho >temp\gdxxrw.rsp
par=co2elemips_in           rng=co2elemips_in!a2             rdim=1 cdim=0
par=co2indmips_in           rng=co2indmips_in!a2             rdim=1 cdim=0
par=co2canmips_in           rng=co2canmips_in!a2             rdim=1 cdim=0
par=co2indfixmips_in        rng=co2indfixmips_in!a2          rdim=1 cdim=0
par=co2indsharemips_in      rng=co2indsharemips_in!a2        rdim=1 cdim=0
par=co2addmips_in           rng=co2addmips_in!a2             rdim=1 cdim=0 
par=co2allocatedmips_in     rng=co2allocatedmips_in!a2       rdim=1 cdim=0
par=co2auctionedmips_in     rng=co2auctionedmips_in!a2       rdim=1 cdim=0
par=msrmips_in              rng=msrmips_in!a2                rdim=1 cdim=0
par=msrinmips_in            rng=msrinmips_in!a2              rdim=1 cdim=0
par=msrstartmips_in         rng=msrstartmips_in!a2           rdim=0 cdim=0
par=tnacmips_in             rng=tnacmips_in!a2               rdim=1 cdim=0
par=tnacusemips_in          rng=tnacusemips_in!a2            rdim=1 cdim=0
par=tnacstartmips_in        rng=tnacstartmips_in!a2          rdim=0 cdim=0
par=co2eleukmips_in         rng=co2eleukmips_in!a2           rdim=1 cdim=0
$offecho
* * Indformula routine
* Define iterative loading loop (iter 0 always loads from the "base" files)
$if     set co2mips                     $if     set shortrun    $call 'gdxxrw i=euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortrun.xlsx  o=euetsmsr\EUETS_MSR_CO2MIPS_%f%_shortrun.gdx  trace=3 log=temp\EUETS_MSR_CO2MIPS_%f%_shortrun.log  @temp\gdxxrw.rsp';
...
* * Final load
$load co2elemips_int=co2elemips_in
$load co2indmips_int=co2indmips_in
$load co2indfixmips_int=co2indfixmips_in
$load co2indsharemips_int=co2indsharemips_in
$load co2addmips_int=co2addmips_in
$load co2canmips_int=co2canmips_in
$load co2allocatedmips_int=co2allocatedmips_in
$load co2auctionedmips_int=co2auctionedmips_in
$load tnacmips_int=tnacmips_in
$load tnacusemips_int=tnacusemips_in
$load tnacstartmips_int=tnacstartmips_in
$load msrmips_int=msrmips_in
$load msrinmips_int=msrinmips_in
$load msrstartmips_int=msrstartmips_in
$load co2eleukmips_int=co2eleukmips_in
$gdxin
...
co2canmips_in(t)
co2indfixmips_in(t)
co2indsharemips_in(t)
co2addmips_in(t)
co2allocatedmips_in(t)
co2auctionedmips_in(t)
tnacmips_in(t)
tnacusemips_in(t)
msrmips_in(t)
msrinmips_in(t)
...
co2elemips_in(t) = round(co2elemips_int(t), 4) ;
co2indmips_in(t) = round(co2indmips_int(t), 4) ;
co2indfixmips_in(t) = round(co2indfixmips_int(t), 4) ;
co2indsharemips_in(t) = round(co2indsharemips_int(t), 4) ;
co2canmips_in(t) = round(co2canmips_int(t), 4) ;
co2addmips_in(t) = round(co2addmips_int(t), 4) ;
co2allocatedmips_in(t) = round(co2allocatedmips_int(t), 4) ;
co2auctionedmips_in(t) = round(co2auctionedmips_int(t), 4) ;
tnacmips_in(t) = round(tnacmips_int(t), 4) ;
tnacusemips_in(t) = round(tnacusemips_int(t), 4) ;
msrmips_in(t) = round(msrmips_int(t), 4) ;
msrinmips_in(t) = round(msrinmips_int(t), 4) ;
msrstartmips_in = round(msrmips_int("2021"), 4) ;
tnacstartmips_in = round(tnacmips_int("2021"), 4) ;
co2eleukmips_in(t) = round(co2eleukmips_int(t), 4) ;
...
$if not  set bauprice   $load ixfx, itfx, igfx, xcfx
...
$if not  set bauprice   $if     set shortrun    IX.FX(sol(i),r,t)$(t.val le 2022)       = ixfx(i,r,t) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2023)        = round(ixfx(i,r,t) * 1.5   + 10 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2024)        = round(ixfx(i,r,t) * 2     + 20 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2025)        = round(ixfx(i,r,t) * 3     + 30 * daref(r,"2020") / daref("Germany","2020"), 4) ;

$if not  set bauprice   $if     set shortrun    IX.FX(windon(i),r,t)$(t.val le 2023)    = ixfx(i,r,t) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windon(i),r,t)$(t.val = 2024)     = round(ixfx(i,r,t) * 1.5   +  5 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windon(i),r,t)$(t.val = 2025)     = round(ixfx(i,r,t) * 2     + 10 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windon(i),r,t)$(t.val = 2026)     = round(ixfx(i,r,t) * 3     + 15 * daref(r,"2020") / daref("Germany","2020"), 4) ;

$if not  set bauprice   $if     set shortrun    IX.FX(windoff(i),r,t)$(t.val le 2024)   = ixfx(i,r,t) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2025)    = round(ixfx(i,r,t) * 1.5   +  1 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2026)    = round(ixfx(i,r,t) * 2     +  2 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2027)    = round(ixfx(i,r,t) * 3     +  3 * daref(r,"2020") / daref("Germany","2020"), 4) ;

$if not  set bauprice   $if not set shortrun    IX.FX(sol(i),r,t)$(t.val le 2025)       = ixfx(i,r,t) ;
$if not  set bauprice   $if not set shortrun    IX.FX(windon(i),r,t)$(t.val le 2025)    = ixfx(i,r,t) ;
$if not  set bauprice   $if not set shortrun    IX.FX(windoff(i),r,t)$(t.val le 2025)   = ixfx(i,r,t) ;
...
$if not  set bauprice                           XC.FX(i,v,r,t)$(t.val le 2021)          = xcfx(i,v,r,t) ;


* * * Model fixes
* No investment in base year
IX.FX(i,r,t)$(t.val le 2022 and tmyopic(t)) = 0 ;
$if      set trans       IT.FX(k,r,rr,t)$(t.val le 2021 and tmyopic(t)) = 0 ;
$if      set storage     IG.FX(j,r,t)$(t.val le 2022 and tmyopic(t)) = 0 ;
* No frictions
...
* Storage level (pump storage and hydrogen storage should be 75% filled by end of December, battery half full)
set
lasts(s)
;
...
* * * * ETC calibration routine

$ontext
* * No-technology-regin switch
* Regional Learning-by-doing
RHO.FX(i,r,t,ls)$(not ir_lea(i,r)) = 0 ;
RHO_LEG.FX(i,r,t,ls)$(not ir_lea(i,r)) = 0 ;
CAPEX_CON.FX(i,v,r)$(not ir_lea(i,r)) = 0 ;
CAPEX_NLP.FX(i,v,r)$(not ir_lea(i,r)) = 0 ;
CAPEX_NLP_LEG.FX(i,v,r)$(not ir_lea(i,r)) = 0 ;
CAPEX_MIP.FX(i,v,r)$(not ir_lea(i,r)) = 0 ;
QTRY.FX(i,r,t)$(not ir_lea(i,r)) = 0 ;
QTRY_LEG.FX(i,r,t)$(not ir_lea(i,r)) = 0 ;
QLS.FX(i,r,t,ls)$(not ir_lea(i,r)) = 0 ;
QLS_LEG.FX(i,r,t,ls)$(not ir_lea(i,r)) = 0 ;
ACC_CAPEX_NLP.FX(i,r,t)$(not ir_lea(i,r)) = 0 ;
ACC_CAPEX_NLP_LEG.FX(i,r,t)$(not ir_lea(i,r)) = 0 ;
ACC_CAPEX_MIP.FX(i,r,t)$(not ir_lea(i,r)) = 0 ;
ACC_CAPEX_MIP_LEG.FX(i,r,t)$(not ir_lea(i,r)) = 0 ;

* European Learning-by-doing
RHOEUR.FX(i,t,ls)$(not i_lea(i)) = 0 ;
RHOEUR_LEG.FX(i,t,ls)$(not i_lea(i)) = 0 ;
CAPEXEUR_CON.FX(i,v)$(not i_lea(i)) = 0 ;
CAPEXEUR_NLP.FX(i,v)$(not i_lea(i)) = 0 ;
CAPEXEUR_NLP_LEG.FX(i,v)$(not i_lea(i)) = 0 ;
CAPEXEUR_MIP.FX(i,v)$(not i_lea(i)) = 0 ;
QTRYEUR.FX(i,t)$(not i_lea(i)) = 0 ;
QTRYEUR_LEG.FX(i,t)$(not i_lea(i)) = 0 ;
QEURLS.FX(i,t,ls)$(not i_lea(i)) = 0 ;
QEURLS_LEG.FX(i,t,ls)$(not i_lea(i)) = 0 ;
ACC_CAPEXEUR_NLP.FX(i,t)$(not i_lea(i)) = 0 ;
ACC_CAPEXEUR_NLP_LEG.FX(i,t)$(not i_lea(i)) = 0 ;
ACC_CAPEXEUR_MIP.FX(i,t)$(not i_lea(i)) = 0 ;
ACC_CAPEXEUR_MIP_LEG.FX(i,t)$(not i_lea(i)) = 0 ;

* Regional Learning-by-searching
KRHO.FX(i,r,t,kls)$(not kir_lea(i,r)) = 0 ;
KTRY.FX(i,r,t)$(not kir_lea(i,r)) = 0 ;
KQLS.FX(i,r,t,kls)$(not kir_lea(i,r)) = 0 ;
IK.FX(i,r,t)$(not kir_lea(i,r)) = 0 ;
KCAPCOST_MIP.FX(i,r,t)$(not kir_lea(i,r)) = 0 ;
KCAPEX_MIP.FX(i,r,t)$(not kir_lea(i,r)) = 0 ;
IXLS.FX(i,r,t,kls)$(not kir_lea(i,r)) = 0 ;

* European Learning-by-searching
KRHOEUR.FX(i,t,kls)$(not ki_lea(i)) = 0 ;
KTRYEUR.FX(i,t)$(not ki_lea(i)) = 0 ;
KEURLS.FX(i,t,kls)$(not ki_lea(i)) = 0 ;
IKEUR.FX(i,t)$(not ki_lea(i)) = 0 ;
KCAPCOSTEUR_MIP.FX(i,t)$(not ki_lea(i)) = 0 ;
KCAPEXEUR_MIP.FX(i,t)$(not ki_lea(i)) = 0 ;
IXEURLS.FX(i,t,kls)$(not ki_lea(i)) = 0 ;

* * European switch
* Regional Learning-by-doing
$if      set eur        RHO.FX(i,r,t,ls) = 0 ;
$if      set eur        RHO_LEG.FX(i,r,t,ls) = 0 ;
$if      set eur        CAPEX_CON.FX(i,v,r) = 0 ;
$if      set eur        CAPEX_NLP.FX(i,v,r) = 0 ;
$if      set eur        CAPEX_NLP_LEG.FX(i,v,r) = 0 ;
$if      set eur        CAPEX_MIP.FX(i,v,r) = 0 ;
$if      set eur        QTRY.FX(i,r,t) = 0 ;
$if      set eur        QTRY_LEG.FX(i,r,t) = 0 ;
$if      set eur        QLS.FX(i,r,t,ls) = 0 ;
$if      set eur        QLS_LEG.FX(i,r,t,ls) = 0 ;
$if      set eur        ACC_CAPEX_NLP.FX(i,r,t) = 0 ;
$if      set eur        ACC_CAPEX_NLP_LEG.FX(i,r,t) = 0 ;
$if      set eur        ACC_CAPEX_MIP.FX(i,r,t) = 0 ;
$if      set eur        ACC_CAPEX_MIP_LEG.FX(i,r,t) = 0 ;
* European Learning-by-doing
$if not  set eur        RHOEUR.FX(i,t,ls) = 0 ;
$if not  set eur        RHOEUR_LEG.FX(i,t,ls) = 0 ;
$if not  set eur        CAPEXEUR_CON.FX(i,v) = 0 ;
$if not  set eur        CAPEXEUR_NLP.FX(i,v) = 0 ;
$if not  set eur        CAPEXEUR_NLP_LEG.FX(i,v) = 0 ;
$if not  set eur        CAPEXEUR_MIP.FX(i,v) = 0 ;
$if not  set eur        QTRYEUR.FX(i,t) = 0 ;
$if not  set eur        QTRYEUR_LEG.FX(i,t) = 0 ;
$if not  set eur        QEURLS.FX(i,t,ls) = 0 ;
$if not  set eur        QEURLS_LEG.FX(i,t,ls) = 0 ;
$if not  set eur        ACC_CAPEXEUR_NLP.FX(i,t) = 0 ;
$if not  set eur        ACC_CAPEXEUR_NLP_LEG.FX(i,t) = 0 ;
$if not  set eur        ACC_CAPEXEUR_MIP.FX(i,t) = 0 ;
$if not  set eur        ACC_CAPEXEUR_MIP_LEG.FX(i,t) = 0 ;
* Regional Learning-by-searching
$if      set eur        KRHO.FX(i,r,t,kls) = 0 ;
$if      set eur        KTRY.FX(i,r,t) = 0 ;
$if      set eur        KQLS.FX(i,r,t,kls) = 0 ;
$if      set eur        IK.FX(i,r,t) = 0 ;
$if      set eur        KCAPCOST_MIP.FX(i,r,t) = 0 ;
$if      set eur        KCAPEX_MIP.FX(i,r,t) = 0 ;
$if      set eur        IXLS.FX(i,r,t,kls) = 0 ;
* European Learning-by-searching
$if not  set eur        KRHOEUR.FX(i,t,kls) = 0 ;
$if not  set eur        KTRYEUR.FX(i,t) = 0 ;
$if not  set eur        KEURLS.FX(i,t,kls) = 0 ;
$if not  set eur        IKEUR.FX(i,t) = 0 ;
$if not  set eur        KCAPCOSTEUR_MIP.FX(i,t) = 0 ;
$if not  set eur        KCAPEXEUR_MIP.FX(i,t) = 0 ;
$if not  set eur        IXEURLS.FX(i,t,kls) = 0 ;
* * Channel switch
* Regional Learning-by-doing
$if not  set doing      RHO.FX(i,r,t,ls) = 0 ;
$if not  set doing      RHO_LEG.FX(i,r,t,ls) = 0 ;
$if not  set doing      CAPEX_CON.FX(i,v,r) = 0 ;
$if not  set doing      CAPEX_NLP.FX(i,v,r) = 0 ;
$if not  set doing      CAPEX_NLP_LEG.FX(i,v,r) = 0 ;
$if not  set doing      CAPEX_MIP.FX(i,v,r) = 0 ;
$if not  set doing      QTRY.FX(i,r,t) = 0 ;
$if not  set doing      QTRY_LEG.FX(i,r,t) = 0 ;
$if not  set doing      QLS.FX(i,r,t,ls) = 0 ;
$if not  set doing      QLS_LEG.FX(i,r,t,ls) = 0 ;
$if not  set doing      ACC_CAPEX_NLP.FX(i,r,t) = 0 ;
$if not  set doing      ACC_CAPEX_NLP_LEG.FX(i,r,t) = 0 ;
$if not  set doing      ACC_CAPEX_MIP.FX(i,r,t) = 0 ;
$if not  set doing      ACC_CAPEX_MIP_LEG.FX(i,r,t) = 0 ;
* European Learning-by-doing
$if not  set doing      RHOEUR.FX(i,t,ls) = 0 ;
$if not  set doing      RHOEUR_LEG.FX(i,t,ls) = 0 ;
$if not  set doing      CAPEXEUR_CON.FX(i,v) = 0 ;
$if not  set doing      CAPEXEUR_NLP.FX(i,v) = 0 ;
$if not  set doing      CAPEXEUR_NLP_LEG.FX(i,v) = 0 ;
$if not  set doing      CAPEXEUR_MIP.FX(i,v) = 0 ;
$if not  set doing      QTRYEUR.FX(i,t) = 0 ;
$if not  set doing      QTRYEUR_LEG.FX(i,t) = 0 ;
$if not  set doing      QEURLS.FX(i,t,ls) = 0 ;
$if not  set doing      QEURLS_LEG.FX(i,t,ls) = 0 ;
$if not  set doing      ACC_CAPEXEUR_NLP.FX(i,t) = 0 ;
$if not  set doing      ACC_CAPEXEUR_NLP_LEG.FX(i,t) = 0 ;
$if not  set doing      ACC_CAPEXEUR_MIP.FX(i,t) = 0 ;
$if not  set doing      ACC_CAPEXEUR_MIP_LEG.FX(i,t) = 0 ;
* Regional Learning-by-searching
$if not  set searching  KRHO.FX(i,r,t,kls) = 0 ;
$if not  set searching  KTRY.FX(i,r,t) = 0 ;
$if not  set searching  KQLS.FX(i,r,t,kls) = 0 ;
$if not  set searching  IK.FX(i,r,t) = 0 ;
$if not  set searching  KCAPCOST_MIP.FX(i,r,t) = 0 ;
$if not  set searching  KCAPEX_MIP.FX(i,r,t) = 0 ;
$if not  set searching  IXLS.FX(i,r,t,kls) = 0 ;
* European Learning-by-searching
$if not  set searching  KRHOEUR.FX(i,t,kls) = 0 ;
$if not  set searching  KTRYEUR.FX(i,t) = 0 ;
$if not  set searching  KEURLS.FX(i,t,kls) = 0 ;
$if not  set searching  IKEUR.FX(i,t) = 0 ;
$if not  set searching  KCAPCOSTEUR_MIP.FX(i,t) = 0 ;
$if not  set searching  KCAPEXEUR_MIP.FX(i,t) = 0 ;
$if not  set searching  IXEURLS.FX(i,t,kls) = 0 ;
* * Method switch    
* Regional Learning-by-doing
$if not  set mip        RHO.FX(i,r,t,ls) = 0 ;
$if not  set mip        RHO_LEG.FX(i,r,t,ls) = 0 ;
$if not  set constant   CAPEX_CON.FX(i,v,r) = 0 ;
$if not  set nonlinear  CAPEX_NLP.FX(i,v,r) = 0 ;
$if not  set nonlinear  CAPEX_NLP_LEG.FX(i,v,r) = 0 ;
$if not  set mip        CAPEX_MIP.FX(i,v,r) = 0 ;
$if not  set mip        QLS.FX(i,r,t,ls) = 0 ;
$if not  set mip        QLS_LEG.FX(i,r,t,ls) = 0 ;
$if not  set nonlinear  ACC_CAPEX_NLP.FX(i,r,t) = 0 ;
$if not  set nonlinear  ACC_CAPEX_NLP_LEG.FX(i,r,t) = 0 ;
$if not  set mip        ACC_CAPEX_MIP.FX(i,r,t) = 0 ;
$if not  set mip        ACC_CAPEX_MIP_LEG.FX(i,r,t) = 0 ;
* European Learning-by-doing
$if not  set mip        RHOEUR.FX(i,t,ls) = 0 ;
$if not  set mip        RHOEUR_LEG.FX(i,t,ls) = 0 ;
$if not  set constant   CAPEXEUR_CON.FX(i,v) = 0 ;
$if not  set nonlinear  CAPEXEUR_NLP.FX(i,v) = 0 ;
$if not  set nonlinear  CAPEXEUR_NLP_LEG.FX(i,v) = 0 ;
$if not  set mip        CAPEXEUR_MIP.FX(i,v) = 0 ;
$if not  set mip        QEURLS.FX(i,t,ls) = 0 ;
$if not  set mip        QEURLS_LEG.FX(i,t,ls) = 0 ;
$if not  set nonlinear  ACC_CAPEXEUR_NLP.FX(i,t) = 0 ;
$if not  set nonlinear  ACC_CAPEXEUR_NLP_LEG.FX(i,t) = 0 ;
$if not  set mip        ACC_CAPEXEUR_MIP.FX(i,t) = 0 ;
$if not  set mip        ACC_CAPEXEUR_MIP_LEG.FX(i,t) = 0 ;
* * Legacy switch
* Regional Learning-by-doing
$if not  set leg        RHO_LEG.FX(i,r,t,ls) = 0 ;
$if not  set leg        CAPEX_NLP_LEG.FX(i,v,r) = 0 ;
$if not  set leg        QTRY_LEG.FX(i,r,t) = 0 ;
$if not  set leg        QLS_LEG.FX(i,r,t,ls) = 0 ;
$if not  set leg        ACC_CAPEX_NLP_LEG.FX(i,r,t) = 0 ;
$if not  set leg        ACC_CAPEX_MIP_LEG.FX(i,r,t) = 0 ;
* European Learning-by-leg
$if not  set leg        RHOEUR_LEG.FX(i,t,ls) = 0 ;
$if not  set leg        CAPEXEUR_NLP_LEG.FX(i,v) = 0 ;
$if not  set leg        QTRYEUR_LEG.FX(i,t) = 0 ;
$if not  set leg        QEURLS_LEG.FX(i,t,ls) = 0 ;
$if not  set leg        ACC_CAPEXEUR_NLP_LEG.FX(i,t) = 0 ;
$if not  set leg        ACC_CAPEXEUR_MIP_LEG.FX(i,t) = 0 ;
$offtext

* * Learning-by-searching 2022 and 2050 fixes
* 2022 R&D spending must match real spending
$if      set searching   $if not  set eur IK.FX(i,r,t)$(t.val le 2022 and kir_lea(i,r))  = rd_budget(i,r,t) ;
$if      set searching   $if      set eur IKEUR.FX(i,t)$(t.val le 2022 and ki_lea(i))    = rd_budgeteur(i,t) ; 
*2050 R&D spending has no impact anymore (due to lag) and thus should get fixed
$if      set searching   $if not  set eur IK.FX(i,r,"2050")$(kir_lea(i,r))  = rd_budget(i,r,"2050") ;
$if      set searching   $if      set eur IKEUR.FX(i,"2050")$(ki_lea(i))    = rd_budgeteur(i,"2050") ; 

* * Calibration routine for MIP and NLP problems
parameter
BS_int_%cv%(s,r,t)                            Lost load (backstop demand option) (GW)
X_int_%cv%(s,i,v,r,t)                         Unit dispatch by segment (GW)
XC_int_%cv%(i,v,r,t)                          Installed generation capacity (GW)
IX_int_%cv%(i,r,t)                            New vintage investment (total GW to be added from t-1 to t) (GW)
XCS_int_%cv%(s,i,v,r,t)                       Copies of XC over s for sparsity purposes (GW)
XTWH_int_%cv%(i,v,r,t)                        Annual generation for sparsity purposes (TWh)
G_int_%cv%(s,j,v,r,t)                         Energy storage charge (GW)
GD_int_%cv%(s,j,v,r,t)                        Energy storage discharge (GW)
GC_int_%cv%(j,v,r,t)                          Energy storage charge-discharge capacity (GW)
GCS_int_%cv%(s,j,v,r,t)                       Energy storage charge-discharge capacity (GW)
IG_int_%cv%(j,r,t)                            Investment in storage charge-discharge capacity (GW)
GB_int_%cv%(s,j,v,r,t)                        Energy storage accumulated balance (GWh)
E_int_%cv%(s,k,r,r,t)                         Bilateral trade flows by load segment (GW)
IT_int_%cv%(k,r,r,t)                          Investment in transmission (total GW to be added from t-1 to t)
TC_int_%cv%(k,r,r,t)                          New Trade flow capacity (GW)
TCS_int_%cv%(s,k,r,r,t)                       New Trade flow capacity (GW)
EC_r_int_%cv%(r,t)                            Annual flow of CO2 emissions (MtCO2)
BC_r_int_%cv%(r,t)                            Annual flow of biomass (GtCO2)
SC_r_int_%cv%(r,t)                            Annual flow of geologically stored carbon (GtCO2)
GASC_r_int_%cv%(r,t)                          Annual flow of natural gas used (TWh)
EC_int_%cv%(t)                                Annual flow of CO2 emissions (MtCO2)
BC_int_%cv%(t)                                Annual flow of biomass (GtCO2)
SC_int_%cv%(t)                                Annual flow of geologically stored carbon (GtCO2)
GASC_int_%cv%(t)                              Annual flow of natural gas used (TWh)
SURPLUS_int_%cv%                              Social surplus (negative) (million EUR)
;
...
$gdxin calibration_%cv%\%ncal%.gdx
$load ls_int_%cv%
$gdxin
...
* * Regional LBD
* Perfect recall
CAPEX_CON_rec_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_NLP_rec_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_NLP_LEG_rec_int_%cv%(i,v,r)             Capacity cost of learning technologies (million)
CAPEX_MIP_rec_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_MIP_LEG_rec_int_%cv%(i,v,r)             Capacity cost of learning technologies (million)
QTRY_rec_int_%cv%(i,r,t)                      Stock of accumulated capacity
QTRY_LEG_rec_int_%cv%(i,r,t)                  Stock of accumulated legacy capacity (from previous periods)
QLS_rec_int_%cv%(i,r,t,ls_int_%cv%)           Stock of capacity on line segment ls
QLS_LEG_rec_int_%cv%(i,r,t,ls_int_%cv%)       Stock of legacy capacity (from previous periods) on line segment ls
ACC_CAPEX_NLP_rec_int_%cv%(i,r,t)             Accumulated capacity cost of learning technologies (million)
ACC_CAPEX_NLP_LEG_rec_int_%cv%(i,r,t)         Accumulated legacy capacity cost of learning technologies (million)
ACC_CAPEX_MIP_rec_int_%cv%(i,r,t)             Accumulated capacity cost of learning technologies (million)
ACC_CAPEX_MIP_LEG_rec_int_%cv%(i,r,t)         Accumulated legacy capacity cost of learning technologies (million)
RHO_rec_int_%cv%(i,r,t,ls_int_%cv%)           Binary variable for line segment
RHO_LEG_rec_int_%cv%(i,r,t,ls_int_%cv%)       Binary variable for line segment
* Continuous forgetting
CAPEX_CON_con_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_NLP_con_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_NLP_LEG_con_int_%cv%(i,v,r)             Capacity cost of learning technologies (million)
CAPEX_MIP_con_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_MIP_LEG_con_int_%cv%(i,v,r)             Capacity cost of learning technologies (million)
QTRY_con_int_%cv%(i,r,t)                      Stock of accumulated capacity
QTRY_LEG_con_int_%cv%(i,r,t)                  Stock of accumulated legacy capacity (from previous periods)
QLS_con_int_%cv%(i,r,t,ls_int_%cv%)           Stock of capacity on line segment ls
QLS_LEG_con_int_%cv%(i,r,t,ls_int_%cv%)       Stock of legacy capacity (from previous periods) on line segment ls
ACC_CAPEX_NLP_con_int_%cv%(i,r,t)             Accumulated capacity cost of learning technologies (million)
ACC_CAPEX_NLP_LEG_con_int_%cv%(i,r,t)         Accumulated legacy capacity cost of learning technologies (million)
ACC_CAPEX_MIP_con_int_%cv%(i,r,t)             Accumulated capacity cost of learning technologies (million)
ACC_CAPEX_MIP_LEG_con_int_%cv%(i,r,t)         Accumulated legacy capacity cost of learning technologies (million)
RHO_con_int_%cv%(i,r,t,ls_int_%cv%)           Binary variable for line segment
RHO_LEG_con_int_%cv%(i,r,t,ls_int_%cv%)       Binary variable for line segment
* Discrete forgetting
CAPEX_CON_dis_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_NLP_dis_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_NLP_LEG_dis_int_%cv%(i,v,r)             Capacity cost of learning technologies (million)
CAPEX_MIP_dis_int_%cv%(i,v,r)                 Capacity cost of learning technologies (million)
CAPEX_MIP_LEG_dis_int_%cv%(i,v,r)             Capacity cost of learning technologies (million)
QTRY_dis_int_%cv%(i,r,t)                      Stock of accumulated capacity
QTRY_LEG_dis_int_%cv%(i,r,t)                  Stock of accumulated legacy capacity (from previous periods)
QLS_dis_int_%cv%(i,r,t,ls_int_%cv%)           Stock of capacity on line segment ls
QLS_LEG_dis_int_%cv%(i,r,t,ls_int_%cv%)       Stock of legacy capacity (from previous periods) on line segment ls
ACC_CAPEX_NLP_dis_int_%cv%(i,r,t)             Accumulated capacity cost of learning technologies (million)
ACC_CAPEX_NLP_LEG_dis_int_%cv%(i,r,t)         Accumulated legacy capacity cost of learning technologies (million)
ACC_CAPEX_MIP_dis_int_%cv%(i,r,t)             Accumulated capacity cost of learning technologies (million)
ACC_CAPEX_MIP_LEG_dis_int_%cv%(i,r,t)         Accumulated legacy capacity cost of learning technologies (million)
RHO_dis_int_%cv%(i,r,t,ls_int_%cv%)           Binary variable for line segment
RHO_LEG_dis_int_%cv%(i,r,t,ls_int_%cv%)       Binary variable for line segment
* * European LBD
* Perfect recall
CAPEXEUR_CON_rec_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_NLP_rec_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_NLP_LEG_rec_int_%cv%(i,v)            Capacity cost of learning technologies (million)
CAPEXEUR_MIP_rec_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_MIP_LEG_rec_int_%cv%(i,v)            Capacity cost of learning technologies (million)
QTRYEUR_rec_int_%cv%(i,t)                     Stock of accumulated capacity
QTRYEUR_LEG_rec_int_%cv%(i,t)                 Stock of accumulated legacy capacity (from previous periods)
QEURLS_rec_int_%cv%(i,t,ls_int_%cv%)          Stock of capacity on line segment ls
QEURLS_LEG_rec_int_%cv%(i,t,ls_int_%cv%)      Stock of legacy capacity (from previous periods) on line segment ls
ACC_CAPEXEUR_NLP_rec_int_%cv%(i,t)            Accumulated capacity cost of learning technologies (million)
ACC_CAPEXEUR_NLP_LEG_rec_int_%cv%(i,t)        Accumulated legacy capacity cost of learning technologies (million)
ACC_CAPEXEUR_MIP_rec_int_%cv%(i,t)            Accumulated capacity cost of learning technologies (million)
ACC_CAPEXEUR_MIP_LEG_rec_int_%cv%(i,t)        Accumulated legacy capacity cost of learning technologies (million)
RHOEUR_rec_int_%cv%(i,t,ls_int_%cv%)          Binary variable for line segment
RHOEUR_LEG_rec_int_%cv%(i,t,ls_int_%cv%)      Binary variable for line segment
* Continuous forgetting
CAPEXEUR_CON_con_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_NLP_con_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_NLP_LEG_con_int_%cv%(i,v)            Capacity cost of learning technologies (million)
CAPEXEUR_MIP_con_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_MIP_LEG_con_int_%cv%(i,v)            Capacity cost of learning technologies (million)
QTRYEUR_con_int_%cv%(i,t)                     Stock of accumulated capacity
QTRYEUR_LEG_con_int_%cv%(i,t)                 Stock of accumulated legacy capacity (from previous periods)
QEURLS_con_int_%cv%(i,t,ls_int_%cv%)          Stock of capacity on line segment ls
QEURLS_LEG_con_int_%cv%(i,t,ls_int_%cv%)      Stock of legacy capacity (from previous periods) on line segment ls
ACC_CAPEXEUR_NLP_con_int_%cv%(i,t)            Accumulated capacity cost of learning technologies (million)
ACC_CAPEXEUR_NLP_LEG_con_int_%cv%(i,t)        Accumulated legacy capacity cost of learning technologies (million)
ACC_CAPEXEUR_MIP_con_int_%cv%(i,t)            Accumulated capacity cost of learning technologies (million)
ACC_CAPEXEUR_MIP_LEG_con_int_%cv%(i,t)        Accumulated legacy capacity cost of learning technologies (million)
RHOEUR_con_int_%cv%(i,t,ls_int_%cv%)          Binary variable for line segment
RHOEUR_LEG_con_int_%cv%(i,t,ls_int_%cv%)      Binary variable for line segment
* Discrete forgetting
CAPEXEUR_CON_dis_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_NLP_dis_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_NLP_LEG_dis_int_%cv%(i,v)            Capacity cost of learning technologies (million)
CAPEXEUR_MIP_dis_int_%cv%(i,v)                Capacity cost of learning technologies (million)
CAPEXEUR_MIP_LEG_dis_int_%cv%(i,v)            Capacity cost of learning technologies (million)
QTRYEUR_dis_int_%cv%(i,t)                     Stock of accumulated capacity
QTRYEUR_LEG_dis_int_%cv%(i,t)                 Stock of accumulated legacy capacity (from previous periods)
QEURLS_dis_int_%cv%(i,t,ls_int_%cv%)          Stock of capacity on line segment ls
QEURLS_LEG_dis_int_%cv%(i,t,ls_int_%cv%)      Stock of legacy capacity (from previous periods) on line segment ls
ACC_CAPEXEUR_NLP_dis_int_%cv%(i,t)            Accumulated capacity cost of learning technologies (million)
ACC_CAPEXEUR_NLP_LEG_dis_int_%cv%(i,t)        Accumulated legacy capacity cost of learning technologies (million)
ACC_CAPEXEUR_MIP_dis_int_%cv%(i,t)            Accumulated capacity cost of learning technologies (million)
ACC_CAPEXEUR_MIP_LEG_dis_int_%cv%(i,t)        Accumulated legacy capacity cost of learning technologies (million)
RHOEUR_dis_int_%cv%(i,t,ls_int_%cv%)          Binary variable for line segment
RHOEUR_LEG_dis_int_%cv%(i,t,ls_int_%cv%)      Binary variable for line segment
;
...
parameter
* Regional LBS
KTRY_int_%cv%(i,r,t)                          Stock of accumulated R&D spendings (million)
KQLS_int_%cv%(i,r,t,kls_int_%cv%)             Stock of accumulated R&D spendings on line segment kls  (million)
IK_int_%cv%(i,r,t)                            R&D investments (million)
KCAPCOST_MIP_int_%cv%(i,r,t)                  Per unit capacity cost of learning technologies (EUR per kW)
KCAPEX_MIP_int_%cv%(i,r,t)                    Capacity cost of learning technologies (million)
IXLS_int_%cv%(i,r,t,kls_int_%cv%)             Variable that replaces the nonlinear product IX*RHO as part of a linearisation strategy
KRHO_int_%cv%(i,r,t,kls_int_%cv%)             Binary variable that reflects piecewise linear segment of learning curve
* European LBS
KTRYEUR_int_%cv%(i,t)                         Stock of accumulated R&D spendings (million)
KEURLS_int_%cv%(i,t,kls_int_%cv%)             Stock of accumulated R&D spendings on line segment kls  (million)
IKEUR_int_%cv%(i,t)                           R&D investments (million)
KCAPCOSTEUR_MIP_int_%cv%(i,t)                 Per unit capacity cost of learning technologies (EUR per kW)
KCAPEXEUR_MIP_int_%cv%(i,t)                   Capacity cost of learning technologies (million)
IXEURLS_int_%cv%(i,t,kls_int_%cv%)            Variable that replaces the nonlinear product IX*RHO as part of a linearisation strategy
KRHOEUR_int_%cv%(i,t,kls_int_%cv%)            Binary variable that reflects piecewise linear segment of learning curve (for European metric)
;

$gdxin calibration_%cv%\%ncal%.gdx
$load XC_int_%cv%,IX_int_%cv%,GC_int_%cv%,IG_int_%cv%,IT_int_%cv%,TC_int_%cv%
*$load BS_int_%cv%,X_int_%cv%,XC_int_%cv%,IX_int_%cv%,XCS_int_%cv%,XTWH_int_%cv%,G_int_%cv%,GD_int_%cv%,GC_int_%cv%,GCS_int_%cv%,IG_int_%cv%,GB_int_%cv%,E_int_%cv%,IT_int_%cv%,TC_int_%cv%,TCS_int_%cv%,BC_r_int_%cv%,SC_r_int_%cv%,EC_int_%cv%,GASC_int_%cv%,GASC_r_int_%cv%,SURPLUS_int_%cv%
$load CAPEX_CON_rec_int_%cv%,CAPEX_NLP_rec_int_%cv%,CAPEX_MIP_rec_int_%cv%,QTRY_rec_int_%cv%,QTRY_LEG_rec_int_%cv%,QLS_rec_int_%cv%,QLS_LEG_rec_int_%cv%,ACC_CAPEX_NLP_rec_int_%cv%,ACC_CAPEX_NLP_LEG_rec_int_%cv%,ACC_CAPEX_MIP_rec_int_%cv%,CAPEX_MIP_LEG_rec_int_%cv%,ACC_CAPEX_MIP_LEG_rec_int_%cv%,RHO_rec_int_%cv%,RHO_LEG_rec_int_%cv%,
$load CAPEX_CON_con_int_%cv%,CAPEX_NLP_con_int_%cv%,CAPEX_MIP_con_int_%cv%,QTRY_con_int_%cv%,QTRY_LEG_con_int_%cv%,QLS_con_int_%cv%,QLS_LEG_con_int_%cv%,ACC_CAPEX_NLP_con_int_%cv%,ACC_CAPEX_NLP_LEG_con_int_%cv%,ACC_CAPEX_MIP_con_int_%cv%,CAPEX_MIP_LEG_con_int_%cv%,ACC_CAPEX_MIP_LEG_con_int_%cv%,RHO_con_int_%cv%,RHO_LEG_con_int_%cv%,
$load CAPEX_CON_dis_int_%cv%,CAPEX_NLP_dis_int_%cv%,CAPEX_MIP_dis_int_%cv%,QTRY_dis_int_%cv%,QTRY_LEG_dis_int_%cv%,QLS_dis_int_%cv%,QLS_LEG_dis_int_%cv%,ACC_CAPEX_NLP_dis_int_%cv%,ACC_CAPEX_NLP_LEG_dis_int_%cv%,ACC_CAPEX_MIP_dis_int_%cv%,CAPEX_MIP_LEG_dis_int_%cv%,ACC_CAPEX_MIP_LEG_dis_int_%cv%,RHO_dis_int_%cv%,RHO_LEG_dis_int_%cv%,
$load CAPEXEUR_CON_rec_int_%cv%,CAPEXEUR_NLP_rec_int_%cv%,CAPEXEUR_MIP_rec_int_%cv%,QTRYEUR_rec_int_%cv%,QTRYEUR_LEG_rec_int_%cv%,QEURLS_rec_int_%cv%,QEURLS_LEG_rec_int_%cv%,ACC_CAPEXEUR_NLP_rec_int_%cv%,ACC_CAPEXEUR_NLP_LEG_rec_int_%cv%,ACC_CAPEXEUR_MIP_rec_int_%cv%,CAPEXEUR_MIP_LEG_rec_int_%cv%,ACC_CAPEXEUR_MIP_LEG_rec_int_%cv%,RHOEUR_rec_int_%cv%,RHOEUR_LEG_rec_int_%cv%,
$load CAPEXEUR_CON_con_int_%cv%,CAPEXEUR_NLP_con_int_%cv%,CAPEXEUR_MIP_con_int_%cv%,QTRYEUR_con_int_%cv%,QTRYEUR_LEG_con_int_%cv%,QEURLS_con_int_%cv%,QEURLS_LEG_con_int_%cv%,ACC_CAPEXEUR_NLP_con_int_%cv%,ACC_CAPEXEUR_NLP_LEG_con_int_%cv%,ACC_CAPEXEUR_MIP_con_int_%cv%,CAPEXEUR_MIP_LEG_con_int_%cv%,ACC_CAPEXEUR_MIP_LEG_con_int_%cv%,RHOEUR_con_int_%cv%,RHOEUR_LEG_con_int_%cv%,
$load CAPEXEUR_CON_dis_int_%cv%,CAPEXEUR_NLP_dis_int_%cv%,CAPEXEUR_MIP_dis_int_%cv%,QTRYEUR_dis_int_%cv%,QTRYEUR_LEG_dis_int_%cv%,QEURLS_dis_int_%cv%,QEURLS_LEG_dis_int_%cv%,ACC_CAPEXEUR_NLP_dis_int_%cv%,ACC_CAPEXEUR_NLP_LEG_dis_int_%cv%,ACC_CAPEXEUR_MIP_dis_int_%cv%,CAPEXEUR_MIP_LEG_dis_int_%cv%,ACC_CAPEXEUR_MIP_LEG_dis_int_%cv%,RHOEUR_dis_int_%cv%,RHOEUR_LEG_dis_int_%cv%,
$load KTRY_int_%cv%,KQLS_int_%cv%,IK_int_%cv%,KCAPCOST_MIP_int_%cv%,KCAPEX_MIP_int_%cv%,IXLS_int_%cv%,KRHO_int_%cv%,
$load KTRYEUR_int_%cv%,KEURLS_int_%cv%,IKEUR_int_%cv%,KCAPCOSTEUR_MIP_int_%cv%,KCAPEXEUR_MIP_int_%cv%,IXEURLS_int_%cv%,KRHOEUR_int_%cv%
$gdxin

XC.L(i,v,r,t)             = XC_int_%cv%(i,v,r,t) ;
IX.L(i,r,t)               = IX_int_%cv%(i,r,t) ;
GC.L(j,v,r,t)             = GC_int_%cv%(j,v,r,t) ;
IG.L(j,r,t)               = IG_int_%cv%(j,r,t) ;
IT.L(k,r,rr,t)            = IT_int_%cv%(k,r,rr,t) ;
TC.L(k,r,rr,t)            = TC_int_%cv%(k,r,rr,t) ;

$ontext
BS.L(s,r,t)               = BS_int_%cv%(s,r,t) ;
X.L(s,i,v,r,t)            = X_int_%cv%(s,i,v,r,t) ;
XCS.L(s,i,v,r,t)          = XCS_int_%cv%(s,i,v,r,t) ;
XTWH.L(i,v,r,t)           = XTWH_int_%cv%(i,v,r,t) ;
G.L(s,j,v,r,t)            = G_int_%cv%(s,j,v,r,t) ;
GD.L(s,j,v,r,t)           = GD_int_%cv%(s,j,v,r,t) ;
GCS.L(s,j,v,r,t)          = GCS_int_%cv%(s,j,v,r,t) ;
GB.L(s,j,v,r,t)           = GB_int_%cv%(s,j,v,r,t) ;
E.L(s,k,r,rr,t) = E_int_%cv%(s,k,r,rr,t) ;
TCS.L(s,k,r,rr,t) = TCS_int_%cv%(s,k,r,rr,t) ;
EC_r.L(r,t)               = EC_r_int_%cv%(r,t) ;
BC_r.L(r,t)               = BC_r_int_%cv%(r,t) ;
SC_r.L(r,t)               = SC_r_int_%cv%(r,t) ;
GASC_r.L(r,t)             = GASC_r_int_%cv%(r,t) ;
EC.L(t)                   = EC_int_%cv%(t) ;
BC.L(t)                   = BC_int_%cv%(t) ;
SC.L(t)                   = SC_int_%cv%(t) ;
GASC.L(t)                 = GASC_int_%cv%(t) ;
SURPLUS.L                 = SURPLUS_int_%cv% ;
$offtext

*$ontext
*$if      set doing       $if      set recall       $if not set eur                       CAPEX_CON.L(i,v,r)        = CAPEX_CON_rec_int_%cv%(i,v,r) ;
*$if      set doing       $if      set recall       $if not set eur                       CAPEX_NLP.L(i,v,r)        = CAPEX_NLP_rec_int_%cv%(i,v,r) ;
*$if      set doing       $if      set recall       $if not set eur       $if     set leg CAPEX_NLP_LEG.L(i,v,r)    = CAPEX_NLP_LEG_rec_int_%cv%(i,v,r) ;
$if      set doing       $if      set recall       $if not set eur       $if not set leg CAPEX_MIP.L(i,v,r)        = CAPEX_MIP_rec_int_%cv%(i,v,r) * 1e-6 ;
$if      set doing       $if      set recall       $if not set eur       $if     set leg CAPEX_MIP.L(i,v,r)        = CAPEX_MIP_LEG_rec_int_%cv%(i,v,r) * 1e-6  ;
$if      set doing       $if      set recall       $if not set eur                       QTRY.L(i,r,t)             = QTRY_rec_int_%cv%(i,r,t) * 1e-3 ;
$if      set doing       $if      set recall       $if not set eur       $if     set leg QTRY_LEG.L(i,r,t)         = QTRY_LEG_rec_int_%cv%(i,r,t) * 1e-3 ;
$if      set doing       $if      set recall       $if not set eur                       QLS.L(i,r,t,ls)           = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QLS_rec_int_%cv%(i,r,t,ls_int_%cv%)) * 1e-3 ;
$if      set doing       $if      set recall       $if not set eur       $if     set leg QLS_LEG.L(i,r,t,ls)       = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QLS_LEG_rec_int_%cv%(i,r,t,ls_int_%cv%)) * 1e-3 ;
*$if      set doing       $if      set recall       $if not set eur                       ACC_CAPEX_NLP.L(i,r,t)    = ACC_CAPEX_NLP_rec_int_%cv%(i,r,t) ;
*$if      set doing       $if      set recall       $if not set eur       $if     set leg ACC_CAPEX_NLP_LEG.L(i,r,t)  = ACC_CAPEX_NLP_LEG_rec_int_%cv%(i,r,t) ;
$if      set doing       $if      set recall       $if not set eur                       ACC_CAPEX_MIP.L(i,r,t)    = ACC_CAPEX_MIP_rec_int_%cv%(i,r,t) * 1e-6 ;
$if      set doing       $if      set recall       $if not set eur       $if     set leg ACC_CAPEX_MIP_LEG.L(i,r,t)  = ACC_CAPEX_MIP_LEG_rec_int_%cv%(i,r,t) * 1e-6 ;
$if      set doing       $if      set recall       $if not set eur                       RHO.L(i,r,t,ls)           = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHO_rec_int_%cv%(i,r,t,ls_int_%cv%)) ;
$if      set doing       $if      set recall       $if not set eur       $if     set leg RHO_LEG.L(i,r,t,ls)       = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHO_LEG_rec_int_%cv%(i,r,t,ls_int_%cv%)) ;

*$if      set doing       $if      set continuous   $if not set eur                       CAPEX_CON.L(i,v,r)        = CAPEX_CON_con_int_%cv%(i,v,r) ;
*$if      set doing       $if      set continuous   $if not set eur                       CAPEX_NLP.L(i,v,r)        = CAPEX_NLP_con_int_%cv%(i,v,r) ;
*$if      set doing       $if      set continuous   $if not set eur       $if     set leg CAPEX_NLP_LEG.L(i,v,r)    = CAPEX_NLP_LEG_con_int_%cv%(i,v,r) ;
$if      set doing       $if      set continuous   $if not set eur       $if not set leg CAPEX_MIP.L(i,v,r)        = CAPEX_MIP_con_int_%cv%(i,v,r) * 1e-6 ;
$if      set doing       $if      set continuous   $if not set eur       $if     set leg CAPEX_MIP.L(i,v,r)        = CAPEX_MIP_LEG_con_int_%cv%(i,v,r) * 1e-6  ;
$if      set doing       $if      set continuous   $if not set eur                       QTRY.L(i,r,t)             = QTRY_con_int_%cv%(i,r,t) * 1e-3 ;
$if      set doing       $if      set continuous   $if not set eur       $if     set leg QTRY_LEG.L(i,r,t)         = QTRY_LEG_con_int_%cv%(i,r,t) * 1e-3 ;
$if      set doing       $if      set continuous   $if not set eur                       QLS.L(i,r,t,ls)           = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QLS_con_int_%cv%(i,r,t,ls_int_%cv%)) * 1e-3 ;
$if      set doing       $if      set continuous   $if not set eur       $if     set leg QLS_LEG.L(i,r,t,ls)       = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QLS_LEG_con_int_%cv%(i,r,t,ls_int_%cv%)) * 1e-3 ;
*$if      set doing       $if      set continuous   $if not set eur                       ACC_CAPEX_NLP.L(i,r,t)    = ACC_CAPEX_NLP_con_int_%cv%(i,r,t) ;
*$if      set doing       $if      set continuous   $if not set eur       $if     set leg ACC_CAPEX_NLP_LEG.L(i,r,t)  = ACC_CAPEX_NLP_LEG_con_int_%cv%(i,r,t) ;
$if      set doing       $if      set continuous   $if not set eur                       ACC_CAPEX_MIP.L(i,r,t)    = ACC_CAPEX_MIP_con_int_%cv%(i,r,t) * 1e-6 ;
$if      set doing       $if      set continuous   $if not set eur       $if     set leg ACC_CAPEX_MIP_LEG.L(i,r,t)  = ACC_CAPEX_MIP_LEG_con_int_%cv%(i,r,t) * 1e-6 ;
$if      set doing       $if      set continuous   $if not set eur                       RHO.L(i,r,t,ls)           = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHO_con_int_%cv%(i,r,t,ls_int_%cv%)) ;
$if      set doing       $if      set continuous   $if not set eur       $if     set leg RHO_LEG.L(i,r,t,ls)       = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHO_LEG_con_int_%cv%(i,r,t,ls_int_%cv%)) ;

*$if      set doing       $if      set discrete     $if not set eur                       CAPEX_CON.L(i,v,r)        = CAPEX_CON_dis_int_%cv%(i,v,r) ;
*$if      set doing       $if      set discrete     $if not set eur                       CAPEX_NLP.L(i,v,r)        = CAPEX_NLP_dis_int_%cv%(i,v,r) ;
*$if      set doing       $if      set discrete     $if not set eur       $if     set leg CAPEX_NLP_LEG.L(i,v,r)    = CAPEX_NLP_LEG_dis_int_%cv%(i,v,r) ;
$if      set doing       $if      set discrete     $if not set eur       $if not set leg CAPEX_MIP.L(i,v,r)        = CAPEX_MIP_dis_int_%cv%(i,v,r) * 1e-6  ;
$if      set doing       $if      set discrete     $if not set eur       $if     set leg CAPEX_MIP.L(i,v,r)        = CAPEX_MIP_LEG_dis_int_%cv%(i,v,r) * 1e-6  ;
$if      set doing       $if      set discrete     $if not set eur                       QTRY.L(i,r,t)             = QTRY_dis_int_%cv%(i,r,t) * 1e-3 ;
$if      set doing       $if      set discrete     $if not set eur       $if     set leg QTRY_LEG.L(i,r,t)         = QTRY_LEG_dis_int_%cv%(i,r,t) * 1e-3 ;
$if      set doing       $if      set discrete     $if not set eur                       QLS.L(i,r,t,ls)           = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QLS_dis_int_%cv%(i,r,t,ls_int_%cv%)) * 1e-3 ;
$if      set doing       $if      set discrete     $if not set eur       $if     set leg QLS_LEG.L(i,r,t,ls)       = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QLS_LEG_dis_int_%cv%(i,r,t,ls_int_%cv%)) * 1e-3 ;
*$if      set doing       $if      set discrete     $if not set eur                       ACC_CAPEX_NLP.L(i,r,t)    = ACC_CAPEX_NLP_dis_int_%cv%(i,r,t) ;
*$if      set doing       $if      set discrete     $if not set eur       $if     set leg ACC_CAPEX_NLP_LEG.L(i,r,t)  = ACC_CAPEX_NLP_LEG_dis_int_%cv%(i,r,t) ;
$if      set doing       $if      set discrete     $if not set eur                       ACC_CAPEX_MIP.L(i,r,t)    = ACC_CAPEX_MIP_dis_int_%cv%(i,r,t) * 1e-6  ;
$if      set doing       $if      set discrete     $if not set eur       $if     set leg ACC_CAPEX_MIP_LEG.L(i,r,t)  = ACC_CAPEX_MIP_LEG_dis_int_%cv%(i,r,t) * 1e-6 ;
$if      set doing       $if      set discrete     $if not set eur                       RHO.L(i,r,t,ls)           = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHO_dis_int_%cv%(i,r,t,ls_int_%cv%)) ;
$if      set doing       $if      set discrete     $if not set eur       $if     set leg RHO_LEG.L(i,r,t,ls)       = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHO_LEG_dis_int_%cv%(i,r,t,ls_int_%cv%)) ;

*$if      set doing       $if      set recall       $if     set eur                       CAPEXEUR_CON.L(i,v)       = CAPEXEUR_CON_rec_int_%cv%(i,v) ;
*$if      set doing       $if      set recall       $if     set eur                       CAPEXEUR_NLP.L(i,v)       = CAPEXEUR_NLP_rec_int_%cv%(i,v) ;
*$if      set doing       $if      set recall       $if     set eur       $if     set leg CAPEXEUR_NLP_LEG.L(i,v)   = CAPEXEUR_NLP_LEG_rec_int_%cv%(i,v) ;
$if      set doing       $if      set recall       $if     set eur       $if not set leg CAPEXEUR_MIP.L(i,v)       = CAPEXEUR_MIP_rec_int_%cv%(i,v) * 1e-6 ;
$if      set doing       $if      set recall       $if     set eur       $if     set leg CAPEXEUR_MIP.L(i,v)       = CAPEXEUR_MIP_LEG_rec_int_%cv%(i,v) * 1e-6 ;
$if      set doing       $if      set recall       $if     set eur                       QTRYEUR.L(i,t)            = QTRYEUR_rec_int_%cv%(i,t) * 1e-3 ;
$if      set doing       $if      set recall       $if     set eur       $if     set leg QTRYEUR_LEG.L(i,t)        = QTRYEUR_LEG_rec_int_%cv%(i,t) * 1e-3 ;
$if      set doing       $if      set recall       $if     set eur                       QEURLS.L(i,t,ls)          = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QEURLS_rec_int_%cv%(i,t,ls_int_%cv%)) * 1e-3 ;
$if      set doing       $if      set recall       $if     set eur       $if     set leg QEURLS_LEG.L(i,t,ls)      = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QEURLS_LEG_rec_int_%cv%(i,t,ls_int_%cv%)) * 1e-3 ;
*$if      set doing       $if      set recall       $if     set eur                       ACC_CAPEXEUR_NLP.L(i,t)   = ACC_CAPEXEUR_NLP_rec_int_%cv%(i,t) ;
*$if      set doing       $if      set recall       $if     set eur       $if     set leg ACC_CAPEXEUR_NLP_LEG.L(i,t) = ACC_CAPEXEUR_NLP_LEG_rec_int_%cv%(i,t) ;
$if      set doing       $if      set recall       $if     set eur                       ACC_CAPEXEUR_MIP.L(i,t)   = ACC_CAPEXEUR_MIP_rec_int_%cv%(i,t) * 1e-6  ;
$if      set doing       $if      set recall       $if     set eur       $if     set leg ACC_CAPEXEUR_MIP_LEG.L(i,t) = ACC_CAPEXEUR_MIP_LEG_rec_int_%cv%(i,t) * 1e-6  ;
$if      set doing       $if      set recall       $if     set eur                       RHOEUR.L(i,t,ls)          = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHOEUR_rec_int_%cv%(i,t,ls_int_%cv%)) ;
$if      set doing       $if      set recall       $if     set eur       $if     set leg RHOEUR_LEG.L(i,t,ls)      = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHOEUR_LEG_rec_int_%cv%(i,t,ls_int_%cv%)) ;

*$if      set doing       $if      set continuous   $if     set eur                       CAPEXEUR_CON.L(i,v)       = CAPEXEUR_CON_con_int_%cv%(i,v) ;
*$if      set doing       $if      set continuous   $if     set eur                       CAPEXEUR_NLP.L(i,v)       = CAPEXEUR_NLP_con_int_%cv%(i,v) ;
*$if      set doing       $if      set continuous   $if     set eur       $if     set leg CAPEXEUR_NLP_LEG.L(i,v)   = CAPEXEUR_NLP_LEG_con_int_%cv%(i,v) ;
$if      set doing       $if      set continuous   $if     set eur       $if not set leg CAPEXEUR_MIP.L(i,v)       = CAPEXEUR_MIP_con_int_%cv%(i,v) * 1e-6  ;
$if      set doing       $if      set continuous   $if     set eur       $if     set leg CAPEXEUR_MIP.L(i,v)       = CAPEXEUR_MIP_LEG_con_int_%cv%(i,v) * 1e-6  ;
$if      set doing       $if      set continuous   $if     set eur                       QTRYEUR.L(i,t)            = QTRYEUR_con_int_%cv%(i,t) * 1e-3 ;
$if      set doing       $if      set continuous   $if     set eur       $if     set leg QTRYEUR_LEG.L(i,t)        = QTRYEUR_LEG_con_int_%cv%(i,t) * 1e-3 ;
$if      set doing       $if      set continuous   $if     set eur                       QEURLS.L(i,t,ls)          = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QEURLS_con_int_%cv%(i,t,ls_int_%cv%)) * 1e-3 ;
$if      set doing       $if      set continuous   $if     set eur       $if     set leg QEURLS_LEG.L(i,t,ls)      = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QEURLS_LEG_con_int_%cv%(i,t,ls_int_%cv%)) * 1e-3 ;
*$if      set doing       $if      set continuous   $if     set eur                       ACC_CAPEXEUR_NLP.L(i,t)   = ACC_CAPEXEUR_NLP_con_int_%cv%(i,t) ;
*$if      set doing       $if      set continuous   $if     set eur       $if     set leg ACC_CAPEXEUR_NLP_LEG.L(i,t) = ACC_CAPEXEUR_NLP_LEG_con_int_%cv%(i,t) ;
$if      set doing       $if      set continuous   $if     set eur                       ACC_CAPEXEUR_MIP.L(i,t)   = ACC_CAPEXEUR_MIP_con_int_%cv%(i,t) * 1e-6  ;
$if      set doing       $if      set continuous   $if     set eur       $if     set leg ACC_CAPEXEUR_MIP_LEG.L(i,t) = ACC_CAPEXEUR_MIP_LEG_con_int_%cv%(i,t) * 1e-6  ;
$if      set doing       $if      set continuous   $if     set eur                       RHOEUR.L(i,t,ls)          = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHOEUR_con_int_%cv%(i,t,ls_int_%cv%)) ;
$if      set doing       $if      set continuous   $if     set eur       $if     set leg RHOEUR_LEG.L(i,t,ls)      = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHOEUR_LEG_con_int_%cv%(i,t,ls_int_%cv%)) ;

*$if      set doing       $if      set discrete     $if     set eur                       CAPEXEUR_CON.L(i,v)       = CAPEXEUR_CON_dis_int_%cv%(i,v) ;
*$if      set doing       $if      set discrete     $if     set eur                       CAPEXEUR_NLP.L(i,v)       = CAPEXEUR_NLP_dis_int_%cv%(i,v) ;
*$if      set doing       $if      set discrete     $if     set eur       $if     set leg CAPEXEUR_NLP_LEG.L(i,v)   = CAPEXEUR_NLP_LEG_dis_int_%cv%(i,v) ;
$if      set doing       $if      set discrete     $if     set eur       $if not set leg CAPEXEUR_MIP.L(i,v)       = CAPEXEUR_MIP_dis_int_%cv%(i,v) * 1e-6  ;
$if      set doing       $if      set discrete     $if     set eur       $if     set leg CAPEXEUR_MIP.L(i,v)       = CAPEXEUR_MIP_LEG_dis_int_%cv%(i,v) * 1e-6  ;
$if      set doing       $if      set discrete     $if     set eur                       QTRYEUR.L(i,t)            = QTRYEUR_dis_int_%cv%(i,t) * 1e-3 ;
$if      set doing       $if      set discrete     $if     set eur       $if     set leg QTRYEUR_LEG.L(i,t)        = QTRYEUR_LEG_dis_int_%cv%(i,t) * 1e-3 ;
$if      set doing       $if      set discrete     $if     set eur                       QEURLS.L(i,t,ls)          = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QEURLS_dis_int_%cv%(i,t,ls_int_%cv%)) * 1e-3 ;
$if      set doing       $if      set discrete     $if     set eur       $if     set leg QEURLS_LEG.L(i,t,ls)      = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), QEURLS_LEG_dis_int_%cv%(i,t,ls_int_%cv%)) * 1e-3 ;
*$if      set doing       $if      set discrete     $if     set eur                       ACC_CAPEXEUR_NLP.L(i,t)   = ACC_CAPEXEUR_NLP_dis_int_%cv%(i,t) ;
*$if      set doing       $if      set discrete     $if     set eur       $if     set leg ACC_CAPEXEUR_NLP_LEG.L(i,t) = ACC_CAPEXEUR_NLP_LEG_dis_int_%cv%(i,t) ;
$if      set doing       $if      set discrete     $if     set eur                       ACC_CAPEXEUR_MIP.L(i,t)   = ACC_CAPEXEUR_MIP_dis_int_%cv%(i,t) * 1e-6  ;
$if      set doing       $if      set discrete     $if     set eur       $if     set leg ACC_CAPEXEUR_MIP_LEG.L(i,t) = ACC_CAPEXEUR_MIP_LEG_dis_int_%cv%(i,t) * 1e-6  ;
$if      set doing       $if      set discrete     $if     set eur                       RHOEUR.L(i,t,ls)          = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHOEUR_dis_int_%cv%(i,t,ls_int_%cv%)) ;
$if      set doing       $if      set discrete     $if     set eur       $if     set leg RHOEUR_LEG.L(i,t,ls)      = sum(ls_int_%cv%$(sameas(ls_int_%cv%,ls)), RHOEUR_LEG_dis_int_%cv%(i,t,ls_int_%cv%)) ;
*$offtext

*$ontext
$if      set searching   $if not set eur       KTRY.L(i,r,t)             =        KTRY_int_%cv%(i,r,t) ;
$if      set searching   $if not set eur       KQLS.L(i,r,t,kls)         =        sum(kls_int_%cv%$(sameas(kls_int_%cv%,kls)), KQLS_int_%cv%(i,r,t,kls_int_%cv%)) ;
$if      set searching   $if not set eur       IK.L(i,r,t)               =        IK_int_%cv%(i,r,t) ;
$if      set searching   $if not set eur       KCAPCOST_MIP.L(i,r,t)     =        KCAPCOST_MIP_int_%cv%(i,r,t) ;
$if      set searching   $if not set eur       KCAPEX_MIP.L(i,r,t)       =        KCAPEX_MIP_int_%cv%(i,r,t) ;
$if      set searching   $if not set eur       IXLS.L(i,r,t,kls)         =        sum(kls_int_%cv%$(sameas(kls_int_%cv%,kls)), IXLS_int_%cv%(i,r,t,kls_int_%cv%)) ;
$if      set searching   $if not set eur       KRHO.L(i,r,t,kls)         =        sum(kls_int_%cv%$(sameas(kls_int_%cv%,kls)), KRHO_int_%cv%(i,r,t,kls_int_%cv%)) ;

$if      set searching   $if     set eur       KTRYEUR.L(i,t)            =        KTRYEUR_int_%cv%(i,t) ;
$if      set searching   $if     set eur       KEURLS.L(i,t,kls)         =        sum(kls_int_%cv%$(sameas(kls_int_%cv%,kls)), KEURLS_int_%cv%(i,t,kls_int_%cv%)) ;
$if      set searching   $if     set eur       IKEUR.L(i,t)              =        IKEUR_int_%cv%(i,t) ;
$if      set searching   $if     set eur       KCAPCOSTEUR_MIP.L(i,t)    =        KCAPCOSTEUR_MIP_int_%cv%(i,t) ;
$if      set searching   $if     set eur       KCAPEXEUR_MIP.L(i,t)      =        KCAPEXEUR_MIP_int_%cv%(i,t) ;
$if      set searching   $if     set eur       IXEURLS.L(i,t,kls)        =        sum(kls_int_%cv%$(sameas(kls_int_%cv%,kls)), IXEURLS_int_%cv%(i,t,kls_int_%cv%)) ;
$if      set searching   $if     set eur       KRHOEUR.L(i,t,kls)        =        sum(kls_int_%cv%$(sameas(kls_int_%cv%,kls)), KRHOEUR_int_%cv%(i,t,kls_int_%cv%)) ;
*$offtext
...
$if      set storage  $if not   set storspec                                storagebal0
...
$if      set co2mark   $if      set shortrun     co2flowuk
$if      set co2mark   $if      set shortrun     ukets
* CO2 market with MSR dynamics via iterative modeling (only shortrun)
$if      set co2iter   $if      set shortrun     it_co2floweu
...
$if      set co2iter   $if      set shortrun     co2flowuk
$if      set co2iter   $if      set shortrun     ukets
* CO2 market with MSR dynamics as simple as possible (only shortrun)
$if      set co2mips   $if      set shortrun     eqs_co2floweu
...
$if      set co2mips   $if      set shortrun     co2flowuk
$if      set co2mips   $if      set shortrun     ukets
* Policy
...
* * * European Learning-by-Doing
$if      set doing       $if      set recall       $if     set eur                       acc_qeur_recall2020
$if      set doing       $if      set recall       $if     set eur     $if       set leg acc_qeur_leg_recall2020
$if      set doing       $if      set recall       $if     set eur                       acc_qeur_recall
$if      set doing       $if      set recall       $if     set eur     $if       set leg acc_qeur_leg_recall
$if      set doing       $if      set continuous   $if     set eur                       acc_qeur_continuous2020
$if      set doing       $if      set continuous   $if     set eur     $if       set leg acc_qeur_leg_continuous2020
$if      set doing       $if      set continuous   $if     set eur                       acc_qeur_continuous
$if      set doing       $if      set continuous   $if     set eur     $if       set leg acc_qeur_leg_continuous
$if      set doing       $if      set discrete     $if     set eur                       acc_qeur_discrete2020
$if      set doing       $if      set discrete     $if     set eur     $if       set leg acc_qeur_leg_discrete2020
$if      set doing       $if      set discrete     $if     set eur                       acc_qeur_discrete
$if      set doing       $if      set discrete     $if     set eur     $if       set leg acc_qeur_leg_discrete
$if      set doing       $if      set constant     $if     set eur                       capexeur_constant
$if      set doing       $if      set nonlinear    $if     set eur                       capexeur_nonlinear
$if      set doing       $if      set nonlinear    $if     set eur                       acc_capexeur_nonlinear
$if      set doing       $if      set nonlinear    $if     set eur     $if       set leg acc_capexeur_leg_nonlinear
$if      set doing       $if      set mip          $if     set eur                       capexeur_mixedip
$if      set doing       $if      set mip          $if     set eur                       acc_capexeur_mixedip
$if      set doing       $if      set mip          $if     set eur     $if       set leg acc_capexeur_leg_mixedip
$if      set doing       $if      set mip          $if     set eur                       rhoeur_mixedip
$if      set doing       $if      set mip          $if     set eur     $if       set leg rhoeur_leg_mixedip
$if      set doing       $if      set mip          $if     set eur                       qeurlsLO_mixedip
$if      set doing       $if      set mip          $if     set eur     $if       set leg qeurlsLO_leg_mixedip
$if      set doing       $if      set mip          $if     set eur                       qeurlsUP_mixedip
$if      set doing       $if      set mip          $if     set eur     $if       set leg qeurlsUP_leg_mixedip
$if      set doing       $if      set mip          $if     set eur                       acc_qeurls_mixedip
$if      set doing       $if      set mip          $if     set eur     $if       set leg acc_qeurls_leg_mixedip
* Max constraints
$if      set doing       $if      set mip          $if     set eur                       acc_qeur_max
$if      set doing       $if      set mip          $if     set eur     $if       set leg acc_qeur_leg_max
* Monotonicity constraints
$if      set doing       $if      set recall       $if     set eur                       acc_qeur_mono
$if      set doing       $if      set recall       $if     set eur     $if       set leg acc_qeur_leg_mono
$if      set doing       $if      set recall       $if     set eur                       rhoeur_mixedip_mono
$if      set doing       $if      set recall       $if     set eur     $if       set leg rhoeur_leg_mixedip_mono
$if      set doing       $if      set recall       $if     set eur                       qeurls_mixedip_mono
$if      set doing       $if      set recall       $if     set eur     $if       set leg qeurls_leg_mixedip_mono
* * * Regional Learning-by-Searching
$if      set searching   $if      set mip          $if not set eur                       acc_k_continuous2020
$if      set searching   $if      set mip          $if not set eur                       acc_k_continuous
$if      set searching   $if      set mip          $if not set eur                       rho_mixedip_k
$if      set searching   $if      set mip          $if not set eur                       capex_mixedip_k
$if      set searching   $if      set mip          $if not set eur                       searching_helper1
$if      set searching   $if      set mip          $if not set eur                       searching_helper2
$if      set searching   $if      set mip          $if not set eur                       searching_helper3
$if      set searching   $if      set mip          $if not set eur                       searching_helper4
$if      set searching   $if      set mip          $if not set eur                       capcost_mixedip_k
$if      set searching   $if      set mip          $if not set eur                       klsLO_mixedip
$if      set searching   $if      set mip          $if not set eur                       klsUP_mixedip
$if      set searching   $if      set mip          $if not set eur                       acc_kls_mixedip
* Budget constraints
$if      set searching   $if      set mip          $if not set eur    $if      set budgetirt       eq_rd_budget_irt
$if      set searching   $if      set mip          $if not set eur    $if      set budgetrt        eq_rd_budget_rt
$if      set searching   $if      set mip          $if not set eur    $if      set budgetit        eq_rd_budget_it
$if      set searching   $if      set mip          $if not set eur    $if      set budgetir        eq_rd_budget_ir
$if      set searching   $if      set mip          $if not set eur    $if      set budgett         eq_rd_budget_t
$if      set searching   $if      set mip          $if not set eur    $if      set budgetr         eq_rd_budget_r
$if      set searching   $if      set mip          $if not set eur    $if      set budgeti         eq_rd_budget_i
$if      set searching   $if      set mip          $if not set eur    $if      set budget          eq_rd_budget
* * * European Learning-by-Searching
$if      set searching   $if      set mip          $if     set eur                       acc_keur_continuous2020
$if      set searching   $if      set mip          $if     set eur                       acc_keur_continuous
$if      set searching   $if      set mip          $if     set eur                       rhoeur_mixedip_k
$if      set searching   $if      set mip          $if     set eur                       capexeur_mixedip_k
$if      set searching   $if      set mip          $if     set eur                       searchingeur_helper1
$if      set searching   $if      set mip          $if     set eur                       searchingeur_helper2
$if      set searching   $if      set mip          $if     set eur                       searchingeur_helper3
$if      set searching   $if      set mip          $if     set eur                       searchingeur_helper4
$if      set searching   $if      set mip          $if     set eur                       capcosteur_mixedip_k
$if      set searching   $if      set mip          $if     set eur                       keurlsLO_mixedip
$if      set searching   $if      set mip          $if     set eur                       keurlsUP_mixedip
$if      set searching   $if      set mip          $if     set eur                       acc_keurls_mixedip
* Budget constraints
$if      set searching   $if      set mip          $if     set eur    $if      set budgeteurit     eq_rd_budgeteur_it
$if      set searching   $if      set mip          $if     set eur    $if      set budgeteuri      eq_rd_budgeteur_i
$if      set searching   $if      set mip          $if     set eur    $if      set budgeteurt      eq_rd_budgeteur_t
$if      set searching   $if      set mip          $if     set eur    $if      set budgeteur       eq_rd_budgeteur
...
$if not  set co2mips $if not  set techmin $if not  set mip  solve euregen using lp    minimizing SURPLUS ;
