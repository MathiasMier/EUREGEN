...
$if not set priceref p0(bse,s,r,t) = Electricity1_rpt("2022",r,"price-avg") ;
$if not set priceref d0(bse,s,r,t) = Electricity1_rpt(t,r,"elec-demand-ave") * bse_share(bse,r,t) * 1e+3 ;
