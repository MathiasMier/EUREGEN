...
par=co2indorgfix_in     rng=co2indfix_in!a2          rdim=1 cdim=0
...
co2marketeu(t)$(tmyopic(t))..           ECEU(t) * (1 + co2elecind(t)) + co2indorgfix_in(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t) =e= co2sup(t) + TNACUSE(t)
...
it_euets(t)$(tmyopic(t) and t.val le 2045)..        ECEU(t) * (1 + co2elecind(t)) + co2indorgfix_in(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t) =l= co2sup(t) + TNACUSE(t)
$if     set hedgeeua                                                                                                                        - co2out_in(t)
                                                    ;
it_euets2050(t)$(tmyopic(t) and t.val ge 2050)..    ECEU(t) * (1 + co2elecind(t)) + co2indorgfix_in(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t) =l= 0 ;
it_tnac(t)$(tmyopic(t)  and t.val le 2045)..        TNAC(t) =e= tnacstart_in - sum(tt$(tt.val le t.val and tt.val ge 2022), TNACUSE(tt) * nyrs(tt)) ;
