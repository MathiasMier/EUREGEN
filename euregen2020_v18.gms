...
voll(r,"2022") = 1000 ;
$if set shortrun   voll(r,"2023") = 2000 ;
$if set shortrun   voll(r,"2024") = 3000 ;
$if set shortlong  voll(r,"2023") = 2000 ;
$if set shortlong  voll(r,"2024") = 3000 ;
voll(r,"2025") = 4000 ;
...
demand_rsa(peak(s,r),t)$(t.val ge 2025 and tmyopic(t))..
...
$if set co2mark $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 500 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) + 250 ;

$if set co2mark $if not set bauprice ECEU.UP(t)$(sameas(t,"2023")) = co2ele_org(t) + 360 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(sameas(t,"2023")) = co2ele_org(t) + 100 ;

$if set co2mark $if not set bauprice ECEU.UP(t)$(sameas(t,"2024")) = co2ele_org(t) + 250 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(sameas(t,"2024")) = co2ele_org(t) + 50 ;

$if set co2mark $if not set bauprice ECEU.UP(t)$(sameas(t,"2025")) = co2ele_org(t) + 150 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(sameas(t,"2025")) = co2ele_org(t) + 0 ;
...
$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val le 2045) = co2ele_org(t) + 50 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(t.val le 2045) = co2ele_org(t) - 50 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 500 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) + 50 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2023")) = co2ele_org(t) + 360 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2023")) = co2ele_org(t) + 0 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2024")) = co2ele_org(t) + 250 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2024")) = co2ele_org(t) - 25 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2025")) = co2ele_org(t) + 150 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2025")) = co2ele_org(t) - 50 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) + 50 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2026) = co2ele_org(t) - 100 ;
...
$if set uselimits       $if     set banking $gdxin limits\%l%_bauprice.gdx
$if set uselimits       $if not set banking $gdxin limits\%l%_bauprice_nobanking.gdx
$if set uselimits                            $load ixfx, itfx, igfx
$if set uselimits                            $gdxin
* Investment limits depending on (not) shortrun modeling
$if set uselimits                                IX.FX(conv(i),r,t)$(t.val le 2030)      = ixfx(i,r,t) ;
$if set uselimits                                 IX.FX(nuc(i),r,t)$(t.val le 2030)       = ixfx(i,r,t) ;

$if set uselimits       $if     set shortrun    IX.FX(sol(i),r,t)$(t.val le 2022)       = ixfx(i,r,t) ;
...
$if set uselimits       $if     set shortrun    IX.FX(windon(i),r,t)$(t.val le 2023)    = ixfx(i,r,t) ;
...
$if set uselimits       $if     set shortrun    IX.FX(windoff(i),r,t)$(t.val le 2024)   = ixfx(i,r,t) ;
...
$if set uselimits       $if not set shortrun    IX.FX(sol(i),r,t)$(t.val le 2025)       = ixfx(i,r,t) ;
$if set uselimits       $if not set shortrun    IX.FX(windon(i),r,t)$(t.val le 2025)    = ixfx(i,r,t) ;
$if set uselimits       $if not set shortrun    IX.FX("Nuclear",r,t)$(t.val le 2025)   = ixfx(i,r,t) ;

$if set uselimits                               IT.FX(k,r,rr,t)$(t.val le 2030)         = itfx(k,r,rr,t) ;
$if set uselimits                               IG.FX("Storage_ST",r,t)$(t.val le 2025) = igfx("Storage_ST",r,t) ;
$if set uselimits                               IG.FX("Storage_LT",r,t)$(t.val le 2025) = igfx("Storage_LT",r,t) ;
...
$if set simpmip IX.FX("OpenPV_q70",r,t)$(not sameas(r,"Spain") or not sameas(r,"Italy") or not sameas(r,"Greece") or not sameas(r,"Croatia") or not sameas(r,"Portugal")) = 0 ;
$if set simpmip IX.FX("OpenPV_q50",r,t)$(not sameas(r,"Spain") or not sameas(r,"Italy") or not sameas(r,"Greece") or not sameas(r,"Croatia") or not sameas(r,"Portugal")) = 0 ;
$if set simpmip IX.FX("OpenPV_q30",r,t)$(not sameas(r,"Spain") or not sameas(r,"Italy") or not sameas(r,"Greece") or not sameas(r,"Croatia") or not sameas(r,"Portugal")) = 0 ;
$if set simpmip IX.FX("OpenPV_q10",r,t)$(not sameas(r,"Spain") or not sameas(r,"Italy") or not sameas(r,"Greece") or not sameas(r,"Croatia") or not sameas(r,"Portugal")) = 0 ;

$if set simpmip IX.FX("WindOn_q70",r,t)$(not sameas(r,"Denmark") or not sameas(r,"Ireland") or not sameas(r,"France") or not sameas(r,"Britain") or not sameas(r,"Netherlands") or not sameas(r,"Belgium") or not sameas(r,"Poland") or not sameas(r,"Germany")) = 0 ;
$if set simpmip IX.FX("WindOn_q50",r,t)$(not sameas(r,"Denmark") or not sameas(r,"Ireland") or not sameas(r,"France") or not sameas(r,"Britain") or not sameas(r,"Netherlands") or not sameas(r,"Belgium") or not sameas(r,"Poland") or not sameas(r,"Germany")) = 0 ;
$if set simpmip IX.FX("WindOn_q30",r,t)$(not sameas(r,"Denmark") or not sameas(r,"Ireland") or not sameas(r,"France") or not sameas(r,"Britain") or not sameas(r,"Netherlands") or not sameas(r,"Belgium") or not sameas(r,"Poland") or not sameas(r,"Germany")) = 0 ;
$if set simpmip IX.FX("WindOn_q10",r,t)$(not sameas(r,"Denmark") or not sameas(r,"Ireland") or not sameas(r,"France") or not sameas(r,"Britain") or not sameas(r,"Netherlands") or not sameas(r,"Belgium") or not sameas(r,"Poland") or not sameas(r,"Germany")) = 0 ;
