...
$load vrsc_s, vrsccorr, irnwflh_h, irnwflh_s, number, irnwlimUP_quantiles, qshare, vrscincrease, load_st
$gdxin
...
$if      set frnuccapreal      capcost("Nuclear","2022",rnuc(r)) = 8250 ;
...
$if     set nucall  $if      set opt1   zeta_invir_rpt(inv,i,v,rnonuc)$(sameas(i,"Nuclear"))            = zetastar_invir("opt1",inv,i,v,"France") ;
$if     set nucall  $if      set opt1   zeta_invir_nodisc_rpt(inv,i,v,rnonuc)$(sameas(i,"Nuclear"))     = zetastar_invir_nodisc("opt1",inv,i,v,"France") ;
$if     set nucall  $if      set opt3   zeta_invir_rpt(inv,i,v,rnonuc)$(sameas(i,"Nuclear"))            = zetastar_invir("opt3",inv,i,v,"France") ;
$if     set nucall  $if      set opt3   zeta_invir_nodisc_rpt(inv,i,v,rnonuc)$(sameas(i,"Nuclear"))     = zetastar_invir_nodisc("opt3",inv,i,v,"France") ;
...
emitfuel("Lignite") = 397.2 + 10.663 ;
emitfuel("Coal") = 338.61 ;
emitfuel("Gas") = 207.86 ;
emitfuel("Oil") = 268.77 ;
...
*emit(i,v,r)$(not ccs(i) and effrate(i,v,r)) = round(sum(xfueli(fuel,i), emitfuel(fuel) / effrate(i,v,r)) * 1e-3, 4) ;
...
$if      set newco2price    co2p(t) = round(255.982 * (dfact("2050")/nyrs("2050")) / (dfact(t)/nyrs(t)),4) ;
...
dref_sec_int(r,t,l) = daref_sec(r,t,l) / daref_sec(r,"2020",l) ;
dref_sec(r,t,l) = dref_sec_int(r,t,l) ;
dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.0) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind20    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 1.0) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind19    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.9) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind18    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.8) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind17    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.7) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind16    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.6) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind15    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.5) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind14    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.4) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind13    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.3) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind12    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.2) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind11    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 + 0.1) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind09    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 - 0.1) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind08    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 - 0.2) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind07    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 - 0.3) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind06    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 - 0.4) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;
$if set gerind05    dref_sec_int(r,t,l)$(sameas(r,"Germany") and sameas(l,"ind")) = 1 + (1 - 0.5) * (t.val - 2020) / (2050 - 2020) * (dref_sec(r,t,l) - 1) ;

* New calculation of sectoral and total demand (growth) as well as load
$if set secdemand   dref_sec(r,t,l)$(dref_sec_int(r,t,l) > 0) = round(dref_sec_int(r,t,l),4) ;
$if set secdemand   daref_sec(r,t,l) = round(daref_sec(r,"2020",l) * dref_sec(r,t,l), 4) ;
$if set secdemand   daref(r,t) = round(sum(l, daref_sec(r,t,l)),4) ;
$if set secdemand   dref(r,t) = round(daref(r,t) / daref(r,"2020"),4) ;
$if set secdemand   load_st(s,r,t) = round(load_s(s,r) * daref(r,"2020") * 1e+3 / sum(ss, hours(ss) * load_s(ss,r)) + (daref(r,t) - daref(r,"2020")) * 1e+3 / 8760,4) ;
$if set loadshape   load_st(s,r,t) = round(load_s(s,r) * daref(r,"2020") * 1e+3 / sum(ss, hours(ss) * load_s(ss,r)) * dref(r,t),4) ;

$if not set priceref $gdxin elastic\priceref.gdx
$if not set priceref $load price, Electricity1_rpt
$if not set priceref $gdxin
...
$if     set nogroups pelas(bse,s,r,t) = 0 ;
$if     set nogroups pelas("bs6",s,r,t) = -0.01 ;

$if not set priceref p0ave(bse,s,r,t) = Electricity1_rpt("2022",r,"price-avg") ;
$if not set priceref d0ave(bse,s,r,t) = Electricity1_rpt(t,r,"elec-demand-ave") * bse_share(bse,r,t) * 1e+3 ;

$if     set priceref p0(bse,s,r,t) = Electricity1_rpt(t,r,"price-avg") ;
$if     set priceref d0(bse,s,r,t) = load_st(s,r,t) * bse_share(bse,r,t) * 1e+3 ;
...
p0dtwh(r,t) = Electricity1_rpt(t,r,"price-avg") ;
d0dtwh(r,t) = Electricity1_rpt(t,r,"elec-demand-ave") * 1e+3 ;
pelasdtwh(r,t) = - 0.1 ;
...
surplus_fact(r,t)  = round(surplus_short(r,t) / surplus_long(r,t),4) ;
surplus_share(r,t) = (surplus_short(r,t) + surplus_fact(r,t) * surplus_long(r,t)) / sum(rr, surplus_short(rr,t) + surplus_fact(rr,t) * surplus_long(rr,t)) ;
demand_share(r,t)  = daref(r,t) / sum(rr, daref(rr,t)) ;
surplus_adj(r,t)   = round(demand_share(r,t) / surplus_share(r,t),4) ;
...
$if      set nogas       ivrt(coa(i),newv(v),r,t)                                                                                        = NO ;
...
$if     set frnuc2023       af(s,ivrt(i,oldv(v),r,t))$(t.val le 2023 and t.val ge 2023                and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0) = sum(sm(s,m), afnn(m,i,r,"2023")) ;
* Set French nuclear availability in 2023 as in 2022 as what-if-still-case
$if     set frnuc2024       af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023 and t.val le 2024 and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0) = sum(sm(s,m), afnn(m,i,r,"2023")) ;
* Set French nuclear availability in 2023 as in 2022 as what-if-still-case
$if     set frnuc2025       af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023 and t.val le 2025 and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0) = sum(sm(s,m), afnn(m,i,r,"2023")) ;
* Set French nuclear availability in 2023 as in 2022 as what-if-still-case
$if     set frnuc20XX       af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023                   and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0) = sum(sm(s,m), afnn(m,i,r,"2023")) ;
...
$if     set hydro2023       af(s,ivrt(i,oldv(v),r,t))$(t.val le 2023 and t.val ge 2023                and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), afnn(m,i,r,"2020") + afnn(m,i,r,"2021")) > 0) = round(sum(sm(s,m), afnn(m,i,r,"2023") / (afnn(m,i,r,"2020")/2 + afnn(m,i,r,"2021")/2)), 4) ;
* Assume that lower hydro availability prevails in 2023
$if     set hydro2024       af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023 and t.val le 2024 and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), afnn(m,i,r,"2020") + afnn(m,i,r,"2021")) > 0) = round(sum(sm(s,m), afnn(m,i,r,"2023") / (afnn(m,i,r,"2020")/2 + afnn(m,i,r,"2021")/2)), 4) ;
* Assume that lower hydro availability prevails in 2023
$if     set hydro2025       af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023 and t.val le 2025 and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), afnn(m,i,r,"2020") + afnn(m,i,r,"2021")) > 0) = round(sum(sm(s,m), afnn(m,i,r,"2023") / (afnn(m,i,r,"2020")/2 + afnn(m,i,r,"2021")/2)), 4) ;
* Assume that lower hydro availability prevails forever
$if     set hydro20XX       af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023                   and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), afnn(m,i,r,"2020") + afnn(m,i,r,"2021")) > 0) = round(sum(sm(s,m), afnn(m,i,r,"2023") / (afnn(m,i,r,"2020")/2 + afnn(m,i,r,"2021")/2)), 4) ;
...
af_mon2022_ger(m,i,r)$(sameas(i,"Nuclear") and sameas(r,"Germany")) = afnn(m,i,r,"2022") * 2 ;
af_mon2023_ext(m,i,r)$(sameas(i,"Nuclear") and sameas(r,"Germany")) = afnn(m,i,r,"2020")/2 + afnn(m,i,r,"2021")/2 ;
$if not set longrun af_mon2023_str("1","Nuclear","Germany") = afnn("1","Nuclear","Germany","2023") * 2 ;
$if not set longrun af_mon2023_str("2","Nuclear","Germany") = afnn("2","Nuclear","Germany","2023") * 2 ;
$if not set longrun af_mon2023_str("3","Nuclear","Germany") = afnn("3","Nuclear","Germany","2023") * 2 ;
$if not set longrun af_mon2023_str("4","Nuclear","Germany") = afnn("3","Nuclear","Germany","2023") * 2 / 2 ;
...
$if      set extension      $if not set longrun af(s,ivrt("Nuclear","1990","Germany",t))$(reliability("Nuclear","1990","Germany") > 0 and t.val ge 2024) = sum(sm(s,m), af_mon2023_ext(m,"Nuclear","Germany")) + eps ; 
$if      set strext         $if not set longrun af(s,ivrt("Nuclear","1990","Germany",t))$(reliability("Nuclear","1990","Germany") > 0 and t.val ge 2024) = sum(sm(s,m), af_mon2023_ext(m,"Nuclear","Germany")) + eps ;
...
WELFARE_short                   WELFARE (positive value) (million EUR)
WELFARE_long                    WELFARE (positive value) (million EUR)
SURPLUS                         Cost (positive) (million EUR)
;

equation
weldef                           Objection function -- definition of welfare
weldef_short                     Objection function -- definition of welfare
weldef_long                      Objection function -- definition of welfare
...
dischargelim_ccgt(s,j,v,r,t)     Discharge cannot exceed gas_ccgt capacity (when using high hydrogenbonus)
...
storagebalann_st2(j,v,r,t)       One complete storage cycle per day
...
$if not  set etc        $if      set mixed      sum(new(i),                    sum(inv,  share(inv,i,r) * IX(i,r,t)    * sum(tv(t,v)$ivrt(i,v,r,t),   (capcost(i,v,r) + deccost(i,v,r)) *  zeta(inv,i,v,r)))) +
...
$if      set lbs        $if      set mixed      sum(new(i)$(not kir_lea(i,r)), sum(inv,  share(inv,i,r) * IX(i,r,t)    * sum(tv(t,v)$ivrt(i,v,r,t),   (capcost(i,v,r) + deccost(i,v,r)) *  zeta(inv,i,v,r)))) +
...
$if not  set etc        $if     set normal    + sum(new(i),                    IX(i,r,t)    * sum(tv(t,v)$ivrt(i,v,r,t),    (capcost(i,v,r) + deccost(i,v,r))  *  endeffect(i,v,r,t)))
...
$if                             set annui     + sum(new(i),  sum((tt,v)$((tt.val le t.val) and tv(tt,v) and ivrt(i,v,r,tt)),             IX(i,r,tt)   *  (capcost(i,v,r) + deccost(i,v,r)) *  deprtime(i,v,r,tt) *  annuity(i,v)  * nyrs(t)))
...
$if                             set ccost     + sum(new(i), sum((tt,v)$((tt.val le t.val) and tv(tt,v) and ivrt(i,v,r,tt)),              IX(i,r,tt)   *  (capcost(i,v,r) + deccost(i,v,r))  *  deprtime(i,v,r,tt) * drate * nyrs(t)))
...
$if      set lbd        $if     set normal    + sum(new(i)$(not ir_lea(i,r)), IX(i,r,t)    * sum(tv(t,v)$ivrt(i,v,r,t),    (capcost(i,v,r) + deccost(i,v,r))  *  endeffect(i,v,r,t)))
...
*                       Cost (EUR/MWh) of lost load/backstop (GWh)
                        ...
                        + 1e-3 * sum(bse, vollelas(bse,r,t) * sum(s, BSELAS(bse,s,r,t) * hours(s)))
...
weldef..
        WELFARE =e= - weight_short * WELFARE_SHORT - weight_long * WELFARE_LONG + SURPLUS ;

weldef_short..
        WELFARE_short =e= sum(t$(tmyopic(t)), dfact(t) * sum(r, sum(s, hours(s) * sum(bse,  DS(bse,s,r,t)        * 1e+3 * cb_1(bse,s,r,t) + 0.5 * DS(bse,s,r,t)    * DS(bse,s,r,t)    * 1e+6  * cb_2(bse,s,r,t))))) * 1e-6 ;       
weldef_long..
        WELFARE_long  =e= sum(t$(tmyopic(t)), dfact(t) * sum(r, surplus_fact(r,t) * 8760 * (DTWH(r,t) / 8760     * 1e+6 * cb_1dtwh(r,t)   + 0.5 * DTWH(r,t) / 8760 * DTWH(r,t) / 8760 * 1e+12 * cb_2dtwh(r,t))))    * 1e-6 ;
...
$if      set lostload    + (BS(s,r,t) + sum(bse, BSELAS(bse,s,r,t))) *
...
$if not set elastic $if not set newdemand   =e=                     1e-3 * hours(s) * round(dref(r,t) * load(s,r) *
$if not set elastic $if not set newdemand   $if not set lossnewtemp (1 + loss(r)),4)
$if not set elastic $if not set newdemand   $if     set lossnewtemp (1 + losss(s,r,t)),4)

$if not set elastic $if     set newdemand   =g=                     1e-3 * hours(s) * round(load_st(s,r,t) *
$if not set elastic $if     set newdemand   $if not set lossnewtemp (1 + loss(r)),4)
$if not set elastic $if     set newdemand   $if     set lossnewtemp (1 + losss(s,r,t)),4)

$if     set elastic                         =e=                     1e-3 * hours(s) * sum(bse, DS(bse,s,r,t)) *
$if     set elastic                         $if not set lossnewtemp (1 + loss(r))
$if     set elastic                         $if     set lossnewtemp (1 + losss(s,r,t) 
;
...
$if not   set uselimits     2031 and tmyopic(t))..
...
*        Equals (annually scaled) demand including losses
$if not set elastic $if not set newdemand   =g=                     1e-3 * hours(s) * round(dref(r,t) * load(s,r) *
$if not set elastic $if not set newdemand   $if not set lossnewtemp (1 + loss(r)),4)
$if not set elastic $if not set newdemand   $if     set lossnewtemp (1 + losss(s,r,t)),4)
...
$if     set elastic                         =g=                     1e-3 * hours(s) * sum(bse, DS(bse,s,r,t)) *
$if     set elastic                         $if not set lossnewtemp (1 + loss(r))
$if     set elastic                         $if     set lossnewtemp (1 + losss(s,r,t)  
;
...
* Discharge must not exceed charge capacity (size of door - exit)
dischargelim_ccgt(s,jvrt(j,v,r,t))$(tmyopic(t) and sameas(j,"Storage_LT"))..
         GD(s,j,v,r,t) =l= XCS(s,"Gas_CCGT",v,r,t) ;
...
storagebalann_st(jvrt(j,v,r,t))$(sameas(j,"Storage_ST") and tmyopic(t))..
         sum(s, hours(s) * (G(s,j,v,r,t) * chrgpen(j,v,r) - GD(s,j,v,r,t))) * 1e-3  =g= 0 ;
storagebalann_st2(jvrt(j,v,r,t))$(sameas(j,"Storage_ST") and tmyopic(t))..
        (sum(s, hours(s) * GD(s,j,v,r,t)) - ghours(j,v,r) * GC(j,v,r,t) * 365) * 1e-3  =g= 0 ;
...
biomarket(t)$(sum(dbclass, dblim(dbclass,t)) and tmyopic(t))..
               sum(dbclass, DBS(dbclass,t))     =e= sum(r, sum(ivrt(i,v,r,t)$(sameas(i,"Bioenergy") or sameas(i,"Bio_CCS") or sameas(i,"Bio_CHP")), round(1 / effrate(i,v,r),4) * XTWH(i,v,r,t)) * 1e+6 ) ;
* for each region (does not allow for system-wide trade)
biomarket_r(r,t)$(sum(dbclass, dblim_r(dbclass,r,t)) and tmyopic(t))..
               sum(dbclass, DBSR(dbclass,r,t))  =e=        sum(ivrt(i,v,r,t)$(sameas(i,"Bioenergy") or sameas(i,"Bio_CCS") or sameas(i,"Bio_CHP")), round(1 / effrate(i,v,r),4) * XTWH(i,v,r,t)) * 1e+6 ;
...
* * * Bioenergy potential
* for whole system (allows for trade and the marginal is then the "price")
bioflow(t)$(biolim_eu(t) and (biolim_eu(t) < inf) and tmyopic(t))..         BC(t)           =e= sum(r, sum(ivrt(i,v,r,t)$(sameas(i,"Bioenergy") or sameas(i,"Bio_CCS") or sameas(i,"Bio_CHP")), round(1 / effrate(i,v,r), 8) * XTWH(i,v,r,t))) ;
cumbio(t)$(biolim_eu(t) and tmyopic(t))..                                   BC(t)           =l= biolim_eu(t) ;
* for each region (does not allow for system-wide trade)
bioflow_r(r,t)$(biolim(r,t) and (biolim(r,t) < inf) and tmyopic(t))..       BC_r(r,t)       =e=        sum(ivrt(i,v,r,t)$(sameas(i,"Bioenergy") or sameas(i,"Bio_CCS") or sameas(i,"Bio_CHP")), round(1 / effrate(i,v,r), 8) * XTWH(i,v,r,t)) ;
...
dtwhdef(r,t)$tmyopic(t)..                           DTWH(r,t)       =e= 1e-3 * sum(s, hours(s) * sum(bse, DS(bse,s,r,t) - BSELAS(bse,s,r,t))) ;
...
gen_nucl(r,"2022") = gen_nucl(r,"2022") ;
gen_hydr(r,"2022") = gen_hydr(r,"2022") ;
gen_biom(r,"2022") = gen_biom(r,"2022") ;

$if     set frnucnormal gen_nucl(r,"2022")$(    sameas(r,"France"))  = gen_nucl(r,"2020")/2 + gen_nucl(r,"2021")/2 ;
$if     set hydronormal gen_hydr(r,"2022")                           = gen_hydr(r,"2020")/2 + gen_hydr(r,"2021")/2 ;

$if     set streckbetrieb   gen_nucl(r,t)$(t.val le 2023 and t.val ge 2023 and                sameas(r,"Germany")) = 6.74 ;
$if     set extension       gen_nucl(r,t)$(t.val ge 2023 and t.val le 2029 and sameas(r,"Germany")) = gen_nucl(r,"2022") ;
$if     set strext          gen_nucl(r,t)$(t.val le 2023 and t.val ge 2023 and                sameas(r,"Germany")) = 6.74 + round(gen_nucl(r,"2022") / 3, 4) ;  
$if     set strext          gen_nucl(r,t)$(t.val ge 2024 and t.val le 2030 and sameas(r,"Germany")) = gen_nucl(r,"2022") ; 

parameter
gen_af_biom(r,t) biomass generation from availability (subject to segment error) (TWh)
gen_co_biom(r,t) correction factor
af_iint(s,i,v,r,t) interim availability
;

gen_af_biom(r,t) = sum(ivrt(bio(i),oldv(v),r,t), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)))) * 1e-3 ;
gen_co_biom(r,t)$(gen_af_biom(r,t) > 0) = gen_biom(r,t) / gen_af_biom(r,t) ;
af_iint(s,ivrt(bio(i),oldv(v),r,t)) = af(s,i,v,r,t) ;
$if set calibration2022mon  af(s,ivrt(bio(i),oldv(v),r,t)) = af_iint(s,i,v,r,t) * gen_co_biom(r,"2022") ;

parameter
gen_af_nucl(r,t) nuclear generation from availability (subject to segment error) (TWh)
gen_co_nucl(r,t) correction factor
;

gen_af_nucl(r,t) = sum(ivrt(nuc(i),oldv(v),r,t), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)))) * 1e-3 ;
gen_co_nucl(r,t)$(gen_af_nucl(r,t) > 0) = gen_nucl(r,t) / gen_af_nucl(r,t) ;
af_iint(s,ivrt(nuc(i),oldv(v),r,t)) = af(s,i,v,r,t) ;
$if set calibration2022mon  af(s,ivrt(nuc(i),oldv(v),r,t)) = af_iint(s,i,v,r,t) * gen_co_nucl(r,"2022") ;

$if set streckbetrieb   af(s,nuc(i),oldv(v),r,t)$(sameas(r,"Germany") and t.val le 2023 and t.val ge 2023)                 = af_iint(s,i,v,r,t) * gen_co_nucl(r,t) ;
$if set extension       af(s,nuc(i),oldv(v),r,t)$(sameas(r,"Germany") and t.val ge 2023 and t.val le 2029)  = af_iint(s,i,v,r,t) * gen_co_nucl(r,t) ;
$if set strext          af(s,nuc(i),oldv(v),r,t)$(sameas(r,"Germany") and t.val ge 2023 and t.val le 2030)  = af_iint(s,i,v,r,t) * gen_co_nucl(r,t) ;

$if set frnuc2023 af(s,nuc(i),oldv(v),r,t)$(sameas(r,"France") and t.val le 2023 and t.val ge 2023)                = af_iint(s,i,v,r,t) ;
$if set frnuc2024 af(s,nuc(i),oldv(v),r,t)$(sameas(r,"France") and t.val ge 2023 and t.val le 2024) = af_iint(s,i,v,r,t) ;
$if set frnuc2025 af(s,nuc(i),oldv(v),r,t)$(sameas(r,"France") and t.val ge 2023 and t.val le 2025) = af_iint(s,i,v,r,t) ;
$if set frnuc20XX af(s,nuc(i),oldv(v),r,t)$(sameas(r,"France") and t.val ge 2023)                   = af_iint(s,i,v,r,t) ;

$if set hydro2023 af(s,i,oldv(v),r,t)$(sameas(i,"Hydro") and t.val le 2023 and t.val ge 2023)                = af_iint(s,i,v,r,t) ;
$if set hydro2024 af(s,i,oldv(v),r,t)$(sameas(i,"Hydro") and t.val ge 2023 and t.val le 2024) = af_iint(s,i,v,r,t) ;
$if set hydro2025 af(s,i,oldv(v),r,t)$(sameas(i,"Hydro") and t.val ge 2023 and t.val le 2025) = af_iint(s,i,v,r,t) ;
$if set hydro20XX af(s,i,oldv(v),r,t)$(sameas(i,"Hydro") and t.val ge 2023)                   = af_iint(s,i,v,r,t) ;

parameter
gen_af_hydr(r,t) nuclear generation from availability (subject to segment error) (TWh)
gen_co_hydr(r,t) correction factor
;

gen_af_hydr(r,t) = sum(ivrt(i,oldv(v),r,t)$(sameas(i,"Hydro")), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * vrsc(s,i,v,r) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)))) * 1e-3 ;
gen_co_hydr(r,t)$(gen_af_hydr(r,t) > 0) = gen_hydr(r,t) / gen_af_hydr(r,t) ;
af_iint(s,ivrt(i,oldv(v),r,t))$(sameas(i,"Hydro")) = af(s,i,v,r,t) ;
$if set calibration2022mon  af(s,ivrt(i,oldv(v),r,t))$(sameas(i,"Hydro")) = af_iint(s,i,v,r,t) * gen_co_hydr(r,"2022") ;
...
gen_af_lign(r,t) = sum(ivrt(i,oldv(v),r,t)$(sameas(i,"Lignite") or sameas(i,"Lig_CHP")), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * reliability(i,v,r))) * 1e-3 ;
gen_af_coal(r,t) = sum(ivrt(i,oldv(v),r,t)$(sameas(i,"Coal") or sameas(i,"Coa_CHP")), sum(s, hours(s) * lifetime(i,v,r,t) * cap(i,v,r) * reliability(i,v,r))) * 1e-3 ;
...
genGER_nucl(r,t)$(tmyopic(t) and t.val le 2023 and t.val ge 2023 and sameas(r,"Germany"))..
    sum(ivrt(nuc(i),oldv(v),r,t), XTWH(i,v,r,t)) =l= 0 
$if set streckbetrieb                                   + 6.74             
$if set strext                                          + 6.74 + round(gen_nucl(r,"2022") / 3, 4) 
    ;

genUP_nucl(r,t)$(tmyopic(t))..
    sum(ivrt(nuc(i),oldv(v),r,t), XTWH(i,v,r,t)) =l= gen_nucl(r,t) ;

genUP_ngas(r,t)$(tmyopic(t))..
...
zeta(inv,"Coal","2010",rcoaladded(r))       = zeta(inv,"Coal","2010","Germany") ;
...
genUP_coal(r,t)$(tmyopic(t) and rcoal(r))..
...
genLO_coal(r,t)$(tmyopic(t) and rcoal(r) and sameas(t,"2022"))..
    sum(ivrt("Coal",oldv(v),r,t), XTWH("Coal",v,r,t)) + sum(ivrt("Coa_CHP",oldv(v),r,t), XTWH("Coa_CHP",v,r,t)) +
...
genLO_lign(r,t)$(tmyopic(t) and rlignite(r) and sameas(t,"2022"))..
    sum(ivrt("Lig_CHP",oldv(v),r,t), XTWH("Lig_CHP",v,r,t)/effrate("Lig_CHP",v,r)) + sum(ivrt("Lignite",oldv(v),r,t), XTWH("Lignite",v,r,t)/effrate("Lignite",v,r)) =g= lign_min(r,t) * 0.95 ;
...
co2marketeu(t)$(tmyopic(t))..                                         ECEU(t) * (1 + co2elecind(t)) + co2indorgfix_in(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t)
...
it_euets(t)$(tmyopic(t))..                                            ECEU(t) * (1 + co2elecind(t)) + co2indorgfix_in(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t)
                                                                                                        =e= co2add_in(t) + co2allocated_in(t) + (co2auctioned_in(t) - msrin_in(t)) + TNACUSE(t)
$if     set hedgeeua                                                                                        - co2out_in(t)
                                                                           ;
...
eqs_msrin2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..       MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) * 200.16 ;
eqs_msrin_old(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..       MSRIN(t)                    =e= UPP(t-1) * 0.12 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) * 100.08 ;
eqs_msrin_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..       MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) ;

eqs_msrout2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 200 + LOWMID(t-1) * 200 * (400 - TNAC(t-1)) ;
eqs_msrout_old(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 100 + LOWMID(t-1) * 100 * (400 - TNAC(t-1)) ;
eqs_msrout_new(t)$((t.val ge 2024 and t.val le 2045) and tmyopic(t))..      MSROUT_INT(t)               =e= LOW(t-1) * 200 + LOWMID(t-1) * 200 * (400 - TNAC(t-1)) ;
eqs_msrout_max(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      MSROUT_MAX(t)               =e= (LOW(t-1) + LOWMID(t-1)) * MSR(t-1) / nyrs(t) ;
eqs_msrout_bin(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      MSRFULL(t) + MSREMPTY(t)    =e= 1 ;
eqs_msrout_fin(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..      MSROUT(t)                   =e= MSRFULL(t-1) * MSROUT_INT(t) + MSREMPTY(t-1) * MSROUT_MAX(t) ;
eqs_msroutup(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1)                    =g=                                           MSRFULL(t-1) * MSROUT_INT(t) * nyrs(t)  ;             
eqs_msroutlo(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..        MSR(t-1)                    =l= MSREMPTY(t-1) * MSROUT_INT(t) * nyrs(t) + MSRFULL(t-1) * 5000 ;
...
eqs_tnac_bin(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..        LOW(t) + LOWMID(t) + UPP(t) + UPPMID(t) + MID(t) =e= 1 ;
eqs_tnacup_old(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..      TNAC(t)                     =g=                LOWMID(t) * 399 + MID(t) * 400 + UPPMID(t) *  833 + UPP(t) *  834 ;
eqs_tnaclo_old(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..      TNAC(t)                     =l= LOW(t) * 399 + LOWMID(t) * 400 + MID(t) * 833 + UPPMID(t) *  834 + UPP(t) * 2000 ;
eqs_tnacup_new(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..      TNAC(t)                     =g=                LOWMID(t) * 399 + MID(t) * 400 + UPPMID(t) *  833 + UPP(t) * 1096.0526 ;
eqs_tnaclo_new(t)$((t.val ge 2022 and t.val le 2040) and tmyopic(t))..      TNAC(t)                     =l= LOW(t) * 399 + LOWMID(t) * 400 + MID(t) * 833 + UPPMID(t) * 1096.0526 + UPP(t) * 2000 ;

eqs_cancel2023(t)$((t.val ge 2023 and t.val le 2023) and tmyopic(t))..      CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) ;
eqs_cancel_old(t)$((t.val ge 2024 and t.val le 2040) and tmyopic(t))..      CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) ;
eqs_cancel_new(t)$((t.val ge 2024 and t.val le 2040) and tmyopic(t))..      CANCEL_INT(t)               =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - 400 ;
eqs_cancel2045(t)$(sameas(t,"2045") and tmyopic(t))..                       CANCEL(t)                   =e= MSR(t-1) + MSRIN(t) - MSROUT(t) - 0 ;

eqs_cancel_fin(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..      CANCEL(t)                   =e= CANCEL_INT(t) * CANCELYES(t) ;
eqs_cancel_bin(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..      CANCELNO(t) + CANCELYES(t)  =e= 1 ;
eqs_cancelup_old(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =g=                                                                   CANCELYES(t) * (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) ;             
eqs_cancello_old(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =l= CANCELNO(t) * (co2auctioned_in(t-1) - MSRIN(t-1) + MSROUT(t-1)) + CANCELYES(t) * 5000 ;
eqs_cancelup_new(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =g=                     CANCELYES(t) * 400 ;             
eqs_cancello_new(t)$((t.val ge 2023 and t.val le 2040) and tmyopic(t))..    MSR(t-1) + MSRIN(t) - MSROUT(t) =l= CANCELNO(t) * 400 + CANCELYES(t) * 5000 ;
...
$if      set co2mips  CANCELNO.L(t)$(t.val ge 2024  and t.val le 2045 and msr_in(t-1) + msrin_in(t) < co2auctioned_in(t-1) - msrin_in(t-1)) = 1 ;
$if      set co2mips  CANCELNO.L(t)$(t.val ge 2024  and t.val le 2045 and msr_in(t-1) + msrin_in(t) > co2auctioned_in(t-1) - msrin_in(t-1)) = 0 ;
$if      set co2mips  CANCELYES.L(t)$(t.val ge 2024 and t.val le 2045 and msr_in(t-1) + msrin_in(t) < co2auctioned_in(t-1) - msrin_in(t-1)) = 0 ;
$if      set co2mips  CANCELYES.L(t)$(t.val ge 2024 and t.val le 2045 and msr_in(t-1) + msrin_in(t) > co2auctioned_in(t-1) - msrin_in(t-1)) = 1 ;

$if      set co2mips  CANCELNO.L(t)$(t.val ge 2023  and t.val le 2045 and msr_in(t-1) + msrin_in(t) < co2auctioned_in(t-1) - msrin_in(t-1)) = 1 ;
$if      set co2mips  CANCELNO.L(t)$(t.val ge 2023  and t.val le 2045 and msr_in(t-1) + msrin_in(t) > co2auctioned_in(t-1) - msrin_in(t-1)) = 0 ;
$if      set co2mips  CANCELYES.L(t)$(t.val ge 2023 and t.val le 2045 and msr_in(t-1) + msrin_in(t) < co2auctioned_in(t-1) - msrin_in(t-1)) = 0 ;
$if      set co2mips  CANCELYES.L(t)$(t.val ge 2023 and t.val le 2045 and msr_in(t-1) + msrin_in(t) > co2auctioned_in(t-1) - msrin_in(t-1)) = 1 ;
...
$if set uselimits       $if not set banking     $gdxin limits\%l%_bauprice_%a%.gdx
...
$if not set nopipeline      IX.FX(nuc(i),r,t)$(t.val le 2030 and not invlimLO(i,r,t) > 0) = 0 ;
$if not set nopipeline      IX.UP(nuc(i),r,t)$(t.val le 2030 and     invlimLO(i,r,t) > 0) = invlimLO(i,r,t) ;
...
$if not  set lostload    BSELAS.FX(bse,s,r,t) = 0 ;
$if      set lostloadnew BS.FX(s,r,t) = 0 ;
$if      set lostloadnew BSELAS.UP(bse,s,r,t) = bse_share(bse,r,t) * load(s,r) * dref(r,t) ;
$if      set elastic     BSELAS.FX(bse,s,r,t) = 0 ;
...
$if      set storage  $if       set hydrogenccgt dischargelim_ccgt
...
$if      set storage  $if       set storspec                                storagebalann_st2
...
$if      set co2price                            co2floweu
$if      set co2price                            co2flowuk
...
$if      set calibration2022coallo               genLO_coal
*$if      set calibration2022coallo               genLO_lign
