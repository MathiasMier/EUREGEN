...
invsum_j(j,r,t) = sum(inv, gshare(inv,j,r) * IG.L(j,r,t)    * sum(tv(t,v)$jvrt(j,v,r,t), gcapcost(j,v,r)  * gzeta(inv,j,v,r))) / dfact(t) ;
...
execute_unload   'database\data\tech_weights.gdx',             invsum_i, invsum_j, invsum_k, tech_weights_i, tech_weights_j, tech_weights_k,
                                                               invsum_i_total, invsum_j_total, invsum_k_total, tech_weights_i_total, tech_weights_j_total, tech_weights_k_total;
