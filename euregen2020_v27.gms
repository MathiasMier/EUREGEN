...
convtarget(i,r,t)$(sameas(i,"Nuclear") and sameas(r,"France") and tmyopic(t))..
    sum(v, XTWH(i,v,r,t)) =g= 0.75 * daref(r,t) * (1 + loss(r)) ;
...
$if set constantcaptargets        and cap_constant(r,i,t)
$if set extracaptargets           and cap_extra(r,i,t) 
    )..
