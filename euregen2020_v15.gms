...
af_mon2022_ger(m,i,r)$(m.val le 10 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon2022(m,i,r) * 2 ;
af_mon2022_ger(m,i,r)$(m.val ge 11 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;

af_mon2023_ext(m,i,r)$(m.val le 10 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;
af_mon2023_ext(m,i,r)$(m.val ge 11 and sameas(i,"Nuclear") and sameas(r,"Germany")) = af_mon(m,i,r)/2 + af_mon2021(m,i,r)/2 ;
...
storagebalann(jvrt(j,v,r,t))$(tmyopic(t))..
         sum(s, hours(s) * G(s,j,v,r,t) * chrgpen(j,v,r)) * 1e-3 =e= sum(s, hours(s) * GD(s,j,v,r,t)) * 1e-3 ;
* Pumpstorage
...
storagebalann_ps(jvrt(j,v,r,t))$(sameas(j,"PumpStorage") and tmyopic(t))..
         sum(s, hours(s) * G(s,j,v,r,t) * chrgpen(j,v,r) - GD(s,j,v,r,t)) =e= 0 ;
* Power-to-gas
...
$if set banking ECEU.UP(t)$(t.val le 2045) = co2ele_org(t) + 25 ;
$if set banking ECEU.LO(t)$(t.val le 2045) = co2ele_org(t) - 25 ;
...
$if set co2iter ECEU.UP(t)$(t.val le 2045) = co2ele_org(t) + 25 ;
$if set co2iter ECEU.LO(t)$(t.val le 2045) = co2ele_org(t) - 25 ;
...
eqs_euets(t)$(tmyopic(t))..                                                 ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t)
                                                                                                        =l= co2add_in(t) + co2allocated_in(t) + co2auctioned_in(t) - MSRIN(t) + MSROUT(t) + TNACUSE(t) ;
...
eqs_cancel(t)$((t.val ge 2023 and t.val le 2030) and tmyopic(t))..          CANCEL(t)                   =e= MSR(t-1) + MSRIN(t-1) - MSROUT(t-1) + MSRIN(t) - MSROUT(t) - co2auctioned_in(t-1) ;
...
*$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEU.UP(t)$(t.val ge 2023 and t.val le 2030) = co2ele_in(t) + 50 ;
*$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEU.LO(t)$(t.val ge 2023 and t.val le 2030) = co2ele_in(t) - 50 ;
