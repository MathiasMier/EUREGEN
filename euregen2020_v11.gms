...
co2captured(i,v,r)          = co2captured_int(i,v,r) ;
...
it_co2flowuk(t)$tmyopic(t)..                              ECUK(t)                               =e= sum(r$(sameas(r,"Britain")),     sum(ivrt(i,v,r,t), emit(i,v,r) * XTWH(i,v,r,t))) ;

it_ukets(t)$(tmyopic(t))..                                ECUK(t)                               =l= co2eleuk_in(t) ;
...
EQUATION
eqmips_co2floweu(tmips)
eqmips_euets(tmips)
eqmips_euets_indformula(tmips)
eqmips_msrin2023(tmips)
eqmips_msrin(tmips)
eqmips_msrout2023(tmips)
eqmips_msrout(tmips)
eqmips_tnac(tmips)
eqmips_msr(tmips)
eqmips_cancel(tmips)
...
eqmips_co2floweu(tmips)$..                                          ECEUMIPS(tmips)    =e= sum(maptmips(tmips,t), ECEU(tmips-1) + (tmips - t.val) / nyrs(t) * (ECEU(tmips-1) - ECEU(t))) ; 
eqmips_euets(tmips)..                                               ECEUMIPS(tmips) + co2indmips_in(tmips) + co2canmips_in(tmips) 
                                                                                                =e= co2addmips_in(tmips) + co2allocatedmips_in(tmips) + co2auctionedmips_in(tmips) - MSRINMIPS(tmips) + MSROUTMIPS(tmips) + TNACUSEMIPS(tmips) ;                                                                                                        
eqmips_euets_indformula(tmips)..                                    ECEUMIPS(tmips) * (1 - co2indfixmips_in(tmips)) * co2indsharemips_in(tmips) + co2indfixmips_in(tmips) * co2indmips_in(tmips) + co2canmips_in(tmips) 
                                                                                                =e= co2addmips_in(tmips) + co2allocatedmips_in(tmips) + co2auctionedmips_in(tmips) - MSRINMIPS(tmips) + MSROUTMIPS(tmips) + TNACUSEMIPS(tmips) ;

eqmips_msrin2023(tmips)$(tmips.val le 2023)..                       MSRINMIPS(tmips)   =e= UPPMIPS(tmips-1) * 0.24 * TNACMIPS(tmips-1) ;
eqmips_msrin(tmips)$((tmips.val ge 2024 and tmips.val le 2040)..    MSRINMIPS(tmips)   =e= UPPMIPS(tmips-1) * 0.12 * TNACMIPS(tmips-1) ;
eqmips_msrout2023(tmips)$(tmips.val le 2023 )..                     MSROUTMIPS(tmips)  =e= LOWMIPS(tmips-1) * 200 ;
eqmips_msrout(tmips)$(tmips.val ge 2024 and tmips.val le 2045)..    MSROUTMIPS(tmips)  =e= LOWMIPS(tmips-1) * 100 ;
eqmips_tnac(tmips)$(tmips.val ge 2022 and tmips.val le 2045)..      TNACMIPS(tmips)    =e= tnacstartmips_in - sum(ttmips$(ttmips.val le tmips.val and ttmips.val ge 2022),  TNACUSEMIPS(ttmips)) ;
eqmips_msr(tmips)$(tmips.val ge 2022 and tmips.val le 2045)..       MSRMIPS(tmips)     =e= msrstartmips_in  + sum(ttmips$(ttmips.val le tmips.val and ttmips.val ge 2022), (MSRINMIPS(ttmips) - MSROUTMIPS(ttmips) - CANCELMIPS(ttmips))) ;
eqmips_cancel(tmips)$(tmips.val ge 2023 and tmips.val le 2040)..    CANCELMIPS(tmips)  =e= MSRMIPS(tmips-1) + MSRINMIPS(tmips-1) - MSROUTMIPS(tmips-1) + MSRINMIPS(tmips) - MSROUTMIPS(tmips) - co2auctionedmips_in(tmips-1) ;
eqmips_tnacup(tmips)$(tmips.val ge 2022 and tmips.val le 2040)..    TNACMIPS(tmips)    =g=                        MIDMIPS(tmips) * 400 + UPPMIPS(tmips) *  833 ;
eqmips_tnaclo(tmips)$(tmips.val ge 2022 and tmips.val le 2040)..    TNACMIPS(tmips)    =l= LOWMIPS(tmips) * 400 + MIDMIPS(tmips) * 833 + UPPMIPS(tmips) * 2000 ;
eqmips_binary(tmips)$(tmips.val ge 2022 and tmips.val le 2040)..    LOWMIPS(tmips) + UPPMIPS(tmips) + MIDMIPS(tmips)    =e= 1 ;

*$ontext
$if      set co2mips  $if      set shortrun   TNACUSEMIPS.L(tmips)                = tnacusemips_in(tmips) ;
$if      set co2mips  $if      set shortrun   TNACMIPS.L(tmips)                   = tnacmips_in(tmips) ;
*$if      set co2mips  $if      set shortrun   CANCELMIPS.L(tmips)                   = cancelmips_in(tmips) ;
$if      set co2mips  $if      set shortrun   MSRINMIPS.L(tmips)$(msrmips_in(tmips) >= 0) =   msrinmips_in(tmips) ;
$if      set co2mips  $if      set shortrun   MSRINMIPS.L(tmips)$(msrmips_in(tmips) < 0) =   0 ;
$if      set co2mips  $if      set shortrun   MSROUTMIPS.L(tmips)$(msrmips_in(tmips) < 0) = - msrinmips_in(tmips) ;
$if      set co2mips  $if      set shortrun   MSROUTMIPS.L(tmips)$(msrmips_in(tmips) >= 0) = 0 ;
$if      set co2mips  $if      set shortrun   MSRMIPS.L(tmips)                    = msrmips_in(tmips) ;
$if      set co2mips  $if      set shortrun   LOWMIPS.L(tmips)$(tnacmips_in(tmips) <  400)  = 1 ;
$if      set co2mips  $if      set shortrun   LOWMIPS.L(tmips)$(tnacmips_in(tmips) >= 400)  = 0 ;
$if      set co2mips  $if      set shortrun   MIDMIPS.L(tmips)$(tnacmips_in(tmips) <= 833 and tnacmips_in(tmips) >= 400) = 1 ;
$if      set co2mips  $if      set shortrun   MIDMIPS.L(tmips)$(tnacmips_in(tmips) <  400 or  tnacmips_in(tmips) >  833) = 0 ;
$if      set co2mips  $if      set shortrun   UPPMIPS.L(tmips)$(tnacmips_in(tmips) >  833) = 1 ;
$if      set co2mips  $if      set shortrun   UPPMIPS.L(tmips)$(tnacmips_in(tmips) <= 833) = 0 ;
*$offtext


*$if      set co2mips  $if      set shortrun   MSRMIPS.FX("2022") = msrmips_in("2022") ;
$if      set co2mips  $if      set shortrun   MSRMIPS.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   MSRMIPS.FX("2050") = 0 ;
*$if      set co2mips  $if      set shortrun   MSRINMIPS.FX("2022") = msrinmips_in("2022") ;
$if      set co2mips  $if      set shortrun   MSRINMIPS.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   MSRINMIPS.FX("2050") = 0 ;
*$if      set co2mips  $if      set shortrun   MSROUTMIPS.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   MSROUTMIPS.FX("2050") = 0 ;
*$if      set co2mips  $if      set shortrun   LOWMIPS.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   LOWMIPS.FX("2045") = 1 ;
$if      set co2mips  $if      set shortrun   LOWMIPS.FX("2050") = 1 ;
*$if      set co2mips  $if      set shortrun   MIDMIPS.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   MIDMIPS.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   MIDMIPS.FX("2050") = 0 ;
*$if      set co2mips  $if      set shortrun   UPPMIPS.FX("2022") = 1 ;
$if      set co2mips  $if      set shortrun   UPPMIPS.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   UPPMIPS.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   CANCELMIPS.FX("2022") = 0 ;
$if      set co2mips  $if      set shortrun   CANCELMIPS.FX("2045") = 0 ;
$if      set co2mips  $if      set shortrun   CANCELMIPS.FX("2050") = 0 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEUMIPS.UP(tmips)$(tMIPS.val le 2022) = co2elemips_in(tmips) + 50 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEUMIPS.LO(tmips)$(tMIPS.val le 2022) = co2elemips_in(tmips) - 50 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEUMIPS.UP(tmips)$(tMIPS.val ge 2023) = co2elemips_in(tmips) + 150 ;
$if      set co2mips  $if      set shortrun   $if     set bauprice    ECEUMIPS.LO(tmips)$(tMIPS.val ge 2023) = co2elemips_in(tmips) - 150 ;
...
$if      set cap180     $if     set high        $gdxin limits\limits_%l%_high.gdx
$if      set cap180     $if     set recovery    $gdxin limits\limits_%l%_recovery.gdx
$if      set cap180                             $load ix_fx=ixfx, xc_fx=xcfx
$if      set cap180                             $gdxin

*$if      set capcoa180                          IX.FX("Coal",r,t)$(t.val ge 2031)       = ix_fx("Coal",r,t) ;
*$if      set capcoa180                          XC.FX("Coal",v,r,t)$(t.val = 2023)      = xc_fx("Coal",v,r,t) ;
$if      set capcoa180                          X.FX(s,"Coal",v,r,t)$(t.val le 2023)     = x_fx(s,"Coal",v,r,t) ;

*$if      set cap180                             IX.FX(gas(i),r,t)$(t.val ge 2031)       = ix_fx(i,r,t) ;
*$if      set cap180                             XC.FX(gas(i),v,r,t)$(t.val = 2023)      = xc_fx(i,v,r,t) ;
$if      set cap180                             X.FX(s,gas(i),v,r,t)$(t.val le 2023)     = x_fx(s,i,v,r,t) ;

*$if      set cap180                             IX.FX(bio(i),r,t)$(t.val ge 2031)       = ix_fx(i,r,t) ;
*$if      set cap180                             XC.FX(bio(i),v,r,t)$(t.val = 2023)      = xc_fx(i,v,r,t) ;
$if      set cap180                             X.FX(s,bio(i),v,r,t)$(t.val le 2023)     = x_fx(s,i,v,r,t) ;

*$if      set cap180                             IX.FX("OilOther",r,t)$(t.val ge 2031)   = ix_fx(i,r,t) ;
*$if      set cap180                             XC.FX("OilOther",v,r,t)$(t.val = 2023)  = xc_fx(i,v,r,t) ;
$if      set cap180                             X.FX(s,"OilOther",v,r,t)$(t.val le 2023) = x_fx(s,"OilOther",v,r,t) ;

*$if      set cap180                             IX.FX(chp(i),r,t)$(t.val ge 2031)       = ix_fx(i,r,t) ;
*$if      set cap180                             XC.FX(chp(i),v,r,t)$(t.val = 2023)      = xc_fx(i,v,r,t) ;
$if      set cap180                             X.FX(s,chp(i),v,r,t)$(t.val le 2023)     = x_fx(s,i,v,r,t) ;

$if      set cap180                             voll(r,"2023")$(not sameas(r,"Switzerland") or sameas(r,"Norway") or sameas(r,"Britain"))                       = 180 ;

*$if      set cap180                             discost(ivrt(gas(i),v,r,"2023"))$(not sameas(r,"Switzerland") or sameas(r,"Norway") or sameas(r,"Britain"))     = 179 ;
*$if      set capcoa180                          discost(ivrt("Coal",v,r,"2023"))$(not sameas(r,"Switzerland") or sameas(r,"Norway") or sameas(r,"Britain"))     = 179 ;
*$if      set cap180                             discost(ivrt(bio(i),v,r,"2023"))$(not sameas(r,"Switzerland") or sameas(r,"Norway") or sameas(r,"Britain"))     = 179 ;
*$if      set cap180                             discost(ivrt("OilOther",v,r,"2023"))$(not sameas(r,"Switzerland") or sameas(r,"Norway") or sameas(r,"Britain")) = 179 ;
*$if      set cap180                             discost(ivrt(chp(i),v,r,"2023"))$(not sameas(r,"Switzerland") or sameas(r,"Norway") or sameas(r,"Britain"))     = 179 ;
...
$ontext
IX.FX("RoofPV_q90",r,t)$(not sameas(r,"Spain")) = 0 ;
IX.FX("RoofPV_q70",r,t)$(not sameas(r,"Spain")) = 0 ;
IX.FX("RoofPV_q50",r,t) = 0 ;
IX.FX("RoofPV_q30",r,t) = 0 ;
IX.FX("RoofPV_q10",r,t) = 0 ;
...
$if      set co2iter   $if      set shortrun     it_co2flowuk
$if      set co2iter   $if      set shortrun     it_ukets
...
$if      set co2mips   $if      set shortrun     it_co2flowuk
$if      set co2mips   $if      set shortrun     it_ukets
* Policy
