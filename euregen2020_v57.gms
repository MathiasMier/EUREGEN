...
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023    and sameas(i,"Nuclear")  )      = round(sum(sm(s,m), (afnn(m,i,r,"2020") + afnn(m,i,r,"2021"))/2), 4) ;
af(s,ivrt(i,oldv(v),r,t))$(t.val ge 2023    and sameas(i,"Bioenergy"))      = round(sum(sm(s,m), (afnn(m,i,r,"2020") + afnn(m,i,r,"2021"))/2), 4) ;
...
capacity_bio(s,ivrt(i,oldv(v),r,t))$(sameas(i,"Bio_CHP") and t.val le 2030 and tmyopic(t))..
                 X(s,i,v,r,t) =l=  XCS(s,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r))* (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) ;
