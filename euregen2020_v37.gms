...
$if      set lbsbenchmark   capcost(i,v,r)$(ki_lea(i)) = kcapcost(i,v,r) ;
...
$if set spillover                  + sum(rr, kSTART(i,rr) * kspillover(i,r,rr))                 
                 ;
...
capex_mixedip_k(i,r,t)$(t.val ge 2023 and tmyopic(t) and kir_lea(i,r))..
                 KCAPEX_MIP(i,r,t)        =e=  sum(kls, IXLS(i,r,t,kls) * kslope_mip(i,r,kls)) * 1e-6 ;
...
capexeur_mixedip_k(i,t)$(t.val ge 2023 and tmyopic(t) and ki_lea(i))..
                 KCAPEXEUR_MIP(i,t)        =e=  sum(kls, IXEURLS(i,t,kls) * kslopeeur_mip(i,kls)) * 1e-6 ;
* Additional constraints in order to linearise IX*RHO, which is replaced by a new helper variable IXLS above
* RHO of t-1 to realise the time lag of one period until the cost degressions materialise
...
$if      set lbseur                                                 1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$(ki_lea(i)), sum(tv(t,v)$ivt(i,v,t), KCAPEXEUR_MIP(i,t) * 1e+6 * kendeffecteur(i,t))) +
...
$if      set lbs                                                  + sum(new(i)$(kir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t), KCAPEX_MIP(i,r,t) * 1e+6 * kendeffect(i,r,t) )) 
               )
...
$if set loadnew daref(r,t) = daref_new(r,t) ;
$if set loadnew dref(r,t)  = dref_new(r,t) ;
$if set loadnew load(s,r) = load_new(s,r) ;
...
genUP_nucl(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((nuc(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_nucl(r,t) ;

genUP_ngas(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((gas(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_ngas(r,t) ;
    
genUP_sola(r,t)$(tymopic(t))..
    sum((sol(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_sola(r,t) ;
    
genUP_wind(r,t)$(tymopic(t))..
    sum((wind(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_wind(r,t) ;
    
genUP_coal(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((coa(i),oldv(v)), XTWH(ivrt(i,v,r,t))) + sum((lig(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_coal(r,t) ;
    
genUP_biom(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((bio(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_biom(r,t) ; 
    
genUP_hydr(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((hyd(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =l= gen_hydr(r,t) ;
    
genLO_nucl(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((nuc(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =g= gen_nucl(r,t) ;

genLO_ngas(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((gas(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =g= gen_ngas(r,t) ;
    
genLO_sola(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((sol(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =g= gen_sola(r,t) ;
    
genLO_wind(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((wind(i),oldv(v)), XTWH(ivrt(i,v,r,t))) gl= gen_wind(r,t) ;
    
genLO_coal(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((coa(i),oldv(v)), XTWH(ivrt(i,v,r,t))) + sum((lig(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =g= gen_coal(r,t) ;
    
genLO_biom(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((bio(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =g= gen_biom(r,t) ; 
    
genLO_hydr(r,t)$(tymopic(t) and sameas(t,"2022"))..
    sum((hyd(i),oldv(v)), XTWH(ivrt(i,v,r,t))) =g= gen_hydr(r,t) ;
...
$if set co2mark $if     set bauprice ECEU.UP(t)$(t.val le 2045) = co2ele_in(t) + 50 ;
$if set co2mark $if     set bauprice ECEU.LO(t)$(t.val le 2045) = co2ele_in(t) - 50 ;

$if set co2mark $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_in(t) + 200 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_in(t) - 50 ;

$if set co2mark $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2025) = co2ele_in(t) + 50 ;
$if set co2mark $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2025) = co2ele_in(t) - 50 ;
...
$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val le 2045) = co2ele_in(t) + 25 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(t.val le 2045) = co2ele_in(t) - 25 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_in(t) + 25 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_in(t) - 25 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2023) = co2ele_in(t) + 25 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2023) = co2ele_in(t) - 25 ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 1 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) - 1 ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(sameas(t,"2023")) = co2ele_org(t) + 25 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(sameas(t,"2023")) = co2ele_org(t) - 25 ;

$if set co2iter $if     set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) + 50 ;
$if set co2iter $if     set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2023) = co2ele_org(t) - 50 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2022")) = co2ele_org(t) + 1 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2022")) = co2ele_org(t) - 1 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(sameas(t,"2023")) = co2ele_org(t) + 25 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(sameas(t,"2023")) = co2ele_org(t) - 25 ;

$if set co2iter $if not set bauprice ECEU.UP(t)$(t.val le 2045 and t.val ge 2024) = co2ele_org(t) + 50 ;
$if set co2iter $if not set bauprice ECEU.LO(t)$(t.val le 2045 and t.val ge 2024) = co2ele_org(t) - 50 ;
...
$if      set calibration2022                     genUP_nucl
$if      set calibration2022                     genUP_sola
$if      set calibration2022                     genUP_biom
$if      set calibration2022                     genUP_coal
$if      set calibration2022                     genUP_wind
$if      set calibration2022                     genUP_hydr
$if      set calibration2022                     genLO_ngas
* * * Regional Learning-by-Doing
...
$if      set lbs        $if     set budget_ir       eq_lbs_rdbudget_rt 
...
$if      set lbseur                                 acc_k_continuous2020
$if      set lbseur                                 acc_k_continuous
$if      set lbseur                                 rho_mixedip_k
$if      set lbseur                                 capex_mixedip_k
$if      set lbseur                                 lbs_helper1
$if      set lbseur                                 lbs_helper2
$if      set lbseur                                 lbs_helper3
$if      set lbseur                                 lbs_helper4
$if      set lbseur                                 capcost_mixedip_k
$if      set lbseur                                 klsLO_mixedip
$if      set lbseur                                 klsUP_mixedip
$if      set lbseur                                 acc_kls_mixedip
* Budget constraints
