...
set
bse elastic lost loas segmenta /bs1,bs2,bs3,bs4,bs5/
;
...
*                       Cost (EUR/MWh) of lost load/backstop (GWh)
                        ...
                        + 1e-3 * sum(bse, bse_share(bse,r,t) * vollelas(bse,r,t) * sum(s, BSELAS(bse,s,r,t) * hours(s)))
...
$if      set lostload    + (BS(s,r,t) + sum(bse, bse_share(bse,r,t) * BSELAS(bse,s,r,t))) *
...
$if      set lostload    BS.UP(s,r,t) = 0.75 * load(s,r) * dref(r,t) ;
$if      set lostload    BSELAS.UP(bse,s,r,t) = bse_share(bse,r,t) * load(s,r) * dref(r,t) ;
