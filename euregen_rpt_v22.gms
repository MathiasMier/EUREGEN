...
$if     set flheur  stock(t,i_flh(i)) = FLHTRYEUR.L(i,t) + eps ;
$if not set flheur  stock(t,i_flh(i)) = eps ;
...
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"-1-")                         = flheurstockUP(i,"ls-1") ;
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"-2-")                         = flheurstockUP(i,"ls-2") ;
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"-3-")                         = flheurstockUP(i,"ls-3") ;
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"-4-")                         = flheurstockUP(i,"ls-4") ;
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"-5-")                         = flheurstockUP(i,"ls-5") ;
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"-6-")                         = flheurstockUP(i,"ls-6") ;
$if     set flheur  flheur_ls_rpt("border",i_flh(i),"Up")                          = flheurstockUP(i,"ls-7") ;
$if     set flheur  flheur_ls_rpt("slope",i_flh(i),"-1-")                          = flheurindexSLOPE(i,"ls-1") ;
$if     set flheur  flheur_ls_rpt("slope",i_flh(i),"-2-")                          = flheurindexSLOPE(i,"ls-2") ;
$if     set flheur  flheur_ls_rpt("slope",i_flh(i),"-3-")                          = flheurindexSLOPE(i,"ls-3") ;
$if     set flheur  flheur_ls_rpt("slope",i_flh(i),"-4-")                          = flheurindexSLOPE(i,"ls-4") ;
$if     set flheur  flheur_ls_rpt("slope",i_flh(i),"-5-")                          = flheurindexSLOPE(i,"ls-5") ;
$if     set flheur  flheur_ls_rpt("slope",i_flh(i),"-6-")                          = flheurindexSLOPE(i,"ls-6") ;
...
$if     set flheur  flheur_cost_rpt("ind",i_flh(i),v)$(v.val ge 2020) = flheurindex(i,v) ;
$if     set flheur  flheur_cost_rpt("inv",i_flh(i),v)$(v.val ge 2020) = capcost(i,v,"Germany") ; 
$if     set flheur  flheur_cost_rpt("fom",i_flh(i),v)$(v.val ge 2020) = fomcost(i,v,"Germany") ;
