...
tnacstart_in =
$if not set hedgeeua    round(tnac_int("2021"), 4) ;
$if     set hedgeeua    round(tnacres_int("2021"), 4) ;
...
co2indorgfix(t) = co2ind_org(t) * co2indfix_in(t) ;
...
co2marketeu(t)$(tmyopic(t))..           ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t) =e= co2sup(t) + TNACUSE(t) - co2out_in(t) ;
...
it_euets(t)$(tmyopic(t))..                                ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t) =l= co2sup(t) + TNACUSE(t) - co2out_in(t) ;
...
eqs_euets(t)$(tmyopic(t))..                                                 ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t) + co2avi_in(t) + co2shi_in(t)
                                                                                                        =e= co2add_in(t) + co2allocated_in(t) + co2auctioned_in(t) - MSRIN(t) + MSROUT(t) + TNACUSE(t) - co2out_in(t) ;
...
eqs_co2mono2020(t)$(tmyopic(t) and t.val le 2022)..
                        ECEU(t)
$if     set bauprice $if     set nofreedom2022  =e= co2ele_in(t) + 0  
$if     set bauprice $if not set nofreedom2022  =l= co2ele_in(t) - 0
$if not set bauprice $if     set nofreedom2022  =e= co2ele_in(t) + 0  
$if not set bauprice $if not set nofreedom2022  =l= co2ele_in(t) + 300              
                        ;
...
$if      set nofreedom2022                       eqs_co2mono2020
