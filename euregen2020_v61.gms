...
d0(bse,s,r,t)              Reference annual demand 
...
$if     set frnucnormal     af(s,ivrt(i,oldv(v),r,t))$(sameas(t,"2022")                and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0) = sum(sm(s,m), afnn(m,i,r,"2020"))/2 + sum(sm(s,m), afnn(m,i,r,"2021"))/2 ;
