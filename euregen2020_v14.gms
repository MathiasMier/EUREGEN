...
capacity_flheur(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and i_flh(i))..
...
* Set French nuclear availability in 2023 as in 202022 as what-if-still-case
...
* Assume that lower hydro availability prevails
...
$if not  set bauprice   $if not set banking $gdxin limits\%l%_bauprice_banking.gdx
...
$if not  set bauprice   $if     set shortrun    IX.FX("Nuclear",r,t)$(t.val le 2024)   = ixfx(i,r,t) ;
$if not  set bauprice   $if     set shortrun    IX.UP("Nuclear",r,t)$(t.val = 2025)    = round(ixfx(i,r,t) * 1.5   +  1 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP("Nuclear",r,t)$(t.val = 2026)    = round(ixfx(i,r,t) * 2     +  2 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP("Nuclear",r,t)$(t.val = 2027)    = round(ixfx(i,r,t) * 3     +  3 * daref(r,"2020") / daref("Germany","2020"), 4) ;
