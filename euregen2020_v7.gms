...
af(s,i,v,r,t)$(reliability(i,v,r) > 0) = 1 ;

af(s,i,oldv(v),r,t)$(sameas(t,"2020") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;
af(s,i,oldv(v),r,t)$(sameas(t,"2020") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;
*af(s,i,oldv(v),r,t)$(sameas(t,"2020") and sameas(i,"Hydro")     and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon(m,i,r)) / reliability(i,v,r), 4) ;

af(s,i,oldv(v),r,t)$(sameas(t,"2021") and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon2021(m,i,r)) / reliability(i,v,r), 4) ;
af(s,i,oldv(v),r,t)$(sameas(t,"2021") and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon2021(m,i,r)) / reliability(i,v,r), 4) ;
*af(s,i,oldv(v),r,t)$(sameas(t,"2021") and sameas(i,"Hydro")     and reliability(i,v,r) > 0)      = round(sum(sm(s,m), af_mon2021(m,i,r)) / reliability(i,v,r), 4) ;
...
$if     set newhydrotimeseries      af(s,i,oldv(v),r,t)$(sameas(t,"2020") and sameas(i,"Hydro") and reliability(i,v,r) > 0)                                     = 1 ;
$if     set newhydrotimeseries      af(s,i,oldv(v),r,t)$(sameas(t,"2021") and sameas(i,"Hydro") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0) = round(sum(sm(s,m), af_mon2021(m,i,r) / af_mon(m,i,r)), 4) ;

* General af calibration
af(s,i,oldv(v),r,t)$(t.val ge 2022 and sameas(i,"Nuclear")   and reliability(i,v,r) > 0)                            = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;
af(s,i,oldv(v),r,t)$(t.val ge 2021 and sameas(i,"Nuclear")   and sameas(r,"France") and reliability(i,v,r) > 0)     = round(af(s,i,v,r,"2020"), 4) ;
af(s,i,oldv(v),r,t)$(t.val ge 2022 and sameas(i,"Bioenergy") and reliability(i,v,r) > 0)                            = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;

af(s,i,oldv(v),r,t)$(t.val ge 2022 and sameas(i,"Hydro")     and reliability(i,v,r) > 0)                            = round((af(s,i,v,r,"2020") + af(s,i,v,r,"2021"))/2, 4) ;

*alias(m,mm) ;
*af_mon2022(m,i,r)$(m.val ge 5 and sameas(i,"Hydro")   and sum(mm$(mm.val le 4), af_mon2021(mm,i,r)/2 + af_mon(mm,i,r)/2) > 0) = (af_mon2021(m,i,r)/2 + af_mon(m,i,r)/2) * sum(mm$(mm.val le 4), af_mon2022(mm,i,r)) / sum(mm$(mm.val le 4), af_mon2021(mm,i,r)/2 + af_mon(mm,i,r)/2) ;
*af_mon2022(m,i,r)$(m.val ge 5 and sameas(i,"Nuclear") and sum(mm$(mm.val le 4), af_mon2021(mm,i,r)/2 + af_mon(mm,i,r)/2) > 0) = (af_mon2021(m,i,r)/2 + af_mon(m,i,r)/2) * sum(mm$(mm.val le 4), af_mon2022(mm,i,r)) / sum(mm$(mm.val le 4), af_mon2021(mm,i,r)/2 + af_mon(mm,i,r)/2) ;

* Hydro adjustments due to droughts
$if not  set bauprice   $if not set hydronormal af(s,i,oldv(v),r,t)$(sameas(t,"2022")                        and sameas(i,"Hydro")   and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r) / af_mon(m,i,r)) / reliability(i,v,r), 4) ;
$if not  set bauprice   $if not set frnucnormal af(s,i,oldv(v),r,t)$(sameas(t,"2022") and sameas(r,"France") and sameas(i,"Nuclear") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r)) / reliability(i,v,r), 4) ;

$if not  set bauprice   $if     set hydro2023   af(s,i,oldv(v),r,t)$(sameas(t,"2023")                        and sameas(i,"Hydro")   and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r) / af_mon(m,i,r)) / reliability(i,v,r), 4) ;
$if not  set bauprice   $if     set frnuc2023   af(s,i,oldv(v),r,t)$(sameas(t,"2023") and sameas(r,"France") and sameas(i,"Nuclear") and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m), af_mon2022(m,i,r)) / reliability(i,v,r), 4) ;
...
$if not  set bauprice       af(s,"Nuclear","1990","Germany","2022")$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2022_ger(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ;   
$if      set extension      af(s,"Nuclear","1990","Germany","2023")$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_ext(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
$if      set streckbetrieb  af(s,"Nuclear","1990","Germany","2023")$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_str(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
$if      set strext         af(s,"Nuclear","1990","Germany","2023")$(reliability("Nuclear","1990","Germany") > 0) = round(sum(sm(s,m), af_mon2023_strext(m,"Nuclear","Germany")) / reliability("Nuclear","1990","Germany"), 4) + eps ; 
...
demand_rsa(peak(s,r),t)$(t.val ge 2022 and tmyopic(t))..
...
exlife(ivrt(i,oldv(v),r,t))$(t.val ge 2022 and not chp(i) and tmyopic(t))..
         XC(i,v,r,t) =l= cap(i,v,r) * lifetime(i,v,r,t) ;
* CHP plants cannot be decommissioned before lifetime         
exlife2030_chp(ivrt(chp(i),oldv(v),r,t))$(t.val ge 2022 and t.val le 2035 and tmyopic(t))..
         XC(i,v,r,t) =e= cap(i,v,r) * lifetime(i,v,r,t) ;
exlife_chp(ivrt(chp(i),oldv(v),r,t))$(t.val ge 2036 and tmyopic(t))..
         XC(i,v,r,t) =l= cap(i,v,r) * lifetime(i,v,r,t) ;
* Bioenergy cannot be decommissioned before lifetime
exlife_bio(ivrt(i,oldv(v),r,t))$(sameas(i,"Bioenergy") and t.val ge 2022 and t.val le 2030 and tmyopic(t))..
         XC(i,v,r,t) =e= cap(i,v,r) * lifetime(i,v,r,t) ;
...
* Upper limit
investlimUP(i,r,t)$(new(i) and conv(i) and invlimUP(i,r,t) and t.val ge 2022 and tmyopic(t))..
         IX(i,r,t) =l= invlimUP(i,r,t) ;
* Lower limit
investlimLO(i,r,t)$(new(i) and invlimLO(i,r,t) and t.val ge 2022 and tmyopic(t))..
...
investlimUP_irnw(irnw(i),r,t,quantiles)$(irnwlimUP_quantiles(i,r,quantiles) and tmyopic(t) and not sameas(i,"Hydro") and t.val ge 2022)..       
...
tinvestnew(k,r,rr,t)$(tmap(k,r,rr) and t.val ge 2021 and tmyopic(t))..
...
gexlife2020(jvrt(j,oldv(v),r,t))$(t.val le 2021 and tmyopic(t))..
         GC(j,v,r,t) =e= gcap(j,v,r) * glifetime(j,v,r,t) ;
* Decommissioning possible >2015
gexlife(jvrt(j,oldv(v),r,t))$(t.val ge 2020 and tmyopic(t))..
         GC(j,v,r,t) =l= gcap(j,v,r) * glifetime(j,v,r,t) ;
* Avoid decommissioning of pump storage capacty
gexlife_pump(jvrt(j,oldv(v),r,t))$(sameas(j,"PumpStorage") and t.val ge 2022 and tmyopic(t))..
         GC(j,v,r,t) =e= gcap(j,v,r) * glifetime(j,v,r,t) ;
...
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2023)        = round(ixfx(i,r,t) * 1.5   +  5 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2024)        = round(ixfx(i,r,t) * 2     + 10 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2025)        = round(ixfx(i,r,t) * 3     + 15 * daref(r,"2020") / daref("Germany","2020"), 4) ;
...
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2025)    = round(ixfx(i,r,t) * 1.5   +  5 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2026)    = round(ixfx(i,r,t) * 2     + 10 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2027)    = round(ixfx(i,r,t) * 3     + 15 * daref(r,"2020") / daref("Germany","2020"), 4) ;
...
$if      set trans       IT.FX(k,r,rr,t)$(t.val le 2020) = 0 ;
