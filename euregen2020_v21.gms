...
$if not set fixbudget IK(i,r,t) =l= rd_budget(i,r,t) ;
$if     set fixbudget IK(i,r,t) =e= rd_budget(i,r,t) ;
...
* Capacity equations
capacity_flh2020(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and sameas(t,"2022"))..
...
capacity_noflh(s,ivrt(i,v,r,t))$(not chp(i) and tmyopic(t) and not ir_flh(i,r) and not sameas(t,"2022"))..
                X(s,i,v,r,t) =l=  XCS(s,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) ;              
capacity_flh(s,ivrt(i,v,r,t))$(tmyopic(t) and ir_flh(i,r) and not sameas(t,"2022"))..
...
kendeffect(i,r,t)       endeffect for searching
kendeffecteur(i,t)      endeffecteur for searching
;
...
$if      set doing       $if      set constant    $if     set eur   1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$( i_lea(i)), sum(tv(t,v)$ivt(i,v,t),  CAPEXEUR_CON(i,v)        *  endeffecteur(i,v,t))) +
$if      set doing       $if      set nonlinear   $if     set eur   1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$( i_lea(i)), sum(tv(t,v)$ivt(i,v,t),  CAPEXEUR_NLP(i,v)        *  endeffecteur(i,v,t))) +
$if      set doing       $if      set mip         $if     set eur   1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$( i_lea(i)), sum(tv(t,v)$ivt(i,v,t),  CAPEXEUR_MIP(i,v) * 1e+6 *  endeffecteur(i,v,t))) +
$if      set searching   $if      set mip         $if     set eur   1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$(ki_lea(i)), sum(tv(t,v)$ivt(i,v,t), KCAPEXEUR_MIP(i,t) * 1e+6 * kendeffecteur(i,v,t))) +
...
$if not  set doing       $if      set mixed   + sum(new(i),              sum(inv,  share(inv,i,r) * IX(i,r,t)    * sum(tv(t,v)$ivrt(i,v,r,t),  capcost(i,v,r)  *  zeta(inv,i,v,r))))
...
$if      set doing       $if    set constant    $if not set eur   + sum(new(i)$( ir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t),  CAPEX_CON(i,v,r)        *  endeffect(i,v,r,t) ))
$if      set doing       $if    set nonlinear   $if not set eur   + sum(new(i)$( ir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t),  CAPEX_NLP(i,v,r)        *  endeffect(i,v,r,t) ))
$if      set doing       $if    set mip         $if not set eur   + sum(new(i)$( ir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t),  CAPEX_MIP(i,v,r) * 1e+6 *  endeffect(i,v,r,t) ))
$if      set searching   $if    set mip         $if not set eur   + sum(new(i)$(kir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t), KCAPEX_MIP(i,r,t) * 1e+6 * kendeffect(new,v,r,t) )) 
               )
...
$if      set flh           not i_flh(i)
$if      set flheur        not i_flh(i)
                            )..
                 X(s,i,v,r,t) =l=  XCS(s,i,v,r,t) * (1 + (reliability(i,v,r)-1)$reliability(i,v,r)) * (1 + (af(s,i,v,r,t)-1)$af(s,i,v,r,t)) * (1 + (vrsc(s,i,v,r)-1)$vrsc(s,i,v,r)) ;
...
EMPTY(t)                MSR is not full enough to get emptied 
;
...
$if      set negmsrin  Variable
$if not  set negmsrin  Positive Variable
MSRIN(t)
;
...
eqs_msrinneg(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..        MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) - LOW(t-1) * 200 ;
...
eqs_msrneg(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          MSR(t)                      =e= msrstart_in  + sum(tt$(tt.val le t.val and tt.val ge 2022), (MSRIN(tt) - CANCEL(tt)) * nyrs(tt)) ;
...
eqs_cancelneg(t)$((t.val ge 2023 and t.val le 2045) and tmyopic(t))..       CANCEL(t)                   =e= MSR(t-1) + MSRIN(t-1) + MSRIN(t) - co2auctioned_in(t-1) ;
...
eqs_tnacup(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          TNAC(t)                     =g=                MID(t) * 400 + UPP(t) *  833 ;
eqs_tnaclo(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          TNAC(t)                     =l= LOW(t) * 400 + MID(t) * 833 + UPP(t) * 2000 ;
eqs_binary(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..          LOW(t) + UPP(t) + MID(t)    =e= 1 ;

eqs_msrin833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..        MSRIN(t)                    =e= UPP(t-1) * 0.24 * TNAC(t-1) + UPPMID(t-1) * (TNAC(t-1) - 833) ;
eqs_msrout833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       MSROUT(t)                   =l= LOW(t-1) * 200 + LOWMID(t-1) * (TNAC(t-1) - 200) ;
eqs_tnacup833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       TNAC(t)                     =g=                LOWMID(t) * 200 + MID(t) * 400 + UPPMID(t) *  833 + UPP(t) * 1096 ;
eqs_tnaclo833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       TNAC(t)                     =l= LOW(t) * 200 + LOWMID(T) * 400 + MID(t) * 833 + UPPMID(t) * 1096 + UPP(t) * 2000 ;
eqs_binary833(t)$((t.val ge 2022 and t.val le 2045) and tmyopic(t))..       LOW(t) + LOWMID(t) + UPP(t) + UPPMID(t) + MID(t) =e= 1 ;
eqs_cancel2023833(t)$((t.val ge 2023 and t.val le 2024) and tmyopic(t))..   CANCEL(t)                   =e= MSR(t-1) + MSRIN(t-1) - MSROUT(t-1) + MSRIN(t) - MSROUT(t) - co2auctioned_in(t-1) ;
eqs_cancel833(t)$((t.val ge 2025 and t.val le 2045) and tmyopic(t))..       CANCEL(t)                   =g= MSR(t) - 400 ;
...
$if      set negmsrin  $if      set co2mips  MSRIN.L(t)$(msr_in(t) < 0)  = msrin_in(t) ;
$if not  set negmsrin  $if      set co2mips  MSRIN.L(t)$(msr_in(t) < 0)  = 0 ;
$if not  set negmsrin  $if      set co2mips  MSROUT.L(t)$(msr_in(t) >= 0)  = 0 ;
$if not  set negmsrin  $if      set co2mips  MSROUT.L(t)$(msr_in(t) < 0)  = - msrin_in(t) ;
$if      set co2mips  MSR.L(t)                     = msr_in(t) ;
$if      set co2mips  LOW.L(t)$(tnac_in(t) <  400) = 1 ;
$if      set co2mips  LOW.L(t)$(tnac_in(t) >= 400) = 0 ;
$if      set co2mips  MID.L(t)$(tnac_in(t) <= 833 and tnac_in(t) >= 400) = 1 ;
$if      set co2mips  MID.L(t)$(tnac_in(t) <  400 or  tnac_in(t) >  833) = 0 ;
$if      set co2mips  UPP.L(t)$(tnac_in(t) >  833) = 1 ;
$if      set co2mips  UPP.L(t)$(tnac_in(t) <= 833) = 0 ;

$if      set co2mips833     LOW.L(t)$(tnac_in(t) <  200) = 1 ;
$if      set co2mips833     LOW.L(t)$(tnac_in(t) >= 200) = 0 ;
$if      set co2mips833     LOWMID.L(t)$(tnac_in(t) <  400 and tnac_in(t) >= 200) = 1 ;
$if      set co2mips833     LOWMID.L(t)$(tnac_in(t) >= 400 or  tnac_in(t) < 200) = 0 ;
$if      set co2mips833     MID.L(t)$(tnac_in(t) <= 833 and tnac_in(t) >= 400) = 1 ;
$if      set co2mips833     MID.L(t)$(tnac_in(t) <  400 or  tnac_in(t) >  833) = 0 ;
$if      set co2mips833     UPPMID.L(t)$(tnac_in(t) >  833 and tnac_in(t) <= 1096) = 1 ;
$if      set co2mips833     UPPMID.L(t)$(tnac_in(t) <= 833 or  tnac_in(t) >  1096) = 0 ;
$if      set co2mips833     UPP.L(t)$(tnac_in(t) >  1096) = 1 ;
$if      set co2mips833     UPP.L(t)$(tnac_in(t) <= 1096) = 0 ;
...
*$if      set co2mips  MSRIN.LO("2022") = 0 ;
*$if      set co2mips  MSRIN.UP("2045") = 0 ;
...
*$if      set co2mips  MSROUT.LO("2045") = 0 ;
$if      set co2mips  MSROUT.FX("2050") = 0 ;

$if      set co2mips  LOW.FX("2020") = 0 ;
$if      set co2mips  LOW.FX("2021") = 0 ;
*$if      set co2mips  LOW.FX("2022") = 0 ;
*$if      set co2mips  LOW.FX("2045") = 1 ;
$if      set co2mips  LOW.FX("2050") = 1 ;

$if      set co2mips  MID.FX("2020") = 0 ;
$if      set co2mips  MID.FX("2021") = 0 ;
*$if      set co2mips  MID.FX("2022") = 0 ;
*$if      set co2mips  MID.FX("2045") = 0 ;
$if      set co2mips  MID.FX("2050") = 0 ;


$if     set co2mips833   $if      set co2mips  LOWMID.FX("2020") = 0 ;
$if     set co2mips833   $if      set co2mips  LOWMID.FX("2021") = 0 ;
*$if     set co2mips833   $if      set co2mips  UPPMID.FX("2022") = 0 ;
*$if     set co2mips833   $if      set co2mips  UPPMID.FX("2045") = 0 ;
$if     set co2mips833   $if      set co2mips  LOWMID.FX("2050") = 0 ;

$if     set co2mips833   $if      set co2mips  UPPMID.FX("2020") = 0 ;
$if     set co2mips833   $if      set co2mips  UPPMID.FX("2021") = 0 ;
*$if     set co2mips833   $if      set co2mips  UPPMID.FX("2022") = 0 ;
*$if     set co2mips833   $if      set co2mips  UPPMID.FX("2045") = 0 ;
$if     set co2mips833   $if      set co2mips  UPPMID.FX("2050") = 0 ;

$if      set co2mips  UPP.FX("2020") = 1 ;
$if      set co2mips  UPP.FX("2021") = 1 ;
*$if      set co2mips  UPP.FX("2022") = 1 ;
*$if      set co2mips  UPP.FX("2045") = 0 ;
$if      set co2mips  UPP.FX("2050") = 0 ;
...
*$if      set co2mips  CANCEL.FX("2045") = 0 ;
...
co2diff(t)$(t.val ge 2023) = co2ele_in(t) - co2ele_in(t-1) ;

eqs_co2mono2020(t)$(tmyopic(t) and t.val le 2022)..
    ECEU(t) =l= co2ele_in(t) + 200 ;
eqs_co2mono(t)$(tmyopic(t) and t.val ge 2023 and t.val le 2030)..
    ECEU(t) =l= ECEU(t-1) + co2diff(t) ;
...
$if set uselimits       $if     set shortrun    IX.FX(sol(i),r,t)$(t.val le 2022)       = round(ixfx(i,r,t), 4) ;
...
$if set uselimits       $if     set shortrun    IX.FX(windon(i),r,t)$(t.val le 2023)    = round(ixfx(i,r,t), 4) ;
...
$if set uselimits       $if     set shortrun    IX.FX(windoff(i),r,t)$(t.val le 2024)   = round(ixfx(i,r,t), 4) ;
...
$if set uselimits       $if     set shortlong    IX.FX(sol(i),r,t)$(t.val le 2022)       = round(ixfx(i,r,t), 4) ;
...
$if set uselimits       $if     set shortlong    IX.FX(windon(i),r,t)$(t.val le 2023)    = round(ixfx(i,r,t), 4) ;
...
$if set uselimits       $if     set shortlong    IX.FX(windoff(i),r,t)$(t.val le 2024)   = round(ixfx(i,r,t), 4) ;
...
$if set uselimits       $if     set longrun     IX.FX(sol(i),r,t)$(t.val le 2025)       = round(ixfx(i,r,t) * 2     + 20 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if set uselimits       $if     set longrun     IX.FX(windon(i),r,t)$(t.val le 2025)    = round(ixfx(i,r,t) * 1.5   +  5 * daref(r,"2020") / daref("Germany","2020"), 4) ;
$if set uselimits       $if     set longrun     IX.FX(windoff(i),r,t)$(t.val le 2025)   = round(ixfx(i,r,t), 4) ;
...
$if      set co2mipsneg                          eqs_msrinneg
$if      set co2mipsneg                          eqs_msrneg
$if      set co2mipsneg                          eqs_cancelneg

$if      set co2mipsnor                          eqs_msrin2023
$if      set co2mipsnor                          eqs_msrin
$if      set co2mipsnor                          eqs_msrout2023
$if      set co2mipsnor                          eqs_msrout
$if      set co2mipsnor                          eqs_msr
$if      set co2mipsnor                          eqs_cancel
$if      set co2mipsnor                          eqs_tnacup
$if      set co2mipsnor                          eqs_tnaclo
$if      set co2mipsnor                          eqs_binary

$if      set co2mips833                          eqs_msrin833
$if      set co2mips833                          eqs_msrout833
$if      set co2mips833                          eqs_msr
$if      set co2mips833                          eqs_cancel2023833
$if      set co2mips833                          eqs_cancel833
$if      set co2mips833                          eqs_tnacup833
$if      set co2mips833                          eqs_tnaclo833
$if      set co2mips833                          eqs_binary833

$if      set co2mips                             co2flowuk
$if      set co2mips                             ukets

$if      set co2mono                             eqs_co2mono2020
$if      set co2mono                             eqs_co2mono
* Policy
...
$if      set searching   $if      set mip          $if     set eur                    acc_k_continuous2020
$if      set searching   $if      set mip          $if     set eur                    acc_k_continuous
$if      set searching   $if      set mip          $if     set eur                    rho_mixedip_k
$if      set searching   $if      set mip          $if     set eur                    capex_mixedip_k
$if      set searching   $if      set mip          $if     set eur                    searching_helper1
$if      set searching   $if      set mip          $if     set eur                    searching_helper2
$if      set searching   $if      set mip          $if     set eur                    searching_helper3
$if      set searching   $if      set mip          $if     set eur                    searching_helper4
$if      set searching   $if      set mip          $if     set eur                    capcost_mixedip_k
$if      set searching   $if      set mip          $if     set eur                    klsLO_mixedip
$if      set searching   $if      set mip          $if     set eur                    klsUP_mixedip
$if      set searching   $if      set mip          $if     set eur                    acc_kls_mixedip
* Budget constraints
$if      set searching   $if      set mip          $if     set eur $if      set budgetit     eq_rd_budget_it
$if      set searching   $if      set mip          $if     set eur $if      set budgeti      eq_rd_budget_i
$if      set searching   $if      set mip          $if     set eur $if      set budgett      eq_rd_budget_t
$if      set searching   $if      set mip          $if     set eur $if      set budget       eq_rd_budget
...
$if      set flheur     capacity_flheur2020
