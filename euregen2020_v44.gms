...
KCAPCOSTEUR_MIP(i,t)        Per unit capacity cost of learning technologies (1000 EUR per kW)
KCAPEXEUR_MIP(i,t)          Capacity cost of learning technologies (billion)
...
$if      set lbseur                                                 1 / nyrs(t) * (1 + tk) * dfact(t) * sum(new(i)$(ki_lea(i)), sum(tv(t,v)$ivt(i,v,t), KCAPEXEUR_MIP(i,t) * 1e+3 * kendeffecteur(i,t))) +
...
$if      set lbs                                                  + sum(new(i)$(kir_lea(i,r)), sum(tv(t,v)$ivrt(i,v,r,t), KCAPEX_MIP(i,r,t) * 1e+3 * kendeffect(i,r,t) )) 
               )
