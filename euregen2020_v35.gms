...
$if      set lbs    capcost(i,v,r)$(ki_lea(i)) = kcapcost_int(i,v,r) ;
$if      set lbseur capcost(i,v,r)$(kir_lea(i,r)) = kcapcost_int(i,v,r) ;
...
eq_lbs_rdbudget_irt(i,r,t)$(ir_lbs(i,r) and tmyopic(t))..
...
$if not set fixbudget        sum((ir_lbs(i,r)), IK(i,r,t)) =l= sum((ir_lbs(i,r)), sum(v$(t.val eq v.val), lbsrdbudget(i,r,v))) ;
$if     set fixbudget        sum((ir_lbs(i,r)), IK(i,r,t)) =e= sum((ir_lbs(i,r)), sum(v$(t.val eq v.val), lbsrdbudget(i,r,v))) ;
eq_lbs_rdbudget_r(r)..
...
eq_lbs_rdbudget..
$if not set fixbudget        sum((ir_lbs(i,r),tmyopic(t)), nyrs(t) * IK(i,r,t)) =l= sum((ir_lbs(i,r),tmyopic(t)), nyrs(t) * sum(v$(t.val eq v.val), lbsrdbudget(i,r,v))) ;
$if     set fixbudget        sum((ir_lbs(i,r),tmyopic(t)), nyrs(t) * IK(i,r,t)) =e= sum((ir_lbs(i,r),tmyopic(t)), nyrs(t) * sum(v$(t.val eq v.val), lbsrdbudget(i,r,v))) ;
