...
co2indfix_in(t) = co2indfix_int(t) ;
co2indshare_in(t) = co2indshare_int(t) ;
co2indorg_in(t) = co2indorg_int(t) ;
...
co2market(t)$(tmyopic(t))..             ECEU(t) + co2ind_in(t) + co2can_in(t)                                                             =l= co2sup1(t)  ;
co2market_indformula(t)$(tmyopic(t))..  ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t)                                    =l= co2sup1_indformula(t)  ;
* * (4) - (5) Simple European cap with banking including industrial emissions
co2marban(t)$(tmyopic(t))..             ECEU(t) + co2ind_in(t) + co2can_in(t)                                                             =e= co2sup2(t) + TNACUSE(t) ;
co2marban_indformula(t)$(tmyopic(t))..  ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t)                                    =e= co2sup2_indformula(t) + TNACUSE(t) ;
...
it_co2floweu(t)$tmyopic(t)..                              ECEU(t)                               =e= sum(r$(not sameas(r,"Britain")), sum(ivrt(i,v,r,t), emit(i,v,r) * XTWH(i,v,r,t))) ;
it_euets(t)$(tmyopic(t))..                                ECEU(t) + co2ind_in(t) + co2can_in(t) =e= co2sup2(t) + TNACUSE(t) ;
it_euets_indformula(t)$(tmyopic(t))..                     ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t)
                                                                                                =l= co2sup2(t) + TNACUSE(t) ;
...
$if      set co2iter  $if      set shortrun                           ECEU.LO("2045")  =  620 ;
*$if      set co2iter  $if      set shortrun                           ECEU.UP(t)$(t.val ge 2023 and t.val le 2040)  = co2ele_in(t) + 25 ;
$if      set co2iter  $if      set shortrun                           ECEU.UP("2045")  =  120 ;
*$if      set co2iter  $if      set shortrun                           ECEU.LO(t)  = co2ele_in(t) - 25 ;
...
eqs_co2floweu(t)$(tmyopic(t))..                                             ECEU(t)                     =e= sum(r$(not sameas(r,"Britain")), sum(ivrt(i,v,r,t), emit(i,v,r) * XTWH(i,v,r,t))) ;
...
eqs_euets_indformula(t)$(tmyopic(t))..                                      ECEU(t) * (1 + co2elecind(t)) + co2indorgfix(t) + co2can_in(t)
...
IX.FX(nuc(i),r,t)$(not invlimLO(i,r,t) > 0 and t.val le 2030) = 0 ;
