...
$gdxin database\setpar_%n%.gdx
$load cap_int=cap, invlimUP, invlimLO, invlimUP_eu, invlife, invdepr, capcost, fomcost_int=fomcost, vomcost, effrate, co2captured, emit, reliability, capcred, mindisp
...
$if not  set bauprice   $if not set hydronormal af(s,i,oldv(v),r,t)$(sameas(t,"2022") and sameas(i,"Hydro")  and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m)$(m.val le 4), af_mon2022(m,i,r) / af_mon(m,i,r)), 4) ;
$if not  set bauprice   $if not set hydronormal af(s,i,oldv(v),r,t)$(sameas(t,"2022") and sameas(i,"Hydro")  and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m)$(m.val ge 5), sum(mm$(mm.val le 4), af_mon2022(mm,i,r))/4 / af_mon(m,i,r)), 4) ;

$if not  set bauprice   $if not set hydronormal af(s,i,oldv(v),r,t)$(sameas(t,"2022") and sameas(i,"Nuclear")  and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m)$(m.val le 4), af_mon2022(m,i,r) / af_mon(m,i,r)), 4) ;
$if not  set bauprice   $if not set hydronormal af(s,i,oldv(v),r,t)$(sameas(t,"2022") and sameas(i,"Nuclear")  and reliability(i,v,r) > 0 and sum(sm(s,m), af_mon(m,i,r)) > 0)      = round(sum(sm(s,m)$(m.val ge 5), sum(mm$(mm.val le 4), af_mon2022(mm,i,r))/4 / af_mon(m,i,r)), 4) ;

  
$if not  set bauprice   $if not set frnucnormal

af(s,i,oldv(v),r,t)$(t.val ge 2021 and t.val le 2025 and sameas(i,"Nuclear") and sameas(r,"France") and reliability(i,v,r) > 0)   = round(sum(sm(s,m), af_mon_ivrt(m,i,v,r,t)) / reliability(i,v,r), 4) ;
...
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2023)        = round(ixfx(i,r,t) * 1.5 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2024)        = round(ixfx(i,r,t) * 2 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(sol(i),r,t)$(t.val = 2025)        = round(ixfx(i,r,t) * 3 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;

$if not  set bauprice   $if     set shortrun    IX.FX(windon(i),r,t)$(t.val le 2023)    = ixfx(i,r,t) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windon(i),r,t)$(t.val = 2024)     = round(ixfx(i,r,t) * 1.5 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windon(i),r,t)$(t.val = 2025)     = round(ixfx(i,r,t) * 2 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windon(i),r,t)$(t.val = 2026)     = round(ixfx(i,r,t) * 3 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;

$if not  set bauprice   $if     set shortrun    IX.FX(windoff(i),r,t)$(t.val le 2024)   = ixfx(i,r,t) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2025)    = round(ixfx(i,r,t) * 1.5 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2026)    = round(ixfx(i,r,t) * 2 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
$if not  set bauprice   $if     set shortrun    IX.UP(windoff(i),r,t)$(t.val = 2027)    = round(ixfx(i,r,t) * 3 + 10 * daref("Germany","2020")/ daref(r,"2020"), 4) ;
