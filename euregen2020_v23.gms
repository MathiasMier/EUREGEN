...
vrsc_nor(s,i,v,r)$(ir_flh(i,r) and v.val ge 2023) = vrsc(s,i,v,r) * sum(ss, hours(ss) * vrsc(ss,i,"2022",r)) / sum(ss, hours(ss) * vrsc(ss,i,v,r)) ;
...
vrsceur_nor(s,i,v,r)$(ir_flh(i,r) and v.val ge 2023) = vrsc(s,i,v,r) * flheur(i,"2022") / sum(ss, hours(ss) * vrsc(ss,i,v,r)) ;
